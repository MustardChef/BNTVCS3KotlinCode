...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.utils.VideoDownloadManager\$downloadThing\$notificationCoroutine$1",
...
class `VideoDownloadManager$downloadThing$notificationCoroutine$1`(
    ...
    longRef: LongRef,
    j: Long,
    continuation: Continuation<in `VideoDownloadManager$downloadThing$notificationCoroutine$1`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in Unit>?, Object?> {
    /* synthetic */ val `$bytesDownloaded`: LongRef
    /* synthetic */ val `$bytesTotal`: Long
    ...
    /* synthetic */ val `$isStopped`: BooleanRef
    ...
    init {
        `$isPaused` = booleanRef
        `$isDone` = booleanRef2
        `$isStopped` = booleanRef3
        `$isFailed` = booleanRef4
        `$parentId` = num
    ...
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `VideoDownloadManager$downloadThing$notificationCoroutine$1`(
            `$isPaused`,
            `$isDone`,
            `$isStopped`,
            `$isFailed`,
    ...
    override operator fun invoke(continuation: Continuation<in Unit>): Object {
        return (create(continuation) as `VideoDownloadManager$downloadThing$notificationCoroutine$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    */   override fun invokeSuspend(r13: Any?): Any {
        ...
        L4c:
            ...
            goto L38
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.utils.VideoDownloadManager\$downloadThing\$notificationCoroutine$1.invokeSuspend(java.lang.Object):java.lang.Object")
    }
}