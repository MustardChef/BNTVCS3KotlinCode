...
@DebugMetadata(
    ...
    m97i = [],
    m96l = [160],
    m95m = "unshortenNuovoIndirizzo",
    m94n = [],
    m93s = []
) /* loaded from: classes4.dex */
class `ShortLink$unshortenNuovoIndirizzo$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: UnshortenUrl,
    continuation: Continuation<in `ShortLink$unshortenNuovoIndirizzo$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.unshortenNuovoIndirizzo(null, this)
    }
}