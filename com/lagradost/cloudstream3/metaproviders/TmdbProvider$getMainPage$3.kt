...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.metaproviders.TmdbProvider\$getMainPage$3",
...
class `TmdbProvider$getMainPage$3`(
    objectRef: ObjectRef<List<TvSeriesSearchResponse?>?>,
    tmdbProvider: TmdbProvider,
    continuation: Continuation<in `TmdbProvider$getMainPage$3`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in Unit>?, Object> {
    /* synthetic */ val `$discoverSeries`: ObjectRef<List<TvSeriesSearchResponse>>
    var `L$0`: Object? = null
    var label = 0
    ...
    init {
        `$discoverSeries` = objectRef
        `this$0` = tmdbProvider
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `TmdbProvider$getMainPage$3`(`$discoverSeries`, `this$0`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    override fun invoke(continuation: Continuation<in Unit>?): Object {
        return (create(continuation) as `TmdbProvider$getMainPage$3`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            val objectRef2: ObjectRef<List<TvSeriesSearchResponse>> = `$discoverSeries`
            tmdb = `this$0`.tmdb
            val build: Call<TvShowResultsPage> = tmdb.discoverTv().build()
            Intrinsics.checkNotNullExpressionValue(build, "tmdb.discoverTv().build()")
            `L$0` = objectRef2
            label = 1
            val awaitResponse: Object = KotlinExtensions.awaitResponse(build, this)
