...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.metaproviders.CrossTmdbProvider",
...
class `CrossTmdbProvider$search$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: CrossTmdbProvider, continuation: Continuation<in `CrossTmdbProvider$search$1`?>?
