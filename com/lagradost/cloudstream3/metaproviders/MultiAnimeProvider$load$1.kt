...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.metaproviders.MultiAnimeProvider",
    m98f = "MultiAnimeProvider.kt",
    m97i = [0, 0, 1, 1, 1],
    m96l = [47, 48],
    m95m = "load",
    m94n = ["this", "url", "this", "url", "res"],
    m93s = ["L$0", "L$1", "L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `MultiAnimeProvider$load$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MultiAnimeProvider, continuation: Continuation<in `MultiAnimeProvider$load$1`?>?
