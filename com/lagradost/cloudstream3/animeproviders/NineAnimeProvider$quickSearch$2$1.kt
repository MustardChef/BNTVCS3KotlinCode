...
internal class `NineAnimeProvider$quickSearch$2$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(  /* synthetic */
    val `$element`: Element
    ...
    fun invoke2(newAnimeSearchResponse: AnimeSearchResponse) {
        ...
        val selectFirst: Element = `$element`.selectFirst(".poster > span > img")
        newAnimeSearchResponse.posterUrl = selectFirst?.attr("src")
    }
}