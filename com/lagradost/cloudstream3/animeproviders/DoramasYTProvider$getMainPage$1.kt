...
@DebugMetadata(
    ...
    m96l = [53, 69],
    m95m = "getMainPage",
    m94n = ["this", "urls", FirebaseAnalytics.Param.ITEMS, "this", FirebaseAnalytics.Param.ITEMS, "i"],
    m93s = ["L$0", "L$1", "L$2", "L$0", "L$1", "L$3"]
) /* loaded from: classes3.dex */
class `DoramasYTProvider$getMainPage$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: DoramasYTProvider,
    continuation: Continuation<in `DoramasYTProvider$getMainPage$1`?>?
