...
class `MainAPIKt$newAnimeSearchResponse$1` internal constructor() : Lambda<Any?>(1),
    Function1<AnimeSearchResponse?, Unit> {
    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(animeSearchResponse: AnimeSearchResponse?) {
    ...
    companion object {
        val INSTANCE = `MainAPIKt$newAnimeSearchResponse$1`()
    }
}