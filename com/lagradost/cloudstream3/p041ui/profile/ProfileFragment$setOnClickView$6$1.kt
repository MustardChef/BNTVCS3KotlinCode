...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: ProfileFragment.kt */
@Metadata(
    m108d1 = ["\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"],
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.profile.ProfileFragment$setOnClickView$6$1 */ /* loaded from: classes3.dex */
class `ProfileFragment$setOnClickView$6$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    val `this$0`: ProfileFragment
    ...
    @Override // kotlin.jvm.functions.Functions
        ...
        val profileFragment: ProfileFragment = `this$0`
        activity.runOnUiThread(object : Runnable() {
            // from class: com.lagradost.cloudstream3.ui.profile.-$$Lambda$ProfileFragment$setOnClickView$6$1$mTOZn234__RIQNqNF2Mdg6uIkB4
            @Override // java.lang.Runnable
            fun run() {
                `m8750invoke$lambda0`(this@ProfileFragment)
            }
        })
    }
    ...
    companion object {
        ...
        fun `m8750invoke$lambda0`(`this$0`: ProfileFragment) {
