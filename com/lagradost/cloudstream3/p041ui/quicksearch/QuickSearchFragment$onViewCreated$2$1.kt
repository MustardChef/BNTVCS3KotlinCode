...
/* renamed from: com.lagradost.cloudstream3.ui.quicksearch.QuickSearchFragment$onViewCreated$2$1 */ /* loaded from: classes3.dex */
internal class `QuickSearchFragment$onViewCreated$2$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    fun invoke2(callback: SearchClickCallback?) {
        ...
        SearchHelper.Companion.INSTANCE.handleSearchClickCallback(`this$0`.getActivity(), callback)
    }
}