...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.APIRepository\$extractorVerifierJob$2",
...
/* renamed from: com.lagradost.cloudstream3.ui.APIRepository$extractorVerifierJob$2 */ /* loaded from: classes.dex */
internal class `APIRepository$extractorVerifierJob$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: APIRepository, /* synthetic */
    val `$extractorData`: String?,
    continuation: Continuation<in `APIRepository$extractorVerifierJob$2`?>?
    ...
    public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `APIRepository$extractorVerifierJob$2`(`this$0`, `$extractorData`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    public override fun invoke(continuation: Continuation<in Unit>?): Object {
        return (create(continuation) as `APIRepository$extractorVerifierJob$2`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            label = 1
            if (`this$0`.getApi()
                    .extractorVerifierJob(`$extractorData`, this) === coroutine_suspended
            ) {
