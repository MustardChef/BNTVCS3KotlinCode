...
/* renamed from: com.lagradost.cloudstream3.ui.home.HomeFragment$Companion$loadHomepageList$spanListener$1 */ /* loaded from: classes3.dex */
internal class `HomeFragment$Companion$loadHomepageList$spanListener$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    val `$recycle`: AutofitRecyclerView
