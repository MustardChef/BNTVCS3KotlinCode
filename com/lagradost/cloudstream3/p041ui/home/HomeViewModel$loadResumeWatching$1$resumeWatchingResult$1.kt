...
@Metadata(
    m108d1 = ["\u0000\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u0001*\u00020\u0003H\u008a@"],
    m107d2 = ["<anonymous>", "", "Lcom/lagradost/cloudstream3/utils/DataStoreHelper\$ResumeWatchingResult;", "Lkotlinx/coroutines/CoroutineScope;"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.home.HomeViewModel\$loadResumeWatching$1\$resumeWatchingResult$1",
...
/* renamed from: com.lagradost.cloudstream3.ui.home.HomeViewModel$loadResumeWatching$1$resumeWatchingResult$1 */ /* loaded from: classes3.dex */
internal class `HomeViewModel$loadResumeWatching$1$resumeWatchingResult$1` constructor(
    list: List<ResumeWatching>,
    continuation: Continuation<in `HomeViewModel$loadResumeWatching$1$resumeWatchingResult$1`?>?
) : SuspendLambda(2, continuation),
    Function2<CoroutineScope, Continuation<in List<ResumeWatchingResult?>?>?, Object> {
    /* synthetic */ val `$resumeWatching`: List<ResumeWatching>
    var label: Int = 0
    ...
    public override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `HomeViewModel$loadResumeWatching$1$resumeWatchingResult$1`(
            `$resumeWatching`,
            continuation
        )
    }
    ...
    public /* bridge */ /* synthetic */  override fun invoke(
        ...
        continuation: Continuation<in List<ResumeWatchingResult?>?>?
    ): Object {
        return invoke2(
            coroutineScope,
            continuation as Continuation<in List<ResumeWatchingResult?>?>?
        )
    }
    ...
    fun invoke2(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `HomeViewModel$loadResumeWatching$1$resumeWatchingResult$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }

    /* JADX WARN: Removed duplicated region for block: B:20:0x006d  */ /* JADX WARN: Removed duplicated region for block: B:21:0x006f  */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */ public override fun invokeSuspend(r25: Any?): Any {
        /*
            r24 = this;
            r0 = r24
        ...
        Lc1:
            ...
            throw r1
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.home.HomeViewModel\$loadResumeWatching$1\$resumeWatchingResult$1.invokeSuspend(java.lang.Object):java.lang.Object")
    }
}