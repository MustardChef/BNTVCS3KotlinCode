...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.home.PageViewModel\$getPage$1$1$1",
...
/* renamed from: com.lagradost.cloudstream3.ui.home.PageViewModel$getPage$1$1$1 */ /* loaded from: classes3.dex */
internal class `PageViewModel$getPage$1$1$1` constructor(
    objectRef: ObjectRef<Resource<PageResponse?>?>,
    pageViewModel: PageViewModel?,
    str: String?,
    continuation: Continuation<in `PageViewModel$getPage$1$1$1`?>?
) : SuspendLambda(2, continuation), Function2<CoroutineScope, Continuation<in Unit>?, Object> {
    /* synthetic */ val `$response`: ObjectRef<Resource<PageResponse>>
    /* synthetic */ val `$url`: String?
    var `L$0`: Object? = null
    var label: Int = 0
    /* synthetic */ val `this$0`: PageViewModel?

    /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    init {
        `$response` = objectRef
        `this$0` = pageViewModel
        `$url` = str
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `PageViewModel$getPage$1$1$1`(`$response`, `this$0`, `$url`, continuation)
    }
    ...
    public override fun invoke(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `PageViewModel$getPage$1$1$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        var obj: Object = obj
        var objectRef: ObjectRef<Resource<PageResponse>>?
        val t: T
        val objectRef2: ObjectRef<Resource<PageResponse>>?
        val coroutine_suspended: Object = IntrinsicsKt.getCOROUTINE_SUSPENDED()
        val i: Int = label
        if (i == 0) {
            ResultKt.throwOnFailure(obj)
            objectRef = `$response`
            val repos: APIRepository? = `this$0`.getRepos()
            if (repos == null) {
                t = 0
                objectRef.element = t
            ...
            `L$0` = objectRef
            label = 1
            val loadPage: Object = repos.loadPage(`$url`, this)
            ...
            objectRef2 = `L$0` as ObjectRef<*>?
            ResultKt.throwOnFailure(obj)
        }
        val objectRef3: ObjectRef<Resource<PageResponse>>? = objectRef2
        t = obj
