...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.home.HomeViewModel\$load$1",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.home.HomeViewModel$load$1 */ /* loaded from: classes3.dex */
class `HomeViewModel$load$1` constructor(/* synthetic */val `this$0`: HomeViewModel,
                                                        mainAPI: MainAPI,
                                                        continuation: Continuation<in `HomeViewModel$load$1`?>?
    ...
    public override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `HomeViewModel$load$1`(`this$0`, `$api`, continuation)
    }
    ...
    public override fun invoke(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `HomeViewModel$load$1`).invokeSuspend(Unit.INSTANCE)
    }

    /* JADX WARN: Removed duplicated region for block: B:74:0x0179  */ /* JADX WARN: Removed duplicated region for block: B:78:0x0091 A[EXC_TOP_SPLITTER, SYNTHETIC] */ /* JADX WARN: Removed duplicated region for block: B:80:0x00e8 A[SYNTHETIC] */ /* JADX WARN: Removed duplicated region for block: B:83:0x00c6 A[SYNTHETIC] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */ public override fun invokeSuspend(r11: Any?): Any {
        /*
            Method dump skipped, instructions count: 421
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.home.HomeViewModel\$load$1.invokeSuspend(java.lang.Object):java.lang.Object")
    }
}