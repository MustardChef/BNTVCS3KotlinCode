...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.livetv.LiveTvViewModel",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.livetv.LiveTvViewModel$getIPTV$1 */ /* loaded from: classes3.dex */
class `LiveTvViewModel$getIPTV$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: LiveTvViewModel, continuation: Continuation<in `LiveTvViewModel$getIPTV$1`?>?
