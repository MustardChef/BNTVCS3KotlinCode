...
internal class `AbstractPlayerFragment$onViewCreated$3`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) : FunctionReferenceImpl(
    1,
    obj,
    AbstractPlayerFragment::class.java,
    "playerError",
    "playerError(Ljava/lang/Exception;)V",
    0
), Function1<Exception, Unit> {
    @Override // kotlin.jvm.functions.Function1
    public /* bridge */ /* synthetic */  override fun invoke(exc: Exception) {
        invoke2(exc)
        return Unit.INSTANCE
    }

    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(p0: Exception) {
        Intrinsics.checkNotNullParameter(p0, "p0")
        (this.receiver as AbstractPlayerFragment).playerError(p0)
    }
}