...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.AbstractPlayerFragment$onViewCreated$4 */ /* loaded from: classes3.dex */
/* synthetic */   class `AbstractPlayerFragment$onViewCreated$4`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) : FunctionReferenceImpl(
    ...
    @Override // kotlin.jvm.functions.Functions
        ...
        (this.receiver as AbstractPlayerFragment).requestAudioFocus()
    }
}