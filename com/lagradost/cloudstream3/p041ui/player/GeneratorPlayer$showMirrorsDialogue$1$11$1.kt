...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.GeneratorPlayer$showMirrorsDialogue$1$11$1 */ /* loaded from: classes3.dex */
class `GeneratorPlayer$showMirrorsDialogue$1$11$1` internal constructor() : Lambda<Any?>(0),
    Functions<Unit> {
    ...
    companion object {
        val INSTANCE: `GeneratorPlayer$showMirrorsDialogue$1$11$1` =
            `GeneratorPlayer$showMirrorsDialogue$1$11$1`()
    }
}