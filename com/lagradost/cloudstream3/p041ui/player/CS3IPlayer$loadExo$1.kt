...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: CS3IPlayer.kt */
@Metadata(
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.CS3IPlayer$loadExo$1 */ /* loaded from: classes3.dex */
/* synthetic */   class `CS3IPlayer$loadExo$1`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) :
    FunctionReferenceImpl(0, obj, CS3IPlayer::class.java, "reloadSubs", "reloadSubs()V", 0),
    Functions<Unit> {
    ...
    @Override // kotlin.jvm.functions.Functions
        ...
        (this.receiver as CS3IPlayer).reloadSubs()
    }
}