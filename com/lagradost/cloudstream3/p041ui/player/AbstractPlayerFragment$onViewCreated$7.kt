...
internal class `AbstractPlayerFragment$onViewCreated$7`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) : FunctionReferenceImpl(
    1,
    obj,
    AbstractPlayerFragment::class.java,
    "playerPositionChanged",
    "playerPositionChanged(Lkotlin/Pair;)V",
    0
), Function1<Tuples<out Long?, out Long?>?, Unit> {
    @Override // kotlin.jvm.functions.Function1
    public /* bridge */ /* synthetic */  override fun invoke(tuples: Tuples<out Long?, out Long?>?) {
        invoke2(tuples as Tuples<Long?, Long?>?)
        return Unit.INSTANCE
    }

    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(p0: Tuples<Long?, Long?>?) {
        Intrinsics.checkNotNullParameter(p0, "p0")
        (this.receiver as AbstractPlayerFragment).playerPositionChanged(p0)
    }
}