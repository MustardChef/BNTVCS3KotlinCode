...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.GeneratorPlayer$onResume$1$1 */ /* loaded from: classes3.dex */
class `GeneratorPlayer$onResume$1$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.player.GeneratorPlayer$onResume$1$1$1 */ /* loaded from: classes3.dex */
    class C48691  /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ internal constructor(/* synthetic */
    ...
    fun invoke2(it: SubtitleData) {
        ...
        Coroutines.INSTANCE.runOnMainThread(C48691(`this$0`, it))
    }
}