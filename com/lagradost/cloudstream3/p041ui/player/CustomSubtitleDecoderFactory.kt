...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/ui/player/CustomSubtitleDecoderFactory;", "Lcom/google/android/exoplayer2/text/SubtitleDecoderFactory;", "()V", "createDecoder", "Lcom/google/android/exoplayer2/text/SubtitleDecoder;", "format", "Lcom/google/android/exoplayer2/Format;", "supportsFormat", "", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.CustomSubtitleDecoderFactory */ /* loaded from: classes3.dex */
class CustomSubtitleDecoderFactory constructor() : SubtitleDecoderFactory {
    @Override // com.google.android.exoplayer2.text.SubtitleDecoderFactory
    public override fun supportsFormat(format: Format): Boolean {
        Intrinsics.checkNotNullParameter(format, "format")
        return CollectionsKt.contains(
    ...
    @Override // com.google.android.exoplayer2.text.SubtitleDecoderFactory
    public override fun createDecoder(format: Format): SubtitleDecoder {
        Intrinsics.checkNotNullParameter(format, "format")
