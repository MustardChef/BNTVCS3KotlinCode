...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/ui/player/CSPlayerEvent;", "", "value", "", "(Ljava/lang/String;II)V", "getValue", "()I", "Pause", "Play", "SeekForward", "SeekBack", "NextEpisode", "PrevEpisode", "PlayPauseToggle", "ToggleMute", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.player.CSPlayerEvent */ /* loaded from: classes3.dex */
enum class CSPlayerEvent(val value: Int) {
    Pause(0), Play(1), SeekForward(2), SeekBack(3), NextEpisode(5), PrevEpisode(6), PlayPauseToggle(
        7
    ),
    ToggleMute(8);
