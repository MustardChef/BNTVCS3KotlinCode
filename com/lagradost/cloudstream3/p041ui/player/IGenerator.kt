...
open interface IGenerator {
    ...
    fun getCurrent(i: Int): Object
    val currentId: Integer
    val hasCache: Boolean
    fun getLoadResponse(): LoadResponse?

    /* renamed from: goto */
    fun mo8669goto(i: Int)
    operator fun hasNext(): Boolean
    fun hasPrev(): Boolean
    operator fun next()
    fun prev()
    fun setLoadResponse(loadResponse: LoadResponse?)
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.player.IGenerator$DefaultImpls */ /* loaded from: classes3.dex */
    object DefaultImpls {
        fun  /* synthetic */`getCurrent$default`(
            ...
            throw UnsupportedOperationException("Super calls with default arguments not supported in this target, function: getCurrent")
        }

        fun  /* synthetic */`generateLinks$default`(
            iGenerator: IGenerator?,
            z: Boolean,
            z2: Boolean,
            function1: Function1<*, *>,
            ...
            if (obj == null) {
                return iGenerator!!.generateLinks(
                    z,
                    z2,
                    function1,
                    function12,
                    if ((i2 and 16) != 0) 0 else i,
                    continuation
                )
            }
            throw UnsupportedOperationException("Super calls with default arguments not supported in this target, function: generateLinks")
        }
    }
}