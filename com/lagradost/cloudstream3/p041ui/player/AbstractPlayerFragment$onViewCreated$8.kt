...
internal class `AbstractPlayerFragment$onViewCreated$8`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) : FunctionReferenceImpl(
    1,
    obj,
    AbstractPlayerFragment::class.java,
    "playerDimensionsLoaded",
    "playerDimensionsLoaded(Lkotlin/Pair;)V",
    0
    ...
    fun invoke2(p0: Tuples<Integer?, Integer?>?) {
        ...
        (this.receiver as AbstractPlayerFragment).playerDimensionsLoaded(p0)
    }
}