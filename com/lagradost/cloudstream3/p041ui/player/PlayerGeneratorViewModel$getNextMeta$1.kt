...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.PlayerGeneratorViewModel$getNextMeta$1 */ /* loaded from: classes3.dex */
class `PlayerGeneratorViewModel$getNextMeta$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    val `this$0`: PlayerGeneratorViewModel
) : Lambda<Any?>(0), Functions<Object?> {
    ...
    */ public override fun invoke(): Any {
        ...
        L21:
            return r0
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.player.PlayerGeneratorViewModel\$getNextMeta$1.invoke():java.lang.Object")
    }
}