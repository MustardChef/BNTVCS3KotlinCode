...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.AbstractPlayerFragment$onViewCreated$11 */ /* loaded from: classes3.dex */
/* synthetic */   class `AbstractPlayerFragment$onViewCreated$11`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) : FunctionReferenceImpl(
    1,
    obj,
    AbstractPlayerFragment::class.java,
    "onSubStyleChanged",
    "onSubStyleChanged(Lcom/lagradost/cloudstream3/ui/subtitles/SaveCaptionStyle;)V",
    0
), Function1<SaveCaptionStyle, Unit> {
    @Override // kotlin.jvm.functions.Function1
    public /* bridge */ /* synthetic */  override fun invoke(saveCaptionStyle: SaveCaptionStyle) {
        invoke2(saveCaptionStyle)
        return Unit.INSTANCE
    }

    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(p0: SaveCaptionStyle) {
        Intrinsics.checkNotNullParameter(p0, "p0")
        (this.receiver as AbstractPlayerFragment).onSubStyleChanged(p0)
    }
}