...
@Metadata(
    m108d1 = ["\u0000\u0006\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001H\u008a@"],
    m107d2 = ["<anonymous>", "Lcom/lagradost/cloudstream3/HomePageResponse;"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.APIRepository\$getMainPage$2",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.APIRepository$getMainPage$2 */ /* loaded from: classes.dex */
class `APIRepository$getMainPage$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: APIRepository, continuation: Continuation<in `APIRepository$getMainPage$2`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in HomePageResponse?>?, Object> {
    var label: Int = 0

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `APIRepository$getMainPage$2`(`this$0`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    public override fun invoke(continuation: Continuation<in HomePageResponse?>?): Object {
        return (create(continuation) as `APIRepository$getMainPage$2`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            label = 1
            obj = `this$0`.getApi().getMainPage(this)
        ...
        val homePageResponse: HomePageResponse? = obj
