...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.SelectSourceController$1$3$loadMirror$1 */ /* loaded from: classes.dex */
class `SelectSourceController$1$3$loadMirror$1` constructor(/* synthetic */val `$index`: Int, /* synthetic */
    ...
    public /* bridge */ /* synthetic */  override fun invoke(bool: Boolean) {
        invoke(bool.booleanValue())
        return Unit.INSTANCE
    }

    override fun invoke(z: Boolean) {
        SelectSourceController.Companion.`m8608lambda11$lambda10$loadMirror`(
            `$holder`,
            `$epData`,
            `this$0`,
            `$index` + 1
