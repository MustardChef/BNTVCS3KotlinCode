...
@Metadata(
    m108d1 = ["\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"],
    m107d2 = ["<anonymous>", "", "click", "Lcom/lagradost/cloudstream3/ui/download/DownloadHeaderClickEvent;", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.download.DownloadFragment$onViewCreated$adapter$1 */ /* loaded from: classes3.dex */
internal class `DownloadFragment$onViewCreated$adapter$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    val `this$0`: DownloadFragment
) : Lambda<Any?>(1), Function1<DownloadHeaderClickEvent, Unit> {
    @Override // kotlin.jvm.functions.Function1
    public /* bridge */ /* synthetic */  override fun invoke(downloadHeaderClickEvent: DownloadHeaderClickEvent) {
        invoke2(downloadHeaderClickEvent)
        return Unit.INSTANCE
    }

    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(click: DownloadHeaderClickEvent) {
        var appCompatActivity: AppCompatActivity?
        Intrinsics.checkNotNullParameter(click, "click")
        val action: Int = click.getAction()
        if (action != 0) {
            if (action == 1 && (`this$0`.getActivity() as AppCompatActivity?. also ({
                    appCompatActivity = it
                })) != null) {
                AppUtils.INSTANCE.loadResult(
                    appCompatActivity,
                    click.getData().url,
                    click.getData().apiName,
            ...
            val folderName: String = DataStore.INSTANCE.getFolderName(
                DataStoreKt.DOWNLOAD_EPISODE_CACHE,
                String.valueOf(click.getData().id)
            )
            ...
            if (activity != null) {
                UIHelper.INSTANCE.navigate(
                    ...
                    DownloadChildFragment.Companion.Companion.newInstance(
                        click.getData().name,
                        folderName
                    )
                )
