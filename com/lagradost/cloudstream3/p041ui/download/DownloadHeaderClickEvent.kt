...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.download.DownloadHeaderClickEvent */ /* loaded from: classes3.dex */
class DownloadHeaderClickEvent constructor(i: Int, data: DownloadHeaderCached?) {
    val action: Int
    ...
    operator fun component2(): DownloadHeaderCached? {
        return data
    }

    fun copy(i: Int, data: DownloadHeaderCached?): DownloadHeaderClickEvent {
        Intrinsics.checkNotNullParameter(data, "data")
        return DownloadHeaderClickEvent(i, data)
    }
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is DownloadHeaderClickEvent) {
            val downloadHeaderClickEvent: DownloadHeaderClickEvent = obj
            return action == downloadHeaderClickEvent.action && Intrinsics.areEqual(
                data, downloadHeaderClickEvent.data
            )
        }
        return false
    }
    ...
    override fun hashCode(): Int {
        return (action * 31) + data.hashCode()
    }

    override fun toString(): String {
        return "DownloadHeaderClickEvent(action=" + action + ", data=" + data + ')'
    }
    ...
    companion object {
        fun  /* synthetic */`copy$default`(
            downloadHeaderClickEvent: DownloadHeaderClickEvent,
            i: Int,
            downloadHeaderCached: DownloadHeaderCached?,
            i2: Int,
            obj: Object?
        ): DownloadHeaderClickEvent {
            var i: Int = i
            var downloadHeaderCached: DownloadHeaderCached? = downloadHeaderCached
            if ((i2 and 1) != 0) {
