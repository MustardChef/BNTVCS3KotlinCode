...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.search.SearchHistoryCallback */ /* loaded from: classes4.dex */
class SearchHistoryCallback constructor(item: SearchHistoryItem, i: Int) {
    val clickAction: Int
    val item: SearchHistoryItem
    operator fun component1(): SearchHistoryItem {
        return item
    }
    ...
    fun copy(item: SearchHistoryItem, i: Int): SearchHistoryCallback {
        Intrinsics.checkNotNullParameter(item, "item")
        return SearchHistoryCallback(item, i)
    }
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is SearchHistoryCallback) {
            val searchHistoryCallback: SearchHistoryCallback = obj
            return Intrinsics.areEqual(
                item,
                searchHistoryCallback.item
            ) && clickAction == searchHistoryCallback.clickAction
        }
        return false
    }

    override fun hashCode(): Int {
        return (item.hashCode() * 31) + clickAction
    }

    override fun toString(): String {
        return "SearchHistoryCallback(item=" + item + ", clickAction=" + clickAction + ')'
    }
    ...
    companion object {
        fun  /* synthetic */`copy$default`(
            ...
            var searchHistoryItem: SearchHistoryItem = searchHistoryItem
            var i: Int = i
            if ((i2 and 1) != 0) {
