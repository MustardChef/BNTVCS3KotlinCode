...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.search.SearchViewModel\$updateHistory$1",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.search.SearchViewModel$updateHistory$1 */ /* loaded from: classes4.dex */
class `SearchViewModel$updateHistory$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: SearchViewModel,
    continuation: Continuation<in `SearchViewModel$updateHistory$1`?>?
    ...
    public override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `SearchViewModel$updateHistory$1`(`this$0`, continuation)
    }
    ...
    public override fun invoke(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `SearchViewModel$updateHistory$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    @DebugMetadata(
        m99c = "com.lagradost.cloudstream3.ui.search.SearchViewModel\$updateHistory$1$1",
        m98f = "SearchViewModel.kt",
        m97i = [],
        m96l = [],
        m95m = "invokeSuspend",
        m94n = [],
        m93s = []
    ) /* renamed from: com.lagradost.cloudstream3.ui.search.SearchViewModel$updateHistory$1$1 */ /* loaded from: classes4.dex */
    class C49611  /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ internal constructor(/* synthetic */
        val `this$0`: SearchViewModel, continuation: Continuation<in C49611?>?
        ...
        public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
            return C49611(`this$0`, continuation)
        }

        @Override // kotlin.jvm.functions.Function1
        public override fun invoke(continuation: Continuation<in Unit>?): Object {
            return (create(continuation) as C49611).invokeSuspend(Unit.INSTANCE)
        }
        ...
        */ public override fun invokeSuspend(r6: Any?): Any {
            /*
                r5 = this;
            ...
            L83:
                ...
                throw r6
            */
            throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.search.SearchViewModel\$updateHistory$1.C49611.invokeSuspend(java.lang.Object):java.lang.Object")
        }
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        if (label == 0) {
            ...
            Coroutines.INSTANCE.ioSafe(C49611(`this$0`, null))
