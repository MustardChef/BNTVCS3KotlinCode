...
/* renamed from: com.lagradost.cloudstream3.ui.search.SearchFragment$onViewCreated$adapter$1$1 */ /* loaded from: classes4.dex */
internal class `SearchFragment$onViewCreated$adapter$1$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
