...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.search.SearchResponseDiffCallback */ /* loaded from: classes4.dex */
class SearchResponseDiffCallback constructor(
    oldList: List<SearchResponse>,
    newList: List<SearchResponse>
) : DiffUtil.Callback() {
    ...
    public override fun areItemsTheSame(i: Int, i2: Int): Boolean {
        return Intrinsics.areEqual(oldList.get(i).getName(), newList.get(i2).getName())
    }
