...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.settings.SettingsUI$onCreatePreferences$1$1 */ /* loaded from: classes4.dex */
class `SettingsUI$onCreatePreferences$1$1` internal constructor() : Lambda<Any?>(0),
    Functions<Unit> {
    ...
    companion object {
        val INSTANCE: `SettingsUI$onCreatePreferences$1$1` = `SettingsUI$onCreatePreferences$1$1`()
    }
}