...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.settings.SettingsPlayer$onCreatePreferences$4$2 */ /* loaded from: classes4.dex */
class `SettingsPlayer$onCreatePreferences$4$2` constructor(
    sharedPreferences: SharedPreferences,
    settingsPlayer: SettingsPlayer,
    list: List<Integer>
) : Lambda<Any?>(1), Function1<Integer, Unit> {
    /* synthetic */ val `$prefValues`: List<Integer>
    ...
    override fun invoke(i: Int) {
        `$settingsManager`.edit()
            .putInt(`this$0`.getString(R.string.quality_pref_key), `$prefValues`.get(i).intValue())
            .apply()
    }
}