...
@Metadata(
    m108d1 = ["\u0000\u0006\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001H\u008a@"],
    m107d2 = ["<anonymous>", "Lcom/lagradost/cloudstream3/PageResponse;"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.APIRepository\$loadPage$2",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.APIRepository$loadPage$2 */ /* loaded from: classes.dex */
class `APIRepository$loadPage$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: APIRepository, /* synthetic */
    val `$url`: String?, continuation: Continuation<in `APIRepository$loadPage$2`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in PageResponse?>?, Object> {
    var label: Int = 0

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `APIRepository$loadPage$2`(`this$0`, `$url`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    public override fun invoke(continuation: Continuation<in PageResponse?>?): Object {
        return (create(continuation) as `APIRepository$loadPage$2`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            label = 1
            obj = `this$0`.getApi().loadPage(`$url`, this)
        ...
        val pageResponse: PageResponse? = obj as PageResponse?
