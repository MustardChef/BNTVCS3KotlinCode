...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.subtitles.ChromecastSubtitlesFragment$onViewCreated$3$3 */ /* loaded from: classes4.dex */
class `ChromecastSubtitlesFragment$onViewCreated$3$3` constructor(/* synthetic */val `this$0`: ChromecastSubtitlesFragment,
    ...
    override fun invoke(i: Int) {
        ...
        saveChromeCaptionStyle.setEdgeType((arrayList.get(i) as Number).intValue())
