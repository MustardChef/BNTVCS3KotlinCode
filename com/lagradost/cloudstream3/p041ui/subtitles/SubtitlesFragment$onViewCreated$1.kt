...
internal class `SubtitlesFragment$onViewCreated$1`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) : FunctionReferenceImpl(
    1,
    obj,
    SubtitlesFragment::class.java,
    "onColorSelected",
    ...
    fun invoke2(p0: Tuples<Integer?, Integer?>) {
        ...
        (this.receiver as SubtitlesFragment).onColorSelected(p0)
    }
}