...
@Metadata(
    m108d1 = ["\u0000\u0006\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001H\u008a@"],
    m107d2 = ["<anonymous>", "Lcom/lagradost/cloudstream3/LoadResponse;"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.APIRepository\$load$2",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.APIRepository$load$2 */ /* loaded from: classes.dex */
class `APIRepository$load$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: APIRepository, /* synthetic */
    val `$url`: String?, continuation: Continuation<in `APIRepository$load$2`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in LoadResponse?>?, Object> {
    var label: Int = 0

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `APIRepository$load$2`(`this$0`, `$url`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    public override fun invoke(continuation: Continuation<in LoadResponse?>?): Object {
        return (create(continuation) as `APIRepository$load$2`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            label = 1
            obj = `this$0`.getApi().load(MainAPIKt.fixUrl(`this$0`.getApi(), `$url`), this)
        ...
        val loadResponse: LoadResponse? = obj as LoadResponse?
