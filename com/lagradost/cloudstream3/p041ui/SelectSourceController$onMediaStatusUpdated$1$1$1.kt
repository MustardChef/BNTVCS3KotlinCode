...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.SelectSourceController$onMediaStatusUpdated$1$1$1 */ /* loaded from: classes.dex */
class `SelectSourceController$onMediaStatusUpdated$1$1$1` internal constructor() : Lambda<Any?>(1),
    ...
    override fun invoke(z: Boolean) {
        System.out.println("FAILED TO LOAD NEXT ITEM" as Object?)
    }

    companion object {
        val INSTANCE: `SelectSourceController$onMediaStatusUpdated$1$1$1` =
