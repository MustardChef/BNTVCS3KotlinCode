...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.result.ResultViewModel\$load$1",
    m98f = "ResultViewModel.kt",
    m97i = [0, 1, 2, 2, 2],
    m96l = [330, 352, 401],
    m95m = "invokeSuspend",
    m94n = ["api", "validUrl", "loadResponse", "dubStatus", "mainId"],
    m93s = ["L$0", "L$0", "L$0", "L$1", "I$0"]
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultViewModel$load$1 */ /* loaded from: classes4.dex */
class `ResultViewModel$load$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: ResultViewModel, /* synthetic */
    val `$url`: String?, /* synthetic */
    val `$apiName`: String?, /* synthetic */
    val `$showFillers`: Boolean, continuation: Continuation<in `ResultViewModel$load$1`?>?
    ...
    public override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `ResultViewModel$load$1`(`this$0`, `$url`, `$apiName`, `$showFillers`, continuation)
    }
    ...
    public override fun invoke(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `ResultViewModel$load$1`).invokeSuspend(Unit.INSTANCE)
    }

    /* JADX WARN: Removed duplicated region for block: B:106:0x03a2  */ /* JADX WARN: Removed duplicated region for block: B:37:0x0101  */ /* JADX WARN: Removed duplicated region for block: B:80:0x0267  */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */ public override fun invokeSuspend(r34: Any?): Any {
        /*
            Method dump skipped, instructions count: 1308
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.result.ResultViewModel\$load$1.invokeSuspend(java.lang.Object):java.lang.Object")
    }
}