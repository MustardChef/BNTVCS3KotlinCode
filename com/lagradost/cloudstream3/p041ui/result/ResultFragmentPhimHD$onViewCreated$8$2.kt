...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$8$2 */ /* loaded from: classes4.dex */
class `ResultFragmentPhimHD$onViewCreated$8$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    fun invoke2(popupMenuNoIcons: MenuItem) {
        ...
        resultViewModel!!.updateWatchStatus(
            WatchType.Companion.Companion.fromInternalId(
                Integer.valueOf(
                    popupMenuNoIcons.getItemId()
                )
            )
        )
    }
