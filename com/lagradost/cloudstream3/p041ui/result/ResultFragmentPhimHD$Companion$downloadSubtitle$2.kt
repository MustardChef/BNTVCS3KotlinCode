...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD\$Companion\$downloadSubtitle$2",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$Companion$downloadSubtitle$2 */ /* loaded from: classes4.dex */
class `ResultFragmentPhimHD$Companion$downloadSubtitle$2` constructor(
    context: Context,
    extractorSubtitleLink: ExtractorSubtitleLink,
    str: String,
    str2: String,
    continuation: Continuation<in `ResultFragmentPhimHD$Companion$downloadSubtitle$2`?>?
    ...
    public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `ResultFragmentPhimHD$Companion$downloadSubtitle$2`(
            `$context`,
            `$link`,
            `$fileName`,
            `$folder`,
    ...
    public override fun invoke(continuation: Continuation<in Unit>?): Object {
        return (create(continuation) as `ResultFragmentPhimHD$Companion$downloadSubtitle$2`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$Companion$downloadSubtitle$2$1 */ /* loaded from: classes4.dex */
    class C49301 internal constructor() : Lambda<Any?>(1),
