...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.result.SyncViewModel\$updateUserData$1",
    ...
    m94n = ["lastError"],
    m93s = ["L$0"]
) /* renamed from: com.lagradost.cloudstream3.ui.result.SyncViewModel$updateUserData$1 */ /* loaded from: classes4.dex */
class `SyncViewModel$updateUserData$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: SyncViewModel, continuation: Continuation<in `SyncViewModel$updateUserData$1`?>?
    ...
    public override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `SyncViewModel$updateUserData$1`(`this$0`, continuation)
    }
    ...
    public override fun invoke(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `SyncViewModel$updateUserData$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    */ public override fun invokeSuspend(r14: Any?): Any {
        /*
            Method dump skipped, instructions count: 260
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.result.SyncViewModel\$updateUserData$1.invokeSuspend(java.lang.Object):java.lang.Object")
    }
}