...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentTV$onViewCreated$9 */ /* loaded from: classes4.dex */
internal class `ResultFragmentTV$onViewCreated$9`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    fun invoke2(watchType: WatchType) {
        ...
        if (num != null) {
            val resultFragmentTV: ResultFragmentTV = `this$0`
            ...
            val extendedFloatingActionButton4: ExtendedFloatingActionButton? =
                resultFragmentTV.`_$_findCachedViewById`(C4761R.C4764id.result_bookmark_fab) as ExtendedFloatingActionButton?
        ...
        if (extendedFloatingActionButton6 != null) {
            ...
            extendedFloatingActionButton6.setOnClickListener(object : OnClickListener() {
                // from class: com.lagradost.cloudstream3.ui.result.-$$Lambda$ResultFragmentTV$onViewCreated$9$RgavvDFtPAjgmoCzUTF2dbVokTo
                @Override // android.view.View.OnClickListener
                fun onClick(view: View?) {
                    `m8857invoke$lambda2`(this@ResultFragmentTV, watchType, view)
                }
            })
        }
    }
    ...
    companion object {
        ...
        fun `m8857invoke$lambda2`(`this$0`: ResultFragmentTV, watchType: WatchType, view: View) {
            ...
            if (activity != null) {
                ...
                singleSelectionHelper.showBottomDialog(
                    ...
                    string,
                    false,
                    `ResultFragmentTV$onViewCreated$9$2$2`.Companion.INSTANCE,
                    `ResultFragmentTV$onViewCreated$9$2$3`(`this$0`)
                )
            }
        }
    }
