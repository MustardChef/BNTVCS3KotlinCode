...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$setSyncMaxEpisodes$1 */ /* loaded from: classes4.dex */
class `ResultFragmentPhimHD$onViewCreated$setSyncMaxEpisodes$1` constructor(/* synthetic */
    val `this$0`: ResultFragmentPhimHD, num: Integer?
