...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentTV$onViewCreated$9$2$2 */ /* loaded from: classes4.dex */
class `ResultFragmentTV$onViewCreated$9$2$2` internal constructor() : Lambda<Any?>(0),
    Functions<Unit> {
    ...
    companion object {
        val INSTANCE: `ResultFragmentTV$onViewCreated$9$2$2` =
