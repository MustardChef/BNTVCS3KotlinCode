...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$18 */ /* loaded from: classes4.dex */
internal class `ResultFragmentPhimHD$onViewCreated$18` constructor(/* synthetic */val `this$0`: ResultFragmentPhimHD,
                                                                                  intRef: IntRef
    ...
    fun invoke2(resource: Resource<SyncStatus?>?) {
        ...
        if (resource is Resource.Failure) {
            ...
            if (resource is Loading) {
                ...
                if (maxEpisodes != null) {
                    ResultFragmentPhimHD.Companion.`onViewCreated$setSyncMaxEpisodes`(
                        `this$0`,
                ...
                ArchComponentExt.normalSafeApiCall<Unit>(C49322(`this$0`, syncStatus))
            }
            z = false
        }
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$18$2 */ /* loaded from: classes4.dex */
    class C49322 internal constructor(/* synthetic */val `this$0`: ResultFragmentPhimHD,
                                                     syncStatus: SyncStatus
    ) : Lambda<Any?>(0), Functions<Unit> {
        /* renamed from: $d */
        /* synthetic */ val `f10018$d`: SyncStatus
        ...
        public override fun invoke() {
            ...
            if (context != null && (context.getString(R.string.sync_score_format)
                ...
                val score: Integer? = `f10018$d`.getScore()
