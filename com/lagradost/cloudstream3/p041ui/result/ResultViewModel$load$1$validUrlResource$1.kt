...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.result.ResultViewModel\$load$1\$validUrlResource$1",
    m98f = "ResultViewModel.kt",
    m97i = [],
    m96l = [MediaError.DetailedErrorCode.SMOOTH_NETWORK],
    m95m = "invokeSuspend",
    m94n = [],
    m93s = []
)
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultViewModel$load$1$validUrlResource$1 */ /* loaded from: classes4.dex */
internal class `ResultViewModel$load$1$validUrlResource$1` constructor(/* synthetic */val `$url`: String,
                                                                                      mainAPI: MainAPI,
                                                                                      continuation: Continuation<in `ResultViewModel$load$1$validUrlResource$1`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in String?>?, Object> {
    ...
    public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `ResultViewModel$load$1$validUrlResource$1`(`$url`, `$api`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    public override fun invoke(continuation: Continuation<in String?>?): Object {
        return (create(continuation) as `ResultViewModel$load$1$validUrlResource$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            label = 1
            obj = AnilistRedirector.INSTANCE.redirect(
                `$url`,
                StringsKt.`replace$default`(
                    `$api`.mainUrl,
                    NineAnimeProvider().getMainUrl(),
                    "9anime",
                    false,
                    4,
                    null as Object?
