...
@Metadata(
    m108d1 = ["\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"],
    m107d2 = ["<anonymous>", "", "it", "Lcom/lagradost/cloudstream3/ui/download/DownloadClickEvent;", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.result.EpisodeAdapter$EpisodeCardViewHolder$reattachDownloadButton$1 */ /* loaded from: classes4.dex */
internal class `EpisodeAdapter$EpisodeCardViewHolder$reattachDownloadButton$1` constructor(
    episodeCardViewHolder: EpisodeCardViewHolder,
    resultEpisode: ResultEpisode
) : Lambda<Any?>(1), Function1<DownloadClickEvent, Unit> {
    /* synthetic */ val `$card`: ResultEpisode
    /* synthetic */ val `this$0`: EpisodeCardViewHolder
    ...
    fun invoke2(it: DownloadClickEvent) {
        val function1: Function1<*, *>
        val function12: Function1<*, *>
        Intrinsics.checkNotNullParameter(it, "it")
        if (it.getAction() == 4) {
            function12 = `this$0`.clickCallback
            function12.invoke(EpisodeClickEvent(6, `$card`))
            return
        }
        function1 = `this$0`.downloadClickCallback
        function1.invoke(it)
    }
}