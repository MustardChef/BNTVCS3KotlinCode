...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$11 */ /* loaded from: classes4.dex */
internal class `ResultFragmentPhimHD$onViewCreated$11`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    */
    fun invoke2(r7: List<Int?>?) {
        ...
        L82:
            return
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.result.ResultFragmentPhimHD\$onViewCreated$11.invoke2(java.util.List):void")
    }

    companion object {
        /* JADX INFO: Access modifiers changed from: private */ /* renamed from: invoke$lambda-2  reason: not valid java name */
        fun `m8783invoke$lambda2`(`this$0`: ResultFragmentPhimHD, seasonList: List?, view: View?) {
            ...
            if (materialButton != null) {
                ...
                uIHelper.popupMenuNoIconsAndNoStringRes(
                    materialButton2,
                    arrayList,
                    `ResultFragmentPhimHD$onViewCreated$11$2$2`(`this$0`)
                )
            }
        }
    }
