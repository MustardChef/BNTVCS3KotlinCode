...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentTV$setActors$2 */ /* loaded from: classes4.dex */
internal class `ResultFragmentTV$setActors$2` constructor() : Lambda<Any?>(1),
    ...
    companion object {
        val INSTANCE: `ResultFragmentTV$setActors$2` = `ResultFragmentTV$setActors$2`()
    }
}