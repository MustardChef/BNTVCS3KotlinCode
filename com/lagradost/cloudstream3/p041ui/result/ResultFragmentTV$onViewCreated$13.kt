...
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentTV$onViewCreated$13 */ /* loaded from: classes4.dex */
internal class `ResultFragmentTV$onViewCreated$13`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    */
    fun invoke2(r6: List<String?>?) {
        ...
        L99:
            return
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.result.ResultFragmentTV\$onViewCreated$13.invoke2(java.util.List):void")
    }
}