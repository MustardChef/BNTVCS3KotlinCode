...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD\$Companion\$downloadEpisode$2",
    ...
    m93s = ["L$0", "L$1"]
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$Companion$downloadEpisode$2 */ /* loaded from: classes4.dex */
class `ResultFragmentPhimHD$Companion$downloadEpisode$2` constructor(/* synthetic */val `$episode`: ResultEpisode?,
                                                                                    activity: Activity,
                                                                                    z: Boolean,
                                                                                    str: String?,
                                                                                    tvType: TvType?,
                                                                                    ...
                                                                                    i: Int,
                                                                                    str4: String?,
                                                                                    continuation: Continuation<in `ResultFragmentPhimHD$Companion$downloadEpisode$2`?>?
    ...
    public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `ResultFragmentPhimHD$Companion$downloadEpisode$2`(
            `$episode`,
            `$activity`,
            `$currentIsMovie`,
            `$currentHeaderName`,
    ...
    public override fun invoke(continuation: Continuation<in Unit>?): Object {
        return (create(continuation) as `ResultFragmentPhimHD$Companion$downloadEpisode$2`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            if (IGenerator.DefaultImpls.`generateLinks$default`(
                    ...
                    false,
                    false,
                    C49271(linkedHashSet),
                    C49282(linkedHashSet2),
                    0,
                    this,
                    16,
                    null
        ...
        if (linkedHashSet.isEmpty()) {
            Coroutines.INSTANCE.main(C49293(`$activity`, null))
            return Unit.INSTANCE
        }
        ResultFragmentPhimHD.Companion.Companion.startDownload(
            `$activity`,
            `$episode`,
            `$currentIsMovie`,
            `$currentHeaderName`,
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$Companion$downloadEpisode$2$1 */ /* loaded from: classes4.dex */
    class C49271 internal constructor(set: Set<ExtractorLink>?) : Lambda<Any?>(1),
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$Companion$downloadEpisode$2$2 */ /* loaded from: classes4.dex */
    class C49282 internal constructor(set: Set<SubtitleData>) : Lambda<Any?>(1),
    ...
    @DebugMetadata(
        m99c = "com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD\$Companion\$downloadEpisode$2$3",
        m98f = "ResultFragmentPhimHD.kt",
        m97i = [],
        m96l = [],
        m95m = "invokeSuspend",
        m94n = [],
        m93s = []
    ) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$Companion$downloadEpisode$2$3 */ /* loaded from: classes4.dex */
    class C49293 internal constructor(activity: Activity, continuation: Continuation<in C49293?>?) :
        SuspendLambda(1, continuation), Function1<Continuation<in Unit>?, Object> {
        /* synthetic */ val `$activity`: Activity
        var label: Int = 0
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
            return C49293(`$activity`, continuation)
        }

        @Override // kotlin.jvm.functions.Function1
        public override fun invoke(continuation: Continuation<in Unit>?): Object {
            return (create(continuation) as C49293).invokeSuspend(Unit.INSTANCE)
        }
