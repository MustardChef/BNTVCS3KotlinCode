...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: YourUpload.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.YourUpload",
    m98f = "YourUpload.kt",
    m97i = [0, 0, 0],
    m96l = [17],
    m95m = "getUrl",
...
class `YourUpload$getUrl$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: YourUpload, continuation: Continuation<in `YourUpload$getUrl$1`?>?
