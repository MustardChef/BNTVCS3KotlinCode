...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.Pelisplus",
    m98f = "Pelisplus.kt",
    m97i = [0, 0, 0, 0, 1, 1, 1, 1],
    m96l = [45, 76],
    m95m = "getUrl",
    m94n = ["subtitleCallback", "callback", "extractorUrl", "isCasting", "subtitleCallback", "callback", "extractorUrl", "isCasting"],
    m93s = ["L$0", "L$1", "L$2", "Z$0", "L$0", "L$1", "L$2", "Z$0"]
) /* loaded from: classes3.dex */
class `Pelisplus$getUrl$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: Pelisplus, continuation: Continuation<in `Pelisplus$getUrl$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.getUrl(null, false, null, null, this)
    }
}