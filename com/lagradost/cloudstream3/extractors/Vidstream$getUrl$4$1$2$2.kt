...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.Vidstream\$getUrl$4$1$2$2",
    m98f = "Vidstream.kt",
    m97i = [],
    m96l = [92],
    m95m = "invokeSuspend",
...
internal class `Vidstream$getUrl$4$1$2$2`(/* synthetic */val `$link`: String, /* synthetic */
                                                         val `$extractorUrl`: String,
                                                         function1: Function1<in SubtitleFile, Unit>?,
                                                         function12: Function1<in ExtractorLink, Unit>,
                                                         continuation: Continuation<in `Vidstream$getUrl$4$1$2$2`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `vidstream$getUrl$4$1$2$2` = `Vidstream$getUrl$4$1$2$2`(
            `$link`,
            `$extractorUrl`,
            `$subtitleCallback`,
            `$callback`,
    ...
    override fun invoke(extractorApi: ExtractorApi, continuation: Continuation<in Unit>?): Object {
        return (create(
            extractorApi,
            continuation
        ) as `Vidstream$getUrl$4$1$2$2`).invokeSuspend(Unit.INSTANCE)
    }
