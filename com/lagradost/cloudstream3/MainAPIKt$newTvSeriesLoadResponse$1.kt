...
internal class `MainAPIKt$newTvSeriesLoadResponse$1` : Lambda<Any?>(1),
    Function1<TvSeriesLoadResponse?, Unit> {
    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(tvSeriesLoadResponse: TvSeriesLoadResponse?) {
    ...
    companion object {
        val INSTANCE = `MainAPIKt$newTvSeriesLoadResponse$1`()
    }
}