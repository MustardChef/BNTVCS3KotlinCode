...
@DebugMetadata(
    ...
    m96l = [74, 107],
    m95m = "load",
    m94n = ["this", "url", "this", "url", "title", "year", TypedValues.TransitionType.S_DURATION, "poster", "descript"],
    m93s = ["L$0", "L$1", "L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "L$6"]
) /* loaded from: classes3.dex */
class `VfFilmProvider$load$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: VfFilmProvider, continuation: Continuation<in `VfFilmProvider$load$1`?>?
