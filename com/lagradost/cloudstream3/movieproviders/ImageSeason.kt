...
class ImageSeason(
    ...
    fun copy(
        ...
        return ImageSeason(j, imageableType, j2, j3, url, type, originalURL)
    }
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is ImageSeason) {
            val imageSeason = obj as ImageSeason
            return imageableID == imageSeason.imageableID && Intrinsics.areEqual(
                imageableType, imageSeason.imageableType
            ) && serverID == imageSeason.serverID && proxyID == imageSeason.proxyID && Intrinsics.areEqual(
                url, imageSeason.url
            ) && Intrinsics.areEqual(type, imageSeason.type) && Intrinsics.areEqual(
    ...
    override fun hashCode(): Int {
        return (((((`C$r8$backportedMethods$utility$Long$1$hashCode`.hashCode(imageableID) * 31 + imageableType.hashCode()) * 31 + `C$r8$backportedMethods$utility$Long$1$hashCode`.hashCode(
            serverID
        )) * 31 + `C$r8$backportedMethods$utility$Long$1$hashCode`.hashCode(proxyID)) * 31 + url.hashCode()) * 31 + type.hashCode()) * 31 + originalURL.hashCode()
    }

    override fun toString(): String {
        return "ImageSeason(imageableID=" + imageableID + ", imageableType=" + imageableType + ", serverID=" + serverID + ", proxyID=" + proxyID + ", url=" + url + ", type=" + type + ", originalURL=" + originalURL + ')'
    }
