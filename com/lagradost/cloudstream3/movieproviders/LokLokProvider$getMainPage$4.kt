...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.LokLokProvider\$getMainPage$4",
...
class `LokLokProvider$getMainPage$4`(
    objectRef: ObjectRef<ArrayList<HomePageList?>?>,
    lokLokProvider: LokLokProvider,
    continuation: Continuation<in `LokLokProvider$getMainPage$4`?>?
    ...
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `LokLokProvider$getMainPage$4`(`$responseFirstPage`, `this$0`, continuation)
    }
    ...
    fun invoke2(continuation: Continuation<Object?>?): Object {
        return (create(continuation) as `LokLokProvider$getMainPage$4`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            obj2 = Requests.`get$default`(
                ...
                "https://ga-mobile-api.loklok.tv/cms/app/homePage/getHome?page=2",
