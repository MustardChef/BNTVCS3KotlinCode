...
internal class `LayarKacaProvider$toBottomSearchResult$1`(/* synthetic */val `$posterUrl`: String,
                                                                         searchQuality: SearchQuality
) : Lambda<Any?>(1), Function1<MovieSearchResponse?, Unit> {
    /* synthetic */ val `$quality`: SearchQuality
    ...
    fun invoke2(newMovieSearchResponse: MovieSearchResponse) {
        ...
        newMovieSearchResponse.quality = `$quality`
    }
}