...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.LokLokProvider",
    m98f = "LokLokProvider.kt",
    m97i = [0, 0, 0, 0, 0],
    m96l = [195],
    m95m = "getMainPage",
    m94n = ["responseFirstPage", "listMenuTvShow", "menuTitleTvShow", "menuTitleMovie", "listMenuMovies"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$4"]
) /* loaded from: classes3.dex */
class `LokLokProvider$getMainPage$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: LokLokProvider, continuation: Continuation<in `LokLokProvider$getMainPage$1`?>?
