...
@DebugMetadata(
    ...
    m97i = [0, 1],
    m96l = [MediaError.DetailedErrorCode.DASH_NO_INIT, 327],
    m95m = "getDataEpisode",
    m94n = ["this", "this"],
    m93s = ["L$0", "L$0"]
) /* loaded from: classes3.dex */
class `SubNhanhProvider$getDataEpisode$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SubNhanhProvider,
    continuation: Continuation<in `SubNhanhProvider$getDataEpisode$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.getDataEpisode(null, this)
    }
}