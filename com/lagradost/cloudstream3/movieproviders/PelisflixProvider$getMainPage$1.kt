...
@DebugMetadata(
    ...
    m96l = [29],
    m95m = "getMainPage",
    m94n = ["this", FirebaseAnalytics.Param.ITEMS, "i"],
    m93s = ["L$0", "L$1", "L$3"]
) /* loaded from: classes3.dex */
class `PelisflixProvider$getMainPage$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: PelisflixProvider,
    continuation: Continuation<in `PelisflixProvider$getMainPage$1`?>?
