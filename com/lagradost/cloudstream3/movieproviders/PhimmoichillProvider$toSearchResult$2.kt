...
internal class `PhimmoichillProvider$toSearchResult$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    ...
    fun invoke2(newMovieSearchResponse: MovieSearchResponse) {
        ...
        newMovieSearchResponse.posterUrl = `$posterUrl`
        MainAPIKt.addQuality(newMovieSearchResponse, `$quality`)
    }
}