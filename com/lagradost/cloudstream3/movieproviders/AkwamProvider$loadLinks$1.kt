...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.AkwamProvider",
    m98f = "AkwamProvider.kt",
    m97i = [0, 0, 0, 1, 1, 1, 1],
    m96l = [184, 208],
    m95m = "loadLinks",
    m94n = ["this", "data", "callback", "this", "callback", "destination\$iv\$iv", "it"],
    m93s = ["L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$4"]
) /* loaded from: classes3.dex */
class `AkwamProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AkwamProvider, continuation: Continuation<in `AkwamProvider$loadLinks$1`?>?
