...
class `PelisplusProviderTemplate$load$episodes$1$1`(
    num: Integer,
    num2: Integer,
    str: String,
    str2: String
) : Lambda<Any?>(1), Function1<Episode?, Unit> {
    /* synthetic */ val `$epDate`: String
    /* synthetic */ val `$epThumb`: String
    /* synthetic */ val `$episode`: Integer
    ...
    fun invoke2(newEpisode: Episode) {
        ...
        newEpisode.setEpisode(`$episode`)
        newEpisode.posterUrl = `$epThumb`
        MainAPIKt.`addDate$default`(newEpisode, `$epDate`, null, 2, null)
    }
}