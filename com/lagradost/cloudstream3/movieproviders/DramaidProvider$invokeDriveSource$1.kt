...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: DramaidProvider.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.DramaidProvider",
    m98f = "DramaidProvider.kt",
    m97i = [0, 0, 0, 0],
    m96l = [161],
    m95m = "invokeDriveSource",
    m94n = ["this", "name", "subCallback", "sourceCallback"],
    m93s = ["L$0", "L$1", "L$2", "L$3"]
) /* loaded from: classes3.dex */
class `DramaidProvider$invokeDriveSource$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: DramaidProvider,
    continuation: Continuation<in `DramaidProvider$invokeDriveSource$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val invokeDriveSource: Object
        result = obj
        label = label or Integer.MIN_VALUE
        invokeDriveSource = `this$0`.invokeDriveSource(null, null, null, null, this)
