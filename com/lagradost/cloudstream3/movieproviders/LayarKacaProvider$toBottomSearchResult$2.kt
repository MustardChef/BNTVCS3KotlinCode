...
internal class `LayarKacaProvider$toBottomSearchResult$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(  /* synthetic */
    ...
    fun invoke2(newTvSeriesSearchResponse: TvSeriesSearchResponse) {
        ...
        newTvSeriesSearchResponse.setPosterUrl(`$posterUrl`)
    }
}