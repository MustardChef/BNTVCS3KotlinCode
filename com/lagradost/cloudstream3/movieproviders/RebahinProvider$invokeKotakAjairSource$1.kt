...
@DebugMetadata(
    ...
    m97i = [0, 0, 0, 0, 0],
    m96l = [bqk.f6555bO],
    m95m = "invokeKotakAjairSource",
    m94n = ["this", "url", "subCallback", "sourceCallback", "domainUrl"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$4"]
) /* loaded from: classes3.dex */
class `RebahinProvider$invokeKotakAjairSource$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: RebahinProvider,
    continuation: Continuation<in `RebahinProvider$invokeKotakAjairSource$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val invokeKotakAjairSource: Object
        result = obj
        label = label or Integer.MIN_VALUE
        invokeKotakAjairSource = `this$0`.invokeKotakAjairSource(null, null, null, this)
