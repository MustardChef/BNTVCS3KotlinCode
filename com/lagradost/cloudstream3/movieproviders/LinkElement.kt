...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/movieproviders/LinkElement;", "", "src", "", "(Ljava/lang/String;)V", "getSrc", "()Ljava/lang/String;", "component1", "copy", "equals", "", "other", "hashCode", "", "toString", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* loaded from: classes3.dex */
class LinkElement(@JsonProperty("src") src: String) {
    val src: String
    operator fun component1(): String {
        return src
    }

    fun copy(@JsonProperty("src") src: String): LinkElement {
        Intrinsics.checkNotNullParameter(src, "src")
        return LinkElement(src)
    }

    override fun equals(obj: Object): Boolean {
        return if (this === obj) {
            true
        } else obj is LinkElement && Intrinsics.areEqual(
            src,
            (obj as LinkElement).src
        )
    }
