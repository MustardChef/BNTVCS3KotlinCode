...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.TwoEmbedProvider",
    m98f = "TwoEmbedProvider.kt",
    m97i = [0, 0, 0, 0],
    m96l = [55],
    m95m = "loadLinks",
    m94n = ["this", "subtitleCallback", "callback", "embedUrl"],
    m93s = ["L$0", "L$1", "L$2", "L$3"]
) /* loaded from: classes3.dex */
class `TwoEmbedProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: TwoEmbedProvider, continuation: Continuation<in `TwoEmbedProvider$loadLinks$1`?>?
