...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: PeliSmartProvider.kt */
@Metadata(
    m108d1 = ["\u0000\u000c\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"],
    m107d2 = ["<anonymous>", "", "it", ""],
    m106k = 3,
...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.PeliSmartProvider\$loadLinks$2",
    m98f = "PeliSmartProvider.kt",
    m97i = [],
    m96l = [155],
    m95m = "invokeSuspend",
    m94n = [],
...
class `PeliSmartProvider$loadLinks$2`(/* synthetic */val `$data`: String,
                                                     function1: Function1<in SubtitleFile, Unit>,
                                                     function12: Function1<in ExtractorLink, Unit>,
                                                     continuation: Continuation<in `PeliSmartProvider$loadLinks$2`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `peliSmartProvider$loadLinks$2` =
            `PeliSmartProvider$loadLinks$2`(`$data`, `$subtitleCallback`, `$callback`, continuation)
    ...
    override fun invoke(str: String, continuation: Continuation<in Boolean?>?): Object {
        return (create(
            str,
            continuation
        ) as `PeliSmartProvider$loadLinks$2`).invokeSuspend(Unit.INSTANCE)
    }
                    ...
                    StringsKt.`replace$default`(
                        StringsKt.`replace$default`(
                            StringsKt.`replace$default`(
                                StringsKt.`replace$default`(
                                    `L$0` as String?,
                                    "https://pelismart.com/p/1.php?v=",
                                    "https://evoload.io/e/",
                                    false,
                                    4,
                                    null as Object?
                                ),
                                "https://pelismart.com/p/2.php?v=",
                                "https://streamtape.com/e/",
                                false,
                                4,
                                null as Object?
                            ),
                            "https://pelismart.com/p/4.php?v=",
                            "https://dood.to/e/",
                            false,
                            4,
                            null as Object?
                        ),
                        "https://pelismarthd.com/p/1.php?v=",
                        "https://evoload.io/e/",
                        false,
                        4,
                        null as Object?
                    ),
                    "https://pelismarthd.com/p/2.php?v=",
                    "https://streamtape.com/e/",
                    false,
                    4,
                    null as Object?
                ),
                "https://pelismarthd.com/p/4.php?v=",
                "https://dood.to/e/",
                false,
                4,
                null as Object?
