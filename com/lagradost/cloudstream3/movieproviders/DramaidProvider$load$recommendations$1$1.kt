...
internal class `DramaidProvider$load$recommendations$1$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(  /* synthetic */
    val `$epPoster`: String
    ...
    fun invoke2(newTvSeriesSearchResponse: TvSeriesSearchResponse) {
        ...
        newTvSeriesSearchResponse.setPosterUrl(`$epPoster`)
    }
}