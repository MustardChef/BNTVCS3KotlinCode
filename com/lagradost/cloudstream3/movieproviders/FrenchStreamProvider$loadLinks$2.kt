...
@Metadata(
    m108d1 = ["\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\u0010\u0000\u001a\u00020\u00012\u0012\u0010\u0002\u001a\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00040\u0003H\u008a@"],
    m107d2 = ["<anonymous>", "", "it", "Lkotlin/Pair;", ""],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.FrenchStreamProvider\$loadLinks$2",
    m98f = "FrenchStreamProvider.kt",
    m97i = [],
    m96l = [bqk.f6560bT],
    m95m = "invokeSuspend",
    m94n = [],
...
class `FrenchStreamProvider$loadLinks$2`(
    function1: Function1<in SubtitleFile, Unit>,
    function12: Function1<in ExtractorLink, Unit>,
    continuation: Continuation<in `FrenchStreamProvider$loadLinks$2`?>?
) : SuspendLambda(2, continuation),
    Function2<Tuples<out String?, out String?>, Continuation<in Unit>?, Object> {
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `frenchStreamProvider$loadLinks$2` = `FrenchStreamProvider$loadLinks$2`(
            `$subtitleCallback`, `$callback`, continuation
        )
    ...
    fun invoke2(tuples: Tuples<String?, String?>, continuation: Continuation<in Unit>?): Object {
        return (create(tuples, continuation) as `FrenchStreamProvider$loadLinks$2`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            var i2 = 0
            val length = extractorApis.size
            while (true) {
                if (i2 >= length) {
                    break
                }
                val extractorApi: ExtractorApi = extractorApis[i2]
                if (StringsKt.contains(
                        tuples!!.first as CharSequence,
                        extractorApi.name as CharSequence,
                        true
                    )
                ) {
                    label = 1
                    if (extractorApi.getSafeUrl(
                            tuples!!.second as String,
                            tuples.second as String,
                            `$subtitleCallback`,
                            `$callback`,
                            this
