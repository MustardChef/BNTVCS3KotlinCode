...
class `SflixProvider$Companion$getUpdatedData$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SflixProvider.Companion,
    continuation: Continuation<in `SflixProvider$Companion$getUpdatedData$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val updatedData: Object
        result = obj
        label = label or Integer.MIN_VALUE
        updatedData = `this$0`.getUpdatedData(null, null, null, this)
        return updatedData
    }
}