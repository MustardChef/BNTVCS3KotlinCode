...
@DebugMetadata(
    ...
    m97i = [0, 0],
    m96l = [bqk.f6552bL, bqk.f6576bj],
    m95m = "loadLinks",
    m94n = ["subtitleCallback", "callback"],
    m93s = ["L$0", "L$1"]
) /* loaded from: classes3.dex */
class `IHaveNoTvProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: IHaveNoTvProvider,
    continuation: Continuation<in `IHaveNoTvProvider$loadLinks$1`?>?
