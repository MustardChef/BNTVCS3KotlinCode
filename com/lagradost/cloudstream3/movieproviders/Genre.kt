...
class Genre(@JsonProperty("name") name: String, @JsonProperty("pivot") pivot: Pivot) {
    val name: String
    val pivot: Pivot
    ...
    fun copy(@JsonProperty("name") name: String, @JsonProperty("pivot") pivot: Pivot): Genre {
        Intrinsics.checkNotNullParameter(name, "name")
        Intrinsics.checkNotNullParameter(pivot, "pivot")
        return Genre(name, pivot)
    }
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is Genre) {
            val genre = obj as Genre
            return Intrinsics.areEqual(name, genre.name) && Intrinsics.areEqual(
                pivot, genre.pivot
            )
        }
        return false
    ...
    override fun hashCode(): Int {
        return name.hashCode() * 31 + pivot.hashCode()
    }

    override fun toString(): String {
        return "Genre(name=" + name + ", pivot=" + pivot + ')'
    }
