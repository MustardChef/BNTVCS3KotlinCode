...
class `AllMoviesForYouProvider$load$3$1`(/* synthetic */val `$name`: String,
                                                        tuples: Tuples<Integer, String>,
                                                        num: Integer,
                                                        allMoviesForYouProvider: AllMoviesForYouProvider,
                                                        str2: String,
                                                        str3: String
) : Lambda<Any?>(1), Function1<Episode?, Unit> {
    /* synthetic */ val `$date`: String
    /* synthetic */ val `$epNum`: Integer
    /* synthetic */ val `$poster`: String
    /* synthetic */ val `$season`: Tuples<Integer, String>
    ...
    fun invoke2(newEpisode: Episode) {
        ...
        newEpisode.setSeason(`$season`.getFirst())
        newEpisode.setEpisode(`$epNum`)
        newEpisode.posterUrl = MainAPIKt.fixUrlNull(`this$0`, `$poster`)
        MainAPIKt.`addDate$default`(newEpisode, `$date`, null, 2, null)
    }
}