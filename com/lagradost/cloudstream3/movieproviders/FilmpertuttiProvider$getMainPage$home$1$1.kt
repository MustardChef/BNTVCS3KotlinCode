...
internal class `FilmpertuttiProvider$getMainPage$home$1$1`(/* synthetic */val `$image`: String,
    ...
    fun invoke2(newTvSeriesSearchResponse: TvSeriesSearchResponse) {
        ...
        newTvSeriesSearchResponse.setPosterUrl(`$image`)
        newTvSeriesSearchResponse.setQuality(`$quality`)
    }
}