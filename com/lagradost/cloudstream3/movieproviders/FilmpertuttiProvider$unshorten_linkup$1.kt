...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: FilmpertuttiProvider.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.FilmpertuttiProvider",
    m98f = "FilmpertuttiProvider.kt",
    m97i = [1],
    m96l = [181, 199, bqk.f6550bJ],
    m95m = "unshorten_linkup",
    m94n = [ShareConstants.MEDIA_URI],
    m93s = ["L$0"]
) /* loaded from: classes3.dex */
class `FilmpertuttiProvider$unshorten_linkup$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: FilmpertuttiProvider,
    continuation: Continuation<in `FilmpertuttiProvider$unshorten_linkup$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.unshorten_linkup(null, this)
    }
}