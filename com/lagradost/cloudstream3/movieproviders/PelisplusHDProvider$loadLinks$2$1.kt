...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.PelisplusHDProvider\$loadLinks$2$1",
...
class `PelisplusHDProvider$loadLinks$2$1`(/* synthetic */val `$data`: String,
                                                         function1: Function1<in SubtitleFile, Unit>,
                                                         function12: Function1<in ExtractorLink, Unit>,
                                                         continuation: Continuation<in `PelisplusHDProvider$loadLinks$2$1`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `pelisplusHDProvider$loadLinks$2$1` = `PelisplusHDProvider$loadLinks$2$1`(
            `$data`,
            `$subtitleCallback`,
            `$callback`,
            continuation
    ...
    override fun invoke(str: String, continuation: Continuation<in Boolean?>?): Object {
        return (create(
            str,
            continuation
        ) as `PelisplusHDProvider$loadLinks$2$1`).invokeSuspend(Unit.INSTANCE)
    }
