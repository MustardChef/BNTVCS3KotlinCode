...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.TocanimeProvider",
...
class `TocanimeProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: TocanimeProvider, continuation: Continuation<in `TocanimeProvider$loadLinks$1`?>?
