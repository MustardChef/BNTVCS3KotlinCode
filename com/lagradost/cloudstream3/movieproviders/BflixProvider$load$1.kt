...
@DebugMetadata(
    ...
    m97i = [0, 0, 1, 1, 1, 1, 1, 1, 1],
    m96l = [bqk.f6553bM, bqk.f6543bC],
    m95m = "load\$suspendImpl",
    m94n = ["this", "url", "this", "url", "soup", "title", "description", "poster", "tags"],
    m93s = ["L$0", "L$1", "L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "L$6"]
) /* loaded from: classes3.dex */
class `BflixProvider$load$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: BflixProvider, continuation: Continuation<in `BflixProvider$load$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return BflixProvider.Companion.`load$suspendImpl`(
            `this$0`,
            null as String?,
