...
class `SuperStream$Data$toSearchResponse$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(  /* synthetic */
    val `this$0`: SuperStream.Data
    ...
    fun invoke2(newMovieSearchResponse: MovieSearchResponse) {
        ...
        var posterOrg: String? = `this$0`.posterOrg
        if (posterOrg == null) {
            posterOrg = `this$0`.poster
        }
        newMovieSearchResponse.posterUrl = posterOrg
        newMovieSearchResponse.setYear(`this$0`.year)
        val qualityTag: String? = `this$0`.qualityTag
        newMovieSearchResponse.quality = MainAPIKt.getQualityFromString(
            if (qualityTag == null || StringsKt.`replace$default`(
                    qualityTag,
                    "-",
                    "",
                    false,
