...
class `PelisflixProvider$load$3$1`(/* synthetic */val `$name`: String, /* synthetic */
                                                  val `$seasonInt`: Int,
                                                  num: Integer,
    ...
    /* synthetic */ val `$epthumb`: String
    /* synthetic */ val `this$0`: PelisflixProvider

    /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    init {
        `$epNum` = num
        `this$0` = pelisflixProvider
        `$epthumb` = str2
        `$date` = str3
    }
    ...
    fun invoke2(newEpisode: Episode) {
        ...
        newEpisode.setSeason(Integer.valueOf(`$seasonInt`))
        newEpisode.setEpisode(`$epNum`)
        newEpisode.posterUrl = MainAPIKt.fixUrlNull(`this$0`, `$epthumb`)
