...
class `FilmpertuttiProvider$load$5`(/* synthetic */val `this$0`: FilmpertuttiProvider, /* synthetic */
                                                   val `$poster`: String,
                                                   num: Integer,
                                                   str2: String,
                                                   str3: String,
    ...
    fun invoke2(newMovieLoadResponse: MovieLoadResponse) {
        ...
        LoadResponse.Companion.addRating(movieLoadResponse, `$rating`)
        LoadResponse.Companion.addTrailer(movieLoadResponse, `$trailerurl`)
    }
}