...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: VfSerieProvider.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.VfSerieProvider",
    m98f = "VfSerieProvider.kt",
    m97i = [0, 0, 1, 1],
    m96l = [74, 95],
    m95m = "loadLinks",
    m94n = ["this", "callback", "this", "callback"],
    m93s = ["L$0", "L$1", "L$0", "L$1"]
) /* loaded from: classes3.dex */
class `VfSerieProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: VfSerieProvider, continuation: Continuation<in `VfSerieProvider$loadLinks$1`?>?
