...
@DebugMetadata(
    ...
    m96l = [544],
    m95m = "loadLinks",
    m94n = ["this", "data", "callback"],
    m93s = ["L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `TheFlixToProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: TheFlixToProvider,
    continuation: Continuation<in `TheFlixToProvider$loadLinks$1`?>?
