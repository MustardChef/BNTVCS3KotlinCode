...
@DebugMetadata(
    ...
    m96l = [166],
    m95m = "loadLinks",
    m94n = ["data", "subtitleCallback", "callback"],
    m93s = ["L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `PelisplusHDProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: PelisplusHDProvider,
    continuation: Continuation<in `PelisplusHDProvider$loadLinks$1`?>?
