...
@DebugMetadata(
    ...
    m96l = [137, 140],
    m95m = "loadLinks",
    m94n = ["this", "data", "callback", "links", "this", "callback", "links"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `UakinoProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: UakinoProvider, continuation: Continuation<in `UakinoProvider$loadLinks$1`?>?
