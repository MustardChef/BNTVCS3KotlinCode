...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.FilmpertuttiProvider\$loadLinks$2",
    m98f = "FilmpertuttiProvider.kt",
    m97i = [],
    m96l = [226, bqk.f6543bC, bqk.f6596cc, bqk.f6526am, 235],
    m95m = "invokeSuspend",
    m94n = [],
    m93s = []
)
/* loaded from: classes3.dex */
internal class `FilmpertuttiProvider$loadLinks$2`(/* synthetic */val `this$0`: FilmpertuttiProvider, /* synthetic */
                                                                 val `$data`: String?,
                                                                 function1: Function1<in SubtitleFile?, Unit>?,
                                                                 function12: Function1<in ExtractorLink?, Unit>?,
                                                                 continuation: Continuation<in `FilmpertuttiProvider$loadLinks$2`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `filmpertuttiProvider$loadLinks$2` = `FilmpertuttiProvider$loadLinks$2`(
            `this$0`,
            `$data`,
            `$subtitleCallback`,
            `$callback`,
    ...
    override fun invoke(str: String, continuation: Continuation<in Boolean?>?): Object {
        return (create(
            str,
            continuation
        ) as `FilmpertuttiProvider$loadLinks$2`).invokeSuspend(Unit.INSTANCE)
    }

    /* JADX WARN: Removed duplicated region for block: B:23:0x009d A[RETURN] */ /* JADX WARN: Removed duplicated region for block: B:32:0x0101 A[RETURN] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */   override fun invokeSuspend(r25: Any?): Any {
        ...
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.movieproviders.FilmpertuttiProvider\$loadLinks$2.invokeSuspend(java.lang.Object):java.lang.Object")
    }
}