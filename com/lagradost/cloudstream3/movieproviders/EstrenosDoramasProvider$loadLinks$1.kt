...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.EstrenosDoramasProvider",
    m98f = "EstrenosDoramasProvider.kt",
    m97i = [0, 0, 0, 0, 0],
    m96l = [189],
    m95m = "loadLinks",
    m94n = ["this", "data", "subtitleCallback", "callback", "headers"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$4"]
) /* loaded from: classes3.dex */
class `EstrenosDoramasProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: EstrenosDoramasProvider,
    continuation: Continuation<in `EstrenosDoramasProvider$loadLinks$1`?>?
