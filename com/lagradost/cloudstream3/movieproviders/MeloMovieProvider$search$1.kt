...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: MeloMovieProvider.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.MeloMovieProvider",
    m98f = "MeloMovieProvider.kt",
    m97i = [0, 0],
    m96l = [41],
    m95m = "search",
    m94n = ["this", "returnValue"],
    m93s = ["L$0", "L$1"]
) /* loaded from: classes3.dex */
class `MeloMovieProvider$search$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MeloMovieProvider, continuation: Continuation<in `MeloMovieProvider$search$1`?>?
