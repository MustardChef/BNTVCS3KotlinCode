...
class `PelisflixProvider$load$4`(/* synthetic */val `this$0`: PelisflixProvider, /* synthetic */
                                                val `$poster`: String, /* synthetic */
                                                val `$year`: String, /* synthetic */
                                                val `$descipt`: String, num: Integer, str4: String
) : Lambda<Any?>(1), Function1<MovieLoadResponse?, Unit> {
    /* synthetic */ val `$duration`: String
    ...
    fun invoke2(newMovieLoadResponse: MovieLoadResponse) {
        ...
        newMovieLoadResponse.plot = `$descipt`
        newMovieLoadResponse.setRating(`$rating`)
        LoadResponse.Companion.addDuration(newMovieLoadResponse, `$duration`)
    }
}