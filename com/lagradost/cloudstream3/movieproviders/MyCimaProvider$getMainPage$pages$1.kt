...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.MyCimaProvider\$getMainPage\$pages$1",
...
internal class `MyCimaProvider$getMainPage$pages$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MyCimaProvider,
    continuation: Continuation<in `MyCimaProvider$getMainPage$pages$1`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `myCimaProvider$getMainPage$pages$1` =
            `MyCimaProvider$getMainPage$pages$1`(`this$0`, continuation)
    ...
    fun invoke2(
        ...
        return (create(tuples, continuation) as `MyCimaProvider$getMainPage$pages$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        Intrinsics.checkNotNullExpressionValue(
            select,
            "doc.select(\"div.Grid--MycimaPosts div.GridItem\")"
        )
