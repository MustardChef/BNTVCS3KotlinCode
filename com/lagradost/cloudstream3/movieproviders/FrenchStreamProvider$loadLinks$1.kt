...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.FrenchStreamProvider",
    m98f = "FrenchStreamProvider.kt",
    m97i = [0, 0, 0, 0, 0, 1, 1, 1],
    m96l = [165, 206],
    m95m = "loadLinks",
    m94n = ["this", "subtitleCallback", "callback", "split", "wantedEpisode", "this", "subtitleCallback", "callback"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$4", "L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `FrenchStreamProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: FrenchStreamProvider,
    continuation: Continuation<in `FrenchStreamProvider$loadLinks$1`?>?
