...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.LokLokProvider\$getMainPage$3",
...
class `LokLokProvider$getMainPage$3`(
    objectRef: ObjectRef<ArrayList<HomePageList?>?>,
    lokLokProvider: LokLokProvider,
    continuation: Continuation<in `LokLokProvider$getMainPage$3`?>?
    ...
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `LokLokProvider$getMainPage$3`(`$responseFirstPage`, `this$0`, continuation)
    }
    ...
    fun invoke2(continuation: Continuation<Object?>?): Object {
        return (create(continuation) as `LokLokProvider$getMainPage$3`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        Intrinsics.checkNotNullExpressionValue(
            fromJson,
            "Gson().fromJson<HomeResp…ss.java\n                )"
        )
