...
@DebugMetadata(
    ...
    m97i = [0, 0, 0, 0, 0],
    m96l = [TypedValues.AttributesType.TYPE_PIVOT_TARGET],
    m95m = "loadLinks\$suspendImpl",
    m94n = ["this", "data", "subtitleCallback", "callback", "prefix"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$4"]
) /* loaded from: classes3.dex */
class `SflixProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SflixProvider, continuation: Continuation<in `SflixProvider$loadLinks$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return SflixProvider.Companion.`loadLinks$suspendImpl`(
            `this$0`,
            null as String?,
            false,
            null as Function1<*, *>?,
