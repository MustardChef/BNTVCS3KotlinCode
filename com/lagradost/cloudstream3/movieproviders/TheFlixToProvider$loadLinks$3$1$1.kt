...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.TheFlixToProvider\$loadLinks$3$1$1",
...
class `TheFlixToProvider$loadLinks$3$1$1`(/* synthetic */val `$authhost`: String, /* synthetic */
                                                         val `$qualityReg`: Regex,
                                                         function1: Function1<in ExtractorLink, Unit>,
                                                         theFlixToProvider: TheFlixToProvider,
                                                         continuation: Continuation<in `TheFlixToProvider$loadLinks$3$1$1`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `theFlixToProvider$loadLinks$3$1$1` = `TheFlixToProvider$loadLinks$3$1$1`(
            `$authhost`,
            `$qualityReg`,
            `$callback`,
            `this$0`,
    ...
    fun invoke2(str: String, continuation: Continuation<Object?>?): Object {
        return (create(
            str,
            continuation
        ) as `TheFlixToProvider$loadLinks$3$1$1`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            obj2 = Requests.`get$default`(
                app,
                `$authhost` + "/tv/videos/" + `L$0` as String? + "/request-access?contentUsageType=Viewing",
        ...
        obj3 = try {
            Requests.Companion.getMapper().readValue<VideoData>(
                ...
                object :
                    TypeReference<VideoData?>() { // from class: com.lagradost.cloudstream3.movieproviders.TheFlixToProvider$loadLinks$3$1$1$invokeSuspend$$inlined$parsedSafe$1
                })
        } catch (e: Exception) {
            e.printStackTrace()
            null
