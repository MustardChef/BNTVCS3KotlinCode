...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.ElifilmsProvider\$loadLinks$2",
...
class `ElifilmsProvider$loadLinks$2`(/* synthetic */val `this$0`: ElifilmsProvider, /* synthetic */
                                                    val `$data`: String,
                                                    function1: Function1<in SubtitleFile, Unit>,
                                                    function12: Function1<in ExtractorLink, Unit>,
                                                    continuation: Continuation<in `ElifilmsProvider$loadLinks$2`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `elifilmsProvider$loadLinks$2` = `ElifilmsProvider$loadLinks$2`(
            `this$0`,
            `$data`,
            `$subtitleCallback`,
            `$callback`,
    ...
    override fun invoke(element: Element, continuation: Continuation<in Boolean?>?): Object {
        return (create(
            element,
            continuation
        ) as `ElifilmsProvider$loadLinks$2`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            val encodedurl: String = (`L$0` as Element?)!!.attr("data-id")
            Intrinsics.checkNotNullExpressionValue(encodedurl, "encodedurl")
            val base64Decode: String = MainAPIKt.base64Decode(encodedurl)
            label = 1
            obj = ExtractorApiKt.loadExtractor(
                MainAPIKt.fixUrl(`this$0`, base64Decode),
                `$data`,
                `$subtitleCallback`,
                `$callback`,
                this
