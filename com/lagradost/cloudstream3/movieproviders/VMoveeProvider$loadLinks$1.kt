...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: VMoveeProvider.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.VMoveeProvider",
    m98f = "VMoveeProvider.kt",
    m97i = [0, 0, 1, 1, 2, 2],
    m96l = [72, 84, 88],
    m95m = "loadLinks",
    m94n = ["this", "callback", "this", "callback", "this", "callback"],
    m93s = ["L$0", "L$1", "L$0", "L$1", "L$0", "L$1"]
) /* loaded from: classes3.dex */
class `VMoveeProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: VMoveeProvider, continuation: Continuation<in `VMoveeProvider$loadLinks$1`?>?
