...
internal class `PhimmoichillProvider$toSearchResult$1`(/* synthetic */val `$posterUrl`: String,
                                                                      num: Integer?
    ...
    fun invoke2(newAnimeSearchResponse: AnimeSearchResponse) {
        ...
        newAnimeSearchResponse.posterUrl = `$posterUrl`
        MainAPIKt.addSub(newAnimeSearchResponse, `$episode`)
    }
}