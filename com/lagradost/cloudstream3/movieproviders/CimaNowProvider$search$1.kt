...
@DebugMetadata(
    ...
    m96l = [60],
    m95m = "search",
    m94n = ["this", "query", "result"],
    m93s = ["L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `CimaNowProvider$search$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: CimaNowProvider, continuation: Continuation<in `CimaNowProvider$search$1`?>?
