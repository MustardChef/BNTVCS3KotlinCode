...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/movieproviders/Vote;", "", "title_id", "", "average", "", "count", "type", "(JLjava/lang/String;JLjava/lang/String;)V", "getAverage", "()Ljava/lang/String;", "getCount", "()J", "getTitle_id", "getType", "component1", "component2", "component3", "component4", "copy", "equals", "", "other", "hashCode", "", "toString", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* loaded from: classes3.dex */
class Vote(
    @JsonProperty("title_id") j: Long,
    @JsonProperty("average") average: String,
    @JsonProperty("count") j2: Long,
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is Vote) {
            val vote = obj as Vote
            return title_id == vote.title_id && Intrinsics.areEqual(
                average,
                vote.average
            ) && count == vote.count && Intrinsics.areEqual(
                type, vote.type
            )
        }
        return false
    ...
    override fun hashCode(): Int {
        return ((`C$r8$backportedMethods$utility$Long$1$hashCode`.hashCode(title_id) * 31 + average.hashCode()) * 31 + `C$r8$backportedMethods$utility$Long$1$hashCode`.hashCode(
            count
        )) * 31 + type.hashCode()
    }

    override fun toString(): String {
        return "Vote(title_id=" + title_id + ", average=" + average + ", count=" + count + ", type=" + type + ')'
    }
