...
@DebugMetadata(
    ...
    m96l = [28, 51],
    m95m = "getMainPage",
    m94n = ["this", FirebaseAnalytics.Param.ITEMS, "name", "this", FirebaseAnalytics.Param.ITEMS],
    m93s = ["L$0", "L$1", "L$3", "L$0", "L$1"]
) /* loaded from: classes3.dex */
class `CineblogProvider$getMainPage$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: CineblogProvider,
    continuation: Continuation<in `CineblogProvider$getMainPage$1`?>?
