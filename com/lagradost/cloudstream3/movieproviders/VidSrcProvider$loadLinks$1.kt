...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: VidSrcProvider.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.VidSrcProvider",
    m98f = "VidSrcProvider.kt",
    m97i = [],
    m96l = [47],
    m95m = "loadLinks",
    m94n = [],
...
class `VidSrcProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: VidSrcProvider, continuation: Continuation<in `VidSrcProvider$loadLinks$1`?>?
