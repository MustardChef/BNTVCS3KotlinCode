...
@Metadata(
    m108d1 = ["\u0000\u0006\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001H\u008a@"],
    m107d2 = ["<anonymous>", "Lcom/lagradost/cloudstream3/syncproviders/SyncAPI\$SyncStatus;"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.syncproviders.SyncRepo\$getStatus$2",
    m98f = "SyncRepo.kt",
    m97i = [],
    m96l = [19],
    m95m = "invokeSuspend",
...
class `SyncRepo$getStatus$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SyncRepo, /* synthetic */
    val `$id`: String?, continuation: Continuation<in `SyncRepo$getStatus$2`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in SyncStatus?>?, Object> {
    var label = 0

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `SyncRepo$getStatus$2`(`this$0`, `$id`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    override fun invoke(continuation: Continuation<in SyncStatus?>?): Object {
        return (create(continuation) as `SyncRepo$getStatus$2`).invokeSuspend(Unit.INSTANCE)
    }
