...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: OpenSubtitlesApi.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.syncproviders.providers.OpenSubtitlesApi",
    m98f = "OpenSubtitlesApi.kt",
    m97i = [0, 0, 0],
    m96l = [97],
    m95m = "initLogin",
    m94n = ["this", AppLovinEventParameters.USER_ACCOUNT_IDENTIFIER, "password"],
    m93s = ["L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `OpenSubtitlesApi$initLogin$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: OpenSubtitlesApi, continuation: Continuation<in `OpenSubtitlesApi$initLogin$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val initLogin: Object
        result = obj
        label = label or Integer.MIN_VALUE
        initLogin = `this$0`.initLogin(null, null, this)
        return initLogin
    }
}