...
@DebugMetadata(
    ...
    m97i = [0],
    m96l = [467],
    m95m = "getDataAboutMalId",
    m94n = ["this"],
    m93s = ["L$0"]
) /* loaded from: classes3.dex */
class `MALApi$getDataAboutMalId$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MALApi, continuation: Continuation<in `MALApi$getDataAboutMalId$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val dataAboutMalId: Object
        result = obj
        label = label or Integer.MIN_VALUE
        dataAboutMalId = `this$0`.getDataAboutMalId(0, this)
