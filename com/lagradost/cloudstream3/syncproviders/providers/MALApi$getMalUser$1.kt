...
@DebugMetadata(
    ...
    m96l = [545, 546],
    m95m = "getMalUser",
    m94n = ["this", "setSettings", "this", "setSettings"],
    m93s = ["L$0", "Z$0", "L$0", "Z$0"]
) /* loaded from: classes3.dex */
class `MALApi$getMalUser$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MALApi, continuation: Continuation<in `MALApi$getMalUser$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        malUser = `this$0`.getMalUser(false, this)
        return malUser
    }
}