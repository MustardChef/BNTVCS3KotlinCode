...
@DebugMetadata(
    ...
    m97i = [],
    m96l = [621],
    m95m = "getAnilistAnimeListSmart",
    m94n = [],
    m93s = []
) /* loaded from: classes3.dex */
class `AniListApi$getAnilistAnimeListSmart$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AniListApi,
    continuation: Continuation<in `AniListApi$getAnilistAnimeListSmart$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.getAnilistAnimeListSmart(this)
    }
}