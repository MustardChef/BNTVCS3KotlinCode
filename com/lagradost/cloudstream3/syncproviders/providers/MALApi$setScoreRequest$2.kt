...
@DebugMetadata(
    ...
    m97i = [],
    m96l = [622],
    m95m = "setScoreRequest",
    m94n = [],
    m93s = []
) /* loaded from: classes3.dex */
class `MALApi$setScoreRequest$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MALApi, continuation: Continuation<in `MALApi$setScoreRequest$2`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val scoreRequest: Object
        result = obj
        label = label or Integer.MIN_VALUE
        scoreRequest =
            `this$0`.setScoreRequest(0, null as String?, null as Integer?, null as Integer?, this)
        return scoreRequest
    }
}