...
class `MALApi$refreshToken$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MALApi, continuation: Continuation<in `MALApi$refreshToken$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val refreshToken: Object
        result = obj
        label = label or Integer.MIN_VALUE
        refreshToken = `this$0`.refreshToken(this)
        return refreshToken
    }
}