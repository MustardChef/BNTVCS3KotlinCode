...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.syncproviders.providers.AniListApi\$initGetUser$1",
    m98f = "AniListApi.kt",
    m97i = [],
    m96l = [457],
    m95m = "invokeSuspend",
...
internal class `AniListApi$initGetUser$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AniListApi, continuation: Continuation<in `AniListApi$initGetUser$1`?>?
    ...
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `AniListApi$initGetUser$1`(`this$0`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    override fun invoke(continuation: Continuation<in Unit>?): Object {
        return (create(continuation) as `AniListApi$initGetUser$1`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            label = 1
            if (AniListApi.Companion.`getUser$default`(
                    `this$0`,
                    false,
                    this,
                    1,
