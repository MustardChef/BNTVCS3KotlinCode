...
@DebugMetadata(
    ...
    m97i = [],
    m96l = [725],
    m95m = "postDataAboutId",
    m94n = [],
    m93s = []
) /* loaded from: classes3.dex */
class `AniListApi$postDataAboutId$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AniListApi, continuation: Continuation<in `AniListApi$postDataAboutId$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val postDataAboutId: Object
        result = obj
        label = label or Integer.MIN_VALUE
        postDataAboutId = `this$0`.postDataAboutId(0, null, null, null, this)
