...
@DebugMetadata(
    ...
    m96l = [747],
    m95m = "getUser",
    m94n = ["this", "setSettings"],
    m93s = ["L$0", "Z$0"]
) /* loaded from: classes3.dex */
class `AniListApi$getUser$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AniListApi, continuation: Continuation<in `AniListApi$getUser$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        user = `this$0`.getUser(false, this)
        return user
    }
}