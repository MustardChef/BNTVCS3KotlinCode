...
@DebugMetadata(
    ...
    m97i = [0, 1, 1, 1],
    m96l = [430, 435],
    m95m = "getMalAnimeList",
    m94n = ["this", "this", "fullList", "offsetRegex"],
    m93s = ["L$0", "L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `MALApi$getMalAnimeList$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MALApi, continuation: Continuation<in `MALApi$getMalAnimeList$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val malAnimeList: Object
        result = obj
        label = label or Integer.MIN_VALUE
        malAnimeList = `this$0`.getMalAnimeList(this)
        return malAnimeList
    }
}