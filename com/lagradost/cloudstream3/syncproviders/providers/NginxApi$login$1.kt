...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: NginxApi.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.syncproviders.providers.NginxApi",
    m98f = "NginxApi.kt",
    m97i = [],
    m96l = [38],
    m95m = "login",
...
class `NginxApi$login$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: NginxApi, continuation: Continuation<in `NginxApi$login$1`?>?
