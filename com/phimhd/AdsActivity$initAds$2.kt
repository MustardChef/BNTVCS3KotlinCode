...
@Metadata(
    ...
    m107d2 = ["com/phimhd/AdsActivity\$initAds$2", "Lcom/applovin/mediation/MaxAdListener;", "onAdClicked", "", "ad", "Lcom/applovin/mediation/MaxAd;", "onAdDisplayFailed", "error", "Lcom/applovin/mediation/MaxError;", "onAdDisplayed", "onAdHidden", "onAdLoadFailed", "adUnitId", "", "onAdLoaded", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* loaded from: classes4.dex */
class `AdsActivity$initAds$2`     /* JADX INFO: Access modifiers changed from: package-private */(  /* synthetic */
    ...
    override fun onAdLoaded(ad: MaxAd) {
        Intrinsics.checkNotNullParameter(ad, "ad")
        `this$0`.retryAttemptFullScreenDownload = 0
    ...
    override fun onAdHidden(ad: MaxAd) {
        ...
        Intrinsics.checkNotNullParameter(ad, "ad")
        maxInterstitialAd = `this$0`.mInterstitialDownloadAd
    ...
    override fun onAdLoadFailed(adUnitId: String, error: MaxError) {
        ...
        i2 = `this$0`.retryAttemptFullScreenDownload
        val millis: Long = timeUnit.toMillis(Math.pow(2.0, Math.min(6, i2)) as Long)
        val handler = Handler()
        val adsActivity2 = `this$0`
        handler.postDelayed(object : Runnable() {
            // from class: com.phimhd.-$$Lambda$AdsActivity$initAds$2$e6XTBeVOliQ4UlYHBlay58reFUU
            @Override // java.lang.Runnable
            fun run() {
                `m9032onAdLoadFailed$lambda0`(this@AdsActivity)
            }
        }, millis)
    ...
    */
        fun `m9032onAdLoadFailed$lambda0`(r1: AdsActivity?) {
            /*
        ...
        L14:
            return
        */
            throw UnsupportedOperationException("Method not decompiled: com.phimhd.AdsActivity\$initAds$2.m9032onAdLoadFailed\$lambda0(com.phimhd.AdsActivity):void")
        }
    }
}