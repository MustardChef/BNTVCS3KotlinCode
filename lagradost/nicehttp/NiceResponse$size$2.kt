...
@Metadata(
    m108d1 = ["\u0000\n\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\u0010\u0000\u001a\u0004\u0018\u00010\u0001H\n¢\u0006\u0004\b\u0002\u0010\u0003"],
    m107d2 = ["<anonymous>", "", "invoke", "()Ljava/lang/Long;"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* loaded from: classes4.dex */
class `NiceResponse$size$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(  /* synthetic */
    val `this$0`: NiceResponse
) : Lambda<Any?>(0), Functions<Long?> {
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // kotlin.jvm.functions.Functions
    override fun invoke(): Long {
        var str: String? = `this$0`.okhttpResponse.headers().get("Content-Length")
        if (str == null) {
            str = `this$0`.okhttpResponse.headers().get("content-length")
        }
        return if (str == null) {
            null
        } else StringsKt.toLongOrNull(str)
    }
}