...
@Metadata(
    m108d1 = ["\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u0004\u0018\u00010\u0001H\n¢\u0006\u0002\b\u0002"],
    m107d2 = ["<anonymous>", "Lokhttp3/ResponseBody;", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* loaded from: classes4.dex */
class `NiceResponse$body$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(  /* synthetic */
    val `this$0`: NiceResponse
) : Lambda<Any?>(0), Functions<ResponseBody?> {
    @Override // kotlin.jvm.functions.Functions
    override fun invoke(): ResponseBody {
        return `this$0`.okhttpResponse.body()
    }
}