...
class `NiceResponse$text$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(  /* synthetic */
    val `this$0`: NiceResponse
) : Lambda<Any?>(0), Functions<String?> {
    @Override // kotlin.jvm.functions.Functions
    override fun invoke(): String {
        var string: String?
        val body: ResponseBody? = `this$0`.okhttpResponse.body()
        return if (body == null || body.string().also { string = it } == null) "" else string!!
    }
}