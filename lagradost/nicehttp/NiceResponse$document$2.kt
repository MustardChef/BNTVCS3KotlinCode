...
@Metadata(
    m108d1 = ["\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\n \u0002*\u0004\u0018\u00010\u00010\u0001H\n¢\u0006\u0002\b\u0003"],
    m107d2 = ["<anonymous>", "Lorg/jsoup/nodes/Document;", "kotlin.jvm.PlatformType", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* loaded from: classes4.dex */
class `NiceResponse$document$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(  /* synthetic */
    val `this$0`: NiceResponse
) : Lambda<Any?>(0), Functions<Document?> {
    @Override // kotlin.jvm.functions.Functions
    override fun invoke(): Document {
        return Jsoup.parse(`this$0`.text)
    }
}