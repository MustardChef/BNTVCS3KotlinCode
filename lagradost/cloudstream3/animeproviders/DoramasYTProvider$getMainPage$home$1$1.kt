...
class `DoramasYTProvider$getMainPage$home$1$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: DoramasYTProvider, /* synthetic */
    ...
    fun invoke2(newAnimeSearchResponse: AnimeSearchResponse) {
        ...
        MainAPIKt.`addDubStatus$default`(
            newAnimeSearchResponse,
            companion.getDubStatus(title),
            null as Integer?,
            2,
            null as Object?
        )
