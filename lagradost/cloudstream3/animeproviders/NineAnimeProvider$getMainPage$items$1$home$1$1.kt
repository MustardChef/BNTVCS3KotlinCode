...
class `NineAnimeProvider$getMainPage$items$1$home$1$1`(/* synthetic */val `$poster`: String,
                                                                      num: Integer?,
                                                                      num2: Integer?
) : Lambda<Any?>(1), Function1<AnimeSearchResponse, Unit> {
    /* synthetic */ val `$dubbedEpisodes`: Integer?
    /* synthetic */ val `$subbedEpisodes`: Integer?
    ...
    fun invoke2(newAnimeSearchResponse: AnimeSearchResponse) {
        ...
        val num: Integer? = `$dubbedEpisodes`
        val z = num != null
        val num2: Integer? = `$subbedEpisodes`
        addDubStatus(newAnimeSearchResponse, z, num2 != null, num, num2)
    }
}