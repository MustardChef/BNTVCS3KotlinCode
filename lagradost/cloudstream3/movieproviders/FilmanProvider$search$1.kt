...
class `FilmanProvider$search$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: FilmanProvider, continuation: Continuation<in `FilmanProvider$search$1`?>?
