...
@DebugMetadata(
    ...
    m97i = [0, 0],
    m96l = [25],
    m95m = "getMainPage\$suspendImpl",
    m94n = ["this", FirebaseAnalytics.Param.ITEMS],
    m93s = ["L$0", "L$1"]
) /* loaded from: classes3.dex */
class `BflixProvider$getMainPage$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: BflixProvider, continuation: Continuation<in `BflixProvider$getMainPage$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return BflixProvider.Companion.`getMainPage$suspendImpl`(`this$0`, this as Continuation<*>)
    }
}