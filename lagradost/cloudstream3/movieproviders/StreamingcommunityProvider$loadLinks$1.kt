...
@DebugMetadata(
    ...
    m96l = [421, 422],
    m95m = "loadLinks",
    m94n = ["this", "data", "callback", "this", "data", "callback", "ip"],
    m93s = ["L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3"]
) /* loaded from: classes3.dex */
class `StreamingcommunityProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: StreamingcommunityProvider,
    continuation: Continuation<in `StreamingcommunityProvider$loadLinks$1`?>?
