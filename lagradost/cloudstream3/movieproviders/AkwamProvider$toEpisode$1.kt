...
class `AkwamProvider$toEpisode$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `$title`: String, /* synthetic */
    val `this$0`: AkwamProvider, /* synthetic */
    val `$thumbUrl`: String, /* synthetic */
    val `$date`: String
