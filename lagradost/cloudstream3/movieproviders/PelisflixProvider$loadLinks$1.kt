...
@DebugMetadata(
    ...
    m97i = [0, 0, 0, 0, 1, 1, 1, 1],
    m96l = [189, 195],
    m95m = "loadLinks",
    m94n = ["this", "data", "subtitleCallback", "callback", "this", "data", "subtitleCallback", "callback"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$0", "L$1", "L$2", "L$3"]
) /* loaded from: classes3.dex */
class `PelisflixProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: PelisflixProvider,
    continuation: Continuation<in `PelisflixProvider$loadLinks$1`?>?
