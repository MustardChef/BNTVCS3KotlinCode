...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.CimaNowProvider",
...
class `CimaNowProvider$getMainPage$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: CimaNowProvider, continuation: Continuation<in `CimaNowProvider$getMainPage$1`?>?
