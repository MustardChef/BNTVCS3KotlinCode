...
@DebugMetadata(
    ...
    m96l = [315],
    m95m = "loadLinks",
    m94n = ["this", "subtitleCallback", "callback", "idMovie", MonitorLogServerProtocol.PARAM_CATEGORY, "episodeVo", "quality"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "L$7"]
) /* loaded from: classes3.dex */
class `LokLokProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: LokLokProvider, continuation: Continuation<in `LokLokProvider$loadLinks$1`?>?
