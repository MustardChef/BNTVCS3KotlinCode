...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.TheFlixToProvider",
    m98f = "TheFlixToProvider.kt",
    m97i = [0],
    m96l = [HttpStatusCodes.HTTP_INSUFFICIENT_SPACE_ON_RESOURCE, 420],
    m95m = "getLoadMan",
    m94n = ["url"],
    m93s = ["L$0"]
) /* loaded from: classes3.dex */
class `TheFlixToProvider$getLoadMan$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: TheFlixToProvider,
    continuation: Continuation<in `TheFlixToProvider$getLoadMan$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        loadMan = `this$0`.getLoadMan(null, this)
        return loadMan
    }
}