...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: PelisflixProvider.kt */
@Metadata(
    m108d1 = ["\u0000\u0012\n\u0000\n\u0002\u0010 \n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u00012\u000e\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004H\u008a@"],
...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.PelisflixProvider\$loadLinks$2$1",
    m98f = "PelisflixProvider.kt",
    m97i = [],
    m96l = [200],
    m95m = "invokeSuspend",
    m94n = [],
...
class `PelisflixProvider$loadLinks$2$1`(/* synthetic */val `$data`: String,
                                                       function1: Function1<SubtitleFile, Unit>,
                                                       function12: Function1<ExtractorLink, Unit>,
                                                       continuation: Continuation<in `PelisflixProvider$loadLinks$2$1`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `pelisflixProvider$loadLinks$2$1` = `PelisflixProvider$loadLinks$2$1`(
            `$data`,
            `$subtitleCallback`,
            `$callback`,
            continuation
    ...
    fun invoke2(element: Element, continuation: Continuation<in List<Boolean?>?>?): Object {
        return (create(element, continuation) as `PelisflixProvider$loadLinks$2$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            val tuplesArr = arrayOf<Tuples<*, *>>(
                TuplesKt.m100to<Any, Any>(HttpHeaders.HOST, "pelisflix.li"),
                ...
                TuplesKt.m100to<Any, Any>(HttpHeaders.PRAGMA, "no-cache"),
                TuplesKt.m100to<Any, Any>("Cache-Control", "no-cache"),
                TuplesKt.m100to<Any, Any>(
                    HttpHeaders.f9840TE, "trailers"
                )
            )
            label = 1
        ...
        return ParCollections.apmap(
            (`post$default` as NiceResponse).getOkhttpResponse().headers()
                .values(FirebaseAnalytics.Param.LOCATION), C48131(
    ...
    @DebugMetadata(
        m99c = "com.lagradost.cloudstream3.movieproviders.PelisflixProvider\$loadLinks$2$1$1",
        m98f = "PelisflixProvider.kt",
        m97i = [],
        m96l = [bqk.f6560bT],
        m95m = "invokeSuspend",
        m94n = [],
        m93s = []
    ) /* renamed from: com.lagradost.cloudstream3.movieproviders.PelisflixProvider$loadLinks$2$1$1 */ /* loaded from: classes3.dex */
    class C48131 internal constructor(/* synthetic */val `$data`: String,
                                                     function1: Function1<SubtitleFile, Unit>,
                                                     function12: Function1<ExtractorLink, Unit>,
                                                     continuation: Continuation<in C48131?>?
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
            val c48131 = C48131(`$data`, `$subtitleCallback`, `$callback`, continuation)
            c48131.`L$0` = obj
            return c48131
        }
        ...
        override fun invoke(str: String, continuation: Continuation<in Boolean?>?): Object {
            return (create(str, continuation) as C48131).invokeSuspend(Unit.INSTANCE)
        }
