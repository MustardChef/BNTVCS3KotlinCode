...
internal class `StreamingcommunityProvider$load$3$1$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `$ep`: Episodejson, /* synthetic */
    val `$stagione`: Int, /* synthetic */
    ...
    fun invoke2(newEpisode: Episode) {
        ...
        newEpisode.setSeason(Integer.valueOf(`$stagione`))
        newEpisode.setEpisode(Integer.valueOf(`$ep`.number.toInt()))
        newEpisode.description = `$ep`.plot
        newEpisode.posterUrl = `$postimage`
    }
}