...
@DebugMetadata(
    ...
    m97i = [0, 0, 0, 0, 1, 1, 1, 1, 1],
    m96l = [187, 190],
    m95m = "invokeLokalSource",
    m94n = ["this", "url", "subCallback", "sourceCallback", "this", "url", "subCallback", "sourceCallback", "document"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$0", "L$1", "L$2", "L$3", "L$4"]
) /* loaded from: classes3.dex */
class `IdlixProvider$invokeLokalSource$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: IdlixProvider,
    continuation: Continuation<in `IdlixProvider$invokeLokalSource$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        invokeLokalSource = `this$0`.invokeLokalSource(null, null, null, this)
