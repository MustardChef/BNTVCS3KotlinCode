...
internal class `FilmpertuttiProvider$load$4`(/* synthetic */val `$poster`: String,
                                                            num: Integer,
                                                            str2: String,
                                                            str3: String,
                                                            str4: String
    ...
    fun invoke2(newTvSeriesLoadResponse: TvSeriesLoadResponse) {
        ...
        LoadResponse.Companion.addRating(tvSeriesLoadResponse, `$rating`)
        LoadResponse.Companion.addTrailer(tvSeriesLoadResponse, `$trailerurl`)
    }
}