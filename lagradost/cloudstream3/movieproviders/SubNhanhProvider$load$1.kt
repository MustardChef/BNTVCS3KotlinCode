...
@DebugMetadata(
    ...
    m96l = [261, 312],
    m95m = "load",
    m94n = ["this", "url", "url", "realName", "description", "listRelate"],
    m93s = ["L$0", "L$1", "L$0", "L$1", "L$2", "L$3"]
) /* loaded from: classes3.dex */
class `SubNhanhProvider$load$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SubNhanhProvider, continuation: Continuation<in `SubNhanhProvider$load$1`?>?
