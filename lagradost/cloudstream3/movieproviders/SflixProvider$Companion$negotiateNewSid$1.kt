...
@DebugMetadata(
    ...
    m97i = [0, 0, 0, 1, 1, 1],
    m96l = [HttpStatusCodes.HTTP_UNAVAILABLE_FOR_LEGAL_REASONS, 454],
    m95m = "negotiateNewSid",
    m94n = ["this", "baseUrl", "i", "this", "baseUrl", "i"],
    m93s = ["L$0", "L$1", "I$0", "L$0", "L$1", "I$0"]
) /* loaded from: classes3.dex */
class `SflixProvider$Companion$negotiateNewSid$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SflixProvider.Companion,
    continuation: Continuation<in `SflixProvider$Companion$negotiateNewSid$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val negotiateNewSid: Object
        result = obj
        label = label or Integer.MIN_VALUE
        negotiateNewSid = `this$0`.negotiateNewSid(null, this)
