...
internal class `MeloMovieProvider$load$4`(/* synthetic */val `$poster`: String,
                                                         num: Integer,
                                                         str2: String,
                                                         str3: String
) : Lambda<Any?>(1), Function1<TvSeriesLoadResponse?, Unit> {
    /* synthetic */ val `$imdbUrl`: String
    ...
    fun invoke2(newTvSeriesLoadResponse: TvSeriesLoadResponse) {
        ...
        LoadResponse.Companion.addImdbUrl(newTvSeriesLoadResponse, `$imdbUrl`)
    }
}