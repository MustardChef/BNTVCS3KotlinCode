...
@DebugMetadata(
    ...
    m96l = [bqk.f6596cc],
    m95m = "loadLinks",
    m94n = ["this", "subtitleCallback", "callback", "count"],
    m93s = ["L$0", "L$1", "L$2", "L$3"]
) /* loaded from: classes3.dex */
class `PinoyHDXyzProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: PinoyHDXyzProvider,
    continuation: Continuation<in `PinoyHDXyzProvider$loadLinks$1`?>?
