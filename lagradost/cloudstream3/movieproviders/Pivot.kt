...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/movieproviders/Pivot;", "", "titleID", "", "genreID", "(JJ)V", "getGenreID", "()J", "getTitleID", "component1", "component2", "copy", "equals", "", "other", "hashCode", "", "toString", "", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* loaded from: classes3.dex */
class Pivot(
    @param:JsonProperty("titleID") val titleID: Long, @param:JsonProperty(
        "genreID"
    ) val genreID: Long
) {
    ...
    fun copy(@JsonProperty("titleID") j: Long, @JsonProperty("genreID") j2: Long): Pivot {
        return Pivot(j, j2)
    }
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is Pivot) {
            val pivot = obj as Pivot
            return titleID == pivot.titleID && genreID == pivot.genreID
        }
        return false
    }

    override fun hashCode(): Int {
        return `C$r8$backportedMethods$utility$Long$1$hashCode`.hashCode(titleID) * 31 + `C$r8$backportedMethods$utility$Long$1$hashCode`.hashCode(
            genreID
        )
    }

    override fun toString(): String {
        return "Pivot(titleID=" + titleID + ", genreID=" + genreID + ')'
    }
