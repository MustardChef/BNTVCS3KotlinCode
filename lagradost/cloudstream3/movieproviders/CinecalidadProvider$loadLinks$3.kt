...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.CinecalidadProvider\$loadLinks$3",
...
class `CinecalidadProvider$loadLinks$3`(
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `cinecalidadProvider$loadLinks$3` = `CinecalidadProvider$loadLinks$3`(
    ...
    override fun invoke(element: Element, continuation: Continuation<in Unit>?): Object {
        return (create(element, continuation) as `CinecalidadProvider$loadLinks$3`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.movieproviders.CinecalidadProvider$loadLinks$3$1 */ /* loaded from: classes3.dex */
    class C47791 internal constructor() : Lambda<Any?>(1), Function1<MatchResult, String> {
    ...
    @DebugMetadata(
        m99c = "com.lagradost.cloudstream3.movieproviders.CinecalidadProvider\$loadLinks$3$2",
        m98f = "CinecalidadProvider.kt",
        m97i = [],
        m96l = [bqk.f6551bK],
        m95m = "invokeSuspend",
        m94n = [],
        m93s = []
    ) /* renamed from: com.lagradost.cloudstream3.movieproviders.CinecalidadProvider$loadLinks$3$2 */ /* loaded from: classes3.dex */
    class C47802 internal constructor(/* synthetic */val `$data`: String, /* synthetic */
                                                     val `this$0`: CinecalidadProvider,
                                                     function1: Function1<SubtitleFile, Unit>,
                                                     function12: Function1<ExtractorLink, Unit>,
                                                     continuation: Continuation<in C47802?>?
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
            val c47802 = C47802(`$data`, `this$0`, `$subtitleCallback`, `$callback`, continuation)
            c47802.`L$0` = obj
            return c47802
        }
        ...
        fun invoke2(str: String, continuation: Continuation<in List<Unit>?>?): Object {
            return (create(str, continuation) as C47802).invokeSuspend(Unit.INSTANCE)
        }
        ...
        override fun invokeSuspend(obj: Object): Object {
            ...
            return ParCollections.apmap(
                (obj2 as NiceResponse).getOkhttpResponse().headers()
                    .values(FirebaseAnalytics.Param.LOCATION), C47811(
        ...
        @DebugMetadata(
            m99c = "com.lagradost.cloudstream3.movieproviders.CinecalidadProvider\$loadLinks$3$2$1",
            m98f = "CinecalidadProvider.kt",
            m97i = [],
            m96l = [bqk.f6597cd],
            m95m = "invokeSuspend",
            m94n = [],
            m93s = []
        ) /* renamed from: com.lagradost.cloudstream3.movieproviders.CinecalidadProvider$loadLinks$3$2$1 */ /* loaded from: classes3.dex */
        class C47811 internal constructor(/* synthetic */val `this$0`: CinecalidadProvider,
                                                         function1: Function1<SubtitleFile, Unit>,
                                                         function12: Function1<ExtractorLink, Unit>,
                                                         continuation: Continuation<in C47811?>?
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
                val c47811 = C47811(`this$0`, `$subtitleCallback`, `$callback`, continuation)
                c47811.`L$0` = obj
                return c47811
            }
            ...
            override fun invoke(str: String, continuation: Continuation<in Unit>?): Object {
                return (create(str, continuation) as C47811).invokeSuspend(Unit.INSTANCE)
            }
