...
@DebugMetadata(
    ...
    m96l = [167, 179],
    m95m = "invokeLokalSource",
    m94n = ["name", "ref", "subCallback", "sourceCallback", "name", "ref", "subCallback", "sourceCallback", "destination\$iv\$iv", "script", "source"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$0", "L$1", "L$2", "L$3", "L$4", "L$6", "L$7"]
) /* loaded from: classes3.dex */
class `RebahinProvider$invokeLokalSource$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: RebahinProvider,
    continuation: Continuation<in `RebahinProvider$invokeLokalSource$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val invokeLokalSource: Object
        result = obj
        label = label or Integer.MIN_VALUE
        invokeLokalSource = `this$0`.invokeLokalSource(null, null, null, null, null, this)
