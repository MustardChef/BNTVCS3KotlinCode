...
@DebugMetadata(
    ...
    m96l = [346],
    m95m = "load",
    m94n = ["this", "url", "id", MonitorLogServerProtocol.PARAM_CATEGORY],
    m93s = ["L$0", "L$1", "L$2", "L$3"]
) /* loaded from: classes3.dex */
class `LokLokProvider$load$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: LokLokProvider, continuation: Continuation<in `LokLokProvider$load$1`?>?
