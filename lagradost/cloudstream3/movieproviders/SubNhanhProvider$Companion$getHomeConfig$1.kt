...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: SubNhanhProvider.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.SubNhanhProvider\$Companion",
    m98f = "SubNhanhProvider.kt",
    m97i = [0],
    m96l = [58],
    m95m = "getHomeConfig",
    m94n = ["listHomePageList"],
    m93s = ["L$0"]
) /* loaded from: classes3.dex */
class `SubNhanhProvider$Companion$getHomeConfig$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SubNhanhProvider.Companion,
    continuation: Continuation<in `SubNhanhProvider$Companion$getHomeConfig$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.getHomeConfig(null, this)
    }
}