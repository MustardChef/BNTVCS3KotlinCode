...
@DebugMetadata(
    ...
    m96l = [51],
    m95m = "getMainPage",
    m94n = ["this", FirebaseAnalytics.Param.ITEMS, "header"],
    m93s = ["L$0", "L$1", "L$3"]
) /* loaded from: classes3.dex */
class `RebahinProvider$getMainPage$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: RebahinProvider, continuation: Continuation<in `RebahinProvider$getMainPage$1`?>?
