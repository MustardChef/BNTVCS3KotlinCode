...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.LokLokProvider\$getMainPage$6",
...
class `LokLokProvider$getMainPage$6`(
    objectRef: ObjectRef<ArrayList<HomePageList?>?>,
    lokLokProvider: LokLokProvider,
    continuation: Continuation<in `LokLokProvider$getMainPage$6`?>?
    ...
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `LokLokProvider$getMainPage$6`(`$responseFirstPage`, `this$0`, continuation)
    }
    ...
    fun invoke2(continuation: Continuation<Object?>?): Object {
        return (create(continuation) as `LokLokProvider$getMainPage$6`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            obj2 = Requests.`get$default`(
                ...
                "https://ga-mobile-api.loklok.tv/cms/app/homePage/getHome?page=4",
