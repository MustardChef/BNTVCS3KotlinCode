...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: AllMoviesForYouProvider.kt */
@Metadata(
    m108d1 = ["\u0000\u000c\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"],
    m107d2 = ["<anonymous>", "", "id", ""],
    m106k = 3,
...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.AllMoviesForYouProvider\$loadLinks$2",
    m98f = "AllMoviesForYouProvider.kt",
    m97i = [1],
    m96l = [197, 200, 202],
    m95m = "invokeSuspend",
...
class `AllMoviesForYouProvider$loadLinks$2`(/* synthetic */val `$data`: String,
                                                           ...
                                                           continuation: Continuation<in `AllMoviesForYouProvider$loadLinks$2`?>?
    ...
    var `L$6`: Object? = null
    var label = 0
    /* synthetic */ val `this$0`: AllMoviesForYouProvider

    /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ /* JADX WARN: Multi-variable type inference failed */
    init {
        `$subtitleCallback` = function1
        `$callback` = function12
        `this$0` = allMoviesForYouProvider
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `allMoviesForYouProvider$loadLinks$2` = `AllMoviesForYouProvider$loadLinks$2`(
            `$data`,
            `$subtitleCallback`,
            `$callback`,
            `this$0`,
    ...
    fun invoke2(str: String, continuation: Continuation<Object?>?): Object {
        return (create(str, continuation) as `AllMoviesForYouProvider$loadLinks$2`).invokeSuspend(
            Unit.INSTANCE
        )
    }

    /* JADX WARN: Multi-variable type inference failed */ /* JADX WARN: Removed duplicated region for block: B:20:0x00c8  */ /* JADX WARN: Removed duplicated region for block: B:25:0x011f  */ /* JADX WARN: Type inference failed for: r2v21, types: [java.util.Collection] */ /* JADX WARN: Type inference failed for: r4v5 */ /* JADX WARN: Type inference failed for: r4v6 */ /* JADX WARN: Type inference failed for: r4v9, types: [java.util.Collection] */ /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:23:0x0105 -> B:24:0x010b). Please submit an issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */   override fun invokeSuspend(r24: Any?): Any {
        /*
            Method dump skipped, instructions count: 311
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.movieproviders.AllMoviesForYouProvider\$loadLinks$2.invokeSuspend(java.lang.Object):java.lang.Object")
    }
}