...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: LayarKaca21Provider.kt */
@Metadata(
    m108d1 = ["\u0000\u000c\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"],
    m107d2 = ["<anonymous>", "", "it", ""],
    m106k = 3,
...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.LayarKacaProvider\$loadLinks$2",
    m98f = "LayarKaca21Provider.kt",
    m97i = [],
    m96l = [222],
    m95m = "invokeSuspend",
    m94n = [],
...
class `LayarKacaProvider$loadLinks$2`(/* synthetic */val `$data`: String,
                                                     function1: Function1<in SubtitleFile, Unit>,
                                                     function12: Function1<in ExtractorLink, Unit>,
                                                     continuation: Continuation<in `LayarKacaProvider$loadLinks$2`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `layarKacaProvider$loadLinks$2` =
            `LayarKacaProvider$loadLinks$2`(`$data`, `$subtitleCallback`, `$callback`, continuation)
    ...
    override fun invoke(str: String, continuation: Continuation<in Boolean?>?): Object {
        return (create(
            str,
            continuation
        ) as `LayarKacaProvider$loadLinks$2`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            var str = `L$0` as String?
            if (StringsKt.`startsWith$default`(
                    str,
                    "https://layarkacaxxi.icu",
                    false,
                    2,
                    null as Object?
                )
            ) {
                str = StringsKt.`substringBeforeLast$default`(
                    str,
                    "/",
                    null as String?,
                    2,
            ...
            label = 1
            obj = ExtractorApiKt.loadExtractor(str, `$data`, `$subtitleCallback`, `$callback`, this)
