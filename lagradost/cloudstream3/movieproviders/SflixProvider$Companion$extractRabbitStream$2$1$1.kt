...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.SflixProvider\$Companion\$extractRabbitStream$2$1$1",
...
internal class `SflixProvider$Companion$extractRabbitStream$2$1$1`(/* synthetic */
    val `$extractorData`: String,
    pollingData: PollingData,
    continuation: Continuation<in `SflixProvider$Companion$extractRabbitStream$2$1$1`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in Unit>?, Object?> {
    /* synthetic */ val `$it`: PollingData
    var label = 0
    ...
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `SflixProvider$Companion$extractRabbitStream$2$1$1`(
            `$extractorData`,
            `$it`,
            continuation
        )
    ...
    override operator fun invoke(continuation: Continuation<in Unit>): Object {
        return (create(continuation) as `SflixProvider$Companion$extractRabbitStream$2$1$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            sb.append(`$extractorData`)
            sb.append("&t=")
            generateTimeStamp = SflixProvider.Companion.Companion.generateTimeStamp()
            sb.append(generateTimeStamp)
            sb.append("&sid=")
            sb.append(`$it`.getSid())
            label = 1
            if (Requests.`get$default`(
                    app,
                    sb.toString(),
                    null,
                    null,
