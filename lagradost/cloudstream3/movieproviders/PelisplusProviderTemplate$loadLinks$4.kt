...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.PelisplusProviderTemplate\$loadLinks$4",
    m98f = "PelisplusProviderTemplate.kt",
    m97i = [0],
    m96l = [bqk.f6603cj, 254],
    m95m = "invokeSuspend",
    m94n = ["serverid"],
    m93s = ["L$0"]
) /* loaded from: classes3.dex */
class `PelisplusProviderTemplate$loadLinks$4`(/* synthetic */val `this$0`: PelisplusProviderTemplate, /* synthetic */
                                                             val `$data`: String,
                                                             function1: Function1<in SubtitleFile, Unit>,
                                                             function12: Function1<in ExtractorLink, Unit>,
                                                             continuation: Continuation<in `PelisplusProviderTemplate$loadLinks$4`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `pelisplusProviderTemplate$loadLinks$4` = `PelisplusProviderTemplate$loadLinks$4`(
    ...
    override fun invoke(element: Element, continuation: Continuation<in Unit>?): Object {
        return (create(
            element,
            continuation
        ) as `PelisplusProviderTemplate$loadLinks$4`).invokeSuspend(
            Unit.INSTANCE
        )
    }
