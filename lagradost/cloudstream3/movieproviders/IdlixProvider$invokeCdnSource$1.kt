...
@DebugMetadata(
    ...
    m97i = [0, 0, 0, 0, 0],
    m96l = [295],
    m95m = "invokeCdnSource",
    m94n = ["this", "url", "subCallback", "sourceCallback", "domainUrl"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$4"]
) /* loaded from: classes3.dex */
class `IdlixProvider$invokeCdnSource$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: IdlixProvider, continuation: Continuation<in `IdlixProvider$invokeCdnSource$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val invokeCdnSource: Object
        result = obj
        label = label or Integer.MIN_VALUE
        invokeCdnSource = `this$0`.invokeCdnSource(null, null, null, this)
