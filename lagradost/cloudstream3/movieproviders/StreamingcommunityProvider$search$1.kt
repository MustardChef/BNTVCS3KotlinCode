...
@DebugMetadata(
    ...
    m97i = [0, 1, 1, 1, 1, 1, 1, 1],
    m96l = [226, 238],
    m95m = "search",
    m94n = ["this", "this", "destination\$iv\$iv", "name", "img", "number", "ip", "id"],
    m93s = ["L$0", "L$0", "L$1", "L$3", "L$4", "L$5", "L$6", "J$0"]
) /* loaded from: classes3.dex */
class `StreamingcommunityProvider$search$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: StreamingcommunityProvider,
    continuation: Continuation<in `StreamingcommunityProvider$search$1`?>?
