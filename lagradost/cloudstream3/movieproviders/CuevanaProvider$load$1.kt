...
class `CuevanaProvider$load$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: CuevanaProvider, continuation: Continuation<in `CuevanaProvider$load$1`?>?
