...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: BongNgoProvider.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.BongNgoProvider",
    m98f = "BongNgoProvider.kt",
    m97i = [0, 0, 0, 1, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3],
    m96l = [201, bqk.f6553bM, bqk.f6536aw, TypedValues.AttributesType.TYPE_PIVOT_TARGET],
    m95m = "loadLinks",
    m94n = ["this", "subtitleCallback", "callback", "this", "subtitleCallback", "callback", "this", "subtitleCallback", "callback", "source", "listSourceFinal", "itemSource", "subtitleList", "urlPlaylist", FirebaseAnalytics.Param.INDEX, "this", "subtitleCallback", "callback", "source", "listSourceFinal", FirebaseAnalytics.Param.INDEX],
    m93s = ["L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "L$6", "L$7", "I$0", "L$0", "L$1", "L$2", "L$3", "L$4", "I$0"]
) /* loaded from: classes3.dex */
class `BongNgoProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: BongNgoProvider, continuation: Continuation<in `BongNgoProvider$loadLinks$1`?>?
