...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: PelisplusHDProvider.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.PelisplusHDProvider",
    m98f = "PelisplusHDProvider.kt",
    m97i = [0, 0],
    m96l = [21],
    m95m = "getMainPage",
...
class `PelisplusHDProvider$getMainPage$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: PelisplusHDProvider,
    continuation: Continuation<in `PelisplusHDProvider$getMainPage$1`?>?
