...
class `SflixProvider$load$4$1$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SflixProvider, /* synthetic */
    val `$episodePosterUrl`: String?, /* synthetic */
    val `$episodeTitle`: String?, /* synthetic */
    val `$episodeNum`: Int, /* synthetic */
    val `$season`: Int
    ...
    fun invoke2(newEpisode: Episode) {
        ...
        newEpisode.posterUrl = MainAPIKt.fixUrlNull(`this$0`, `$episodePosterUrl`)
        val str2 = `$episodeTitle`
        if (str2 != null) {
            str = StringsKt.removePrefix(str2, ("Episode " + `$episodeNum` + ": ") as CharSequence)
        } else {
            str = null
        }
        newEpisode.name = str
        newEpisode.setSeason(Integer.valueOf(`$season` + 1))
        newEpisode.setEpisode(Integer.valueOf(`$episodeNum`))
    }
}