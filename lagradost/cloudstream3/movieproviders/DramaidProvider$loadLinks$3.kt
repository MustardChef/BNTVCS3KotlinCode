...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.DramaidProvider\$loadLinks$3",
    m98f = "DramaidProvider.kt",
    m97i = [],
    m96l = [208, bqk.f6548bH],
    m95m = "invokeSuspend",
    m94n = [],
    m93s = []
) /* loaded from: classes3.dex */
class `DramaidProvider$loadLinks$3`(/* synthetic */val `this$0`: DramaidProvider,
                                                   function1: Function1<in SubtitleFile, Unit>,
                                                   function12: Function1<in ExtractorLink, Unit>,
                                                   str: String,
                                                   continuation: Continuation<in `DramaidProvider$loadLinks$3`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `dramaidProvider$loadLinks$3` = `DramaidProvider$loadLinks$3`(
            `this$0`,
            `$subtitleCallback`,
            `$callback`,
            `$data`,
    ...
    fun invoke2(str: String, continuation: Continuation<Object?>?): Object {
        return (create(
            str,
            continuation
        ) as `DramaidProvider$loadLinks$3`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            if (StringsKt.`contains$default`(
                    str as CharSequence?,
                    "motonews.club" as CharSequence,
                    false,
                    2,
                    null as Object?
                )
            ) {
                val dramaidProvider = `this$0`
                label = 1
                invokeDriveSource = dramaidProvider.invokeDriveSource(
                    str,
                    dramaidProvider.getName(),
                    `$subtitleCallback`,
                    `$callback`,
                    this
                )
