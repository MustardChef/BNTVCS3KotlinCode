...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: TwoEmbedProvider.kt */
@Metadata(
    m108d1 = ["\u0000\u000e\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0000\u0010\u0000\u001a\u0004\u0018\u00010\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u0003H\u008a@"],
    m107d2 = ["<anonymous>", "", "serverID", "", "kotlin.jvm.PlatformType"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.TwoEmbedProvider\$loadLinks$2",
    m98f = "TwoEmbedProvider.kt",
    m97i = [0],
    m96l = [62, 63, 67, 69],
    m95m = "invokeSuspend",
    m94n = ["serverID"],
...
class `TwoEmbedProvider$loadLinks$2`(/* synthetic */val `$embedUrl`: String, /* synthetic */
                                                    val `$captchaKey`: String, /* synthetic */
                                                    val `this$0`: TwoEmbedProvider,
                                                    function1: Function1<in SubtitleFile, Unit>,
                                                    function12: Function1<in ExtractorLink, Unit>,
                                                    continuation: Continuation<in `TwoEmbedProvider$loadLinks$2`?>?
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.movieproviders.TwoEmbedProvider$loadLinks$2$1 */ /* loaded from: classes3.dex */
    class C48301 internal constructor() : Lambda<Any?>(1), Function1<String?, String?> {
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `twoEmbedProvider$loadLinks$2` = `TwoEmbedProvider$loadLinks$2`(
            `$embedUrl`,
            `$captchaKey`,
            `this$0`,
            `$subtitleCallback`,
    ...
    fun invoke2(str: String, continuation: Continuation<Object?>?): Object {
        return (create(
            str,
            continuation
        ) as `TwoEmbedProvider$loadLinks$2`).invokeSuspend(Unit.INSTANCE)
    }

    /* JADX WARN: Removed duplicated region for block: B:21:0x00cf  */ /* JADX WARN: Removed duplicated region for block: B:24:0x00f2  */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */   override fun invokeSuspend(r26: Any?): Any {
        ...
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.movieproviders.TwoEmbedProvider\$loadLinks$2.invokeSuspend(java.lang.Object):java.lang.Object")
    }
}