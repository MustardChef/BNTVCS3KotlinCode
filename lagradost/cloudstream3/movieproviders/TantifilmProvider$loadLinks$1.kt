...
@DebugMetadata(
    ...
    m97i = [0, 0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 3],
    m96l = [bqk.f6565bY, bqk.f6598ce, 234, 235],
    m95m = "loadLinks",
    m94n = ["this", "data", "subtitleCallback", "callback", "data", "subtitleCallback", "callback", "data", "subtitleCallback", "callback", "data", "subtitleCallback", "callback"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `TantifilmProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: TantiFilmProvider,
    continuation: Continuation<in `TantifilmProvider$loadLinks$1`?>?
