...
@DebugMetadata(
    ...
    m96l = [683, 691],
    m95m = "loadLinks",
    m94n = ["this", "subtitleCallback", "callback", "parsed", "subtitleCallback"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$0"]
) /* loaded from: classes3.dex */
class `SuperStream$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SuperStream, continuation: Continuation<in `SuperStream$loadLinks$1`?>?
