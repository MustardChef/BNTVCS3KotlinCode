...
@DebugMetadata(
    ...
    m96l = [41],
    m95m = "loadLinks",
    m94n = ["this", "callback", "slug"],
    m93s = ["L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `HDMProvider$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: HDMProvider, continuation: Continuation<in `HDMProvider$loadLinks$1`?>?
