...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.movieproviders.BflixProvider\$loadLinks$2$2",
...
class `BflixProvider$loadLinks$2$2`(/* synthetic */val `$data`: String,
                                                   function1: Function1<in SubtitleFile, Unit>,
                                                   function12: Function1<in ExtractorLink, Unit>,
                                                   continuation: Continuation<in `BflixProvider$loadLinks$2$2`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        val `bflixProvider$loadLinks$2$2` =
            `BflixProvider$loadLinks$2$2`(`$data`, `$subtitleCallback`, `$callback`, continuation)
    ...
    override fun invoke(str: String, continuation: Continuation<in Boolean?>?): Object {
        return (create(
            str,
            continuation
        ) as `BflixProvider$loadLinks$2$2`).invokeSuspend(Unit.INSTANCE)
    }
