...
class MultiAnimeProvider : MainAPI() {
    ...
    val syncApi: SyncAPI = AccountManager.Companion.aniListApi
    private val `syncUtilType$delegate`: Lazy<*> =
        LazyKt.lazy(`MultiAnimeProvider$syncUtilType$2`(this))
    private val `validApis$delegate`: Lazy<*> = LazyKt.lazy(`MultiAnimeProvider$validApis$2`(this))
    ...
    private val syncUtilType: String
        private get() = `syncUtilType$delegate`.value as String

    /* JADX INFO: Access modifiers changed from: private */
    val validApis: List<Any>
        get() = `validApis$delegate`.value as List

    private fun filterName(str: String): String {
        return Regex("[^a-zA-Z0-9-]").replace(str, "")
    }

    /* JADX WARN: Removed duplicated region for block: B:10:0x0028  */ /* JADX WARN: Removed duplicated region for block: B:14:0x003a  */ /* JADX WARN: Removed duplicated region for block: B:20:0x0051  */ /* JADX WARN: Removed duplicated region for block: B:25:0x00a1 A[ORIG_RETURN, RETURN] */
    @Override // com.lagradost.cloudstream3.MainAPI
    /*
    ...
    */   override fun search(
        ...
        La2:
            return r3
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.metaproviders.MultiAnimeProvider.search(java.lang.String, kotlin.coroutines.Continuation):java.lang.Object")
    }

    /* JADX WARN: Removed duplicated region for block: B:10:0x002c  */ /* JADX WARN: Removed duplicated region for block: B:16:0x0055  */ /* JADX WARN: Removed duplicated region for block: B:22:0x006c  */ /* JADX WARN: Removed duplicated region for block: B:34:0x00b8  */ /* JADX WARN: Removed duplicated region for block: B:40:0x00cd  */ /* JADX WARN: Removed duplicated region for block: B:41:0x00d0  */ /* JADX WARN: Removed duplicated region for block: B:44:0x00dc  */ /* JADX WARN: Removed duplicated region for block: B:45:0x00ee  */ /* JADX WARN: Removed duplicated region for block: B:47:0x00f6 A[ORIG_RETURN, RETURN] */
    @Override // com.lagradost.cloudstream3.MainAPI
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */   override fun load(r18: String?, r19: Continuation<in LoadResponse?>?): Any {
        /*
            Method dump skipped, instructions count: 247
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.metaproviders.MultiAnimeProvider.load(java.lang.String, kotlin.coroutines.Continuation):java.lang.Object")
    }
}