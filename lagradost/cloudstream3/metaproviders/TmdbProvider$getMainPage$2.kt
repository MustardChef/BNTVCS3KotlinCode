...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.metaproviders.TmdbProvider\$getMainPage$2",
...
class `TmdbProvider$getMainPage$2`(
    objectRef: ObjectRef<List<MovieSearchResponse?>?>,
    tmdbProvider: TmdbProvider,
    continuation: Continuation<in `TmdbProvider$getMainPage$2`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in Unit>?, Object> {
    /* synthetic */ val `$discoverMovies`: ObjectRef<List<MovieSearchResponse>>
    var `L$0`: Object? = null
    var label = 0
    ...
    init {
        `$discoverMovies` = objectRef
        `this$0` = tmdbProvider
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `TmdbProvider$getMainPage$2`(`$discoverMovies`, `this$0`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    override fun invoke(continuation: Continuation<in Unit>?): Object {
        return (create(continuation) as `TmdbProvider$getMainPage$2`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            val objectRef2: ObjectRef<List<MovieSearchResponse>> = `$discoverMovies`
            tmdb = `this$0`.tmdb
            val build: Call<MovieResultsPage> = tmdb.discoverMovie().build()
