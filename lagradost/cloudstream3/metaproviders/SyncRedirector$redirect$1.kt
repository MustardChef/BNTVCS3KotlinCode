...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: AnilistRedirector.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.metaproviders.SyncRedirector",
    m98f = "AnilistRedirector.kt",
    m97i = [0, 0],
    m96l = [21],
    m95m = "redirect",
    m94n = ["this", "preferredUrl"],
    m93s = ["L$0", "L$1"]
) /* loaded from: classes3.dex */
class `SyncRedirector$redirect$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AnilistRedirector, continuation: Continuation<in `SyncRedirector$redirect$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.redirect(null, null, this)
    }
}