...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: RepoLinkGenerator.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.player.RepoLinkGenerator",
    m98f = "RepoLinkGenerator.kt",
    m97i = [0, 0, 0, 0, 0],
    m96l = [108],
    m95m = "generateLinks",
    m94n = ["this", "subtitleCallback", "current", "currentLinkCache", "currentSubsCache"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "L$4"]
) /* renamed from: com.lagradost.cloudstream3.ui.player.RepoLinkGenerator$generateLinks$1 */ /* loaded from: classes3.dex */
class `RepoLinkGenerator$generateLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: RepoLinkGenerator,
    continuation: Continuation<in `RepoLinkGenerator$generateLinks$1`?>?
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.generateLinks(false, false, null, null, 0, this)
    }
}