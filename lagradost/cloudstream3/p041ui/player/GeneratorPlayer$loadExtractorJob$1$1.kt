...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.player.GeneratorPlayer\$loadExtractorJob$1$1",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.player.GeneratorPlayer$loadExtractorJob$1$1 */ /* loaded from: classes3.dex */
class `GeneratorPlayer$loadExtractorJob$1$1` constructor(
    extractorLink: ExtractorLink,
    continuation: Continuation<in `GeneratorPlayer$loadExtractorJob$1$1`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in Unit>?, Object> {
    /* synthetic */ val `$it`: ExtractorLink
    var label: Int = 0
    ...
    public override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `GeneratorPlayer$loadExtractorJob$1$1`(`$it`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    public override fun invoke(continuation: Continuation<in Unit>?): Object {
        return (create(continuation) as `GeneratorPlayer$loadExtractorJob$1$1`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            if (`$it`.extractorData != null && (APIHolder.INSTANCE.getApiFromNameNull(`$it`.source)
