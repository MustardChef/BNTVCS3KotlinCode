...
@Metadata(
    m108d1 = ["\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0005\n\u0002\u0010\t\n\u0002\b\u0002\u0018\u0000 \u00182\u00020\u0001:\u0001\u0018B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0004\u001a\u00020\u0005H\u0016J\n\u0010\u0006\u001a\u0004\u0018\u00010\u0007H\u0016J\b\u0010\b\u001a\u00020\tH\u0016J\b\u0010\n\u001a\u00020\u000bH\u0016J\u0012\u0010\u000c\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\r\u001a\u00020\u0005H\u0002J\u001c\u0010\u000c\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\u000f0\u000e2\u0006\u0010\u0010\u001a\u00020\u0011H\u0002J\u0010\u0010\u0012\u001a\u00020\t2\u0006\u0010\u0013\u001a\u00020\u0005H\u0016J\b\u0010\u0014\u001a\u00020\tH\u0016J\u0010\u0010\u0015\u001a\u00020\t2\u0006\u0010\u0016\u001a\u00020\u0017H\u0016R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0019"],
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.CustomDecoder */ /* loaded from: classes3.dex */
class CustomDecoder constructor() : SubtitleDecoder {
    private val realDecoder: SubtitleDecoder? = null

    /* compiled from: CustomSubtitleDecoderFactory.kt */
    @Metadata(
        m108d1 = ["\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\n\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0017\u001a\u00020\u00042\u0006\u0010\u0018\u001a\u00020\u0004J\u000e\u0010\u0019\u001a\u00020\u001a2\u0006\u0010\u001b\u001a\u00020\u001cR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u0017\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0017\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\b0\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u000c\u0010\nR\u0010\u0010\r\u001a\u0004\u0018\u00010\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u001a\u0010\u000e\u001a\u00020\u000fX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\u0013R\u001a\u0010\u0014\u001a\u00020\u000fX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0015\u0010\u0011\"\u0004\b\u0016\u0010\u0013¨\u0006\u001d"],
        m107d2 = ["Lcom/lagradost/cloudstream3/ui/player/CustomDecoder\$Companion;", "", "()V", "TAG", "", "UTF_8", "bloatRegex", "", "Lkotlin/text/Regex;", "getBloatRegex", "()Ljava/util/List;", "captionRegex", "getCaptionRegex", "overrideEncoding", "regexSubtitlesToRemoveBloat", "", "getRegexSubtitlesToRemoveBloat", "()Z", "setRegexSubtitlesToRemoveBloat", "(Z)V", "regexSubtitlesToRemoveCaptions", "getRegexSubtitlesToRemoveCaptions", "setRegexSubtitlesToRemoveCaptions", "trimStr", TypedValues.Custom.S_STRING, "updateForcedEncoding", "", "context", "Landroid/content/Context;", "app_release"],
        m106k = 1,
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.player.CustomDecoder$Companion */ /* loaded from: classes3.dex */
    class Companion private constructor() {
        /* synthetic */   constructor(defaultConstructorMarker: DefaultConstructorMarker?) : this() {}

        fun updateForcedEncoding(context: Context) {
            Intrinsics.checkNotNullParameter(context, "context")
            var string: String? = PreferenceManager.getDefaultSharedPreferences(context)
                .getString(context.getString(R.string.subtitles_encoding_key), null)
            val str: String? = string
            if (str == null || StringsKt.isBlank(str)) {
                string = null
            }
            CustomDecoder.Companion.overrideEncoding = string
        }

        var regexSubtitlesToRemoveCaptions: Boolean
            get() {
                return CustomDecoder.Companion.regexSubtitlesToRemoveCaptions
            }
            set(z) {
                CustomDecoder.Companion.regexSubtitlesToRemoveCaptions = z
            }
        var regexSubtitlesToRemoveBloat: Boolean
            get() {
                return CustomDecoder.Companion.regexSubtitlesToRemoveBloat
            }
            set(z) {
                CustomDecoder.Companion.regexSubtitlesToRemoveBloat = z
            }
        val bloatRegex: List<Regex>
            get() {
                return CustomDecoder.Companion.bloatRegex
            }
        val captionRegex: List<Regex>
            get() {
                return CustomDecoder.Companion.captionRegex
            }
        ...
        fun trimStr(string: String?): String {
            ...
            return Regex("[ \u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a\u205f]").replace(
                StringsKt.trim(
                    StringsKt.trimStart(string as CharSequence?).toString(),
                    65279,
                    8203
                ),
                " "
    ...
    val name: String
        // com.google.android.exoplayer2.decoder.Decoder
        get() {
            val subtitleDecoder: SubtitleDecoder? = realDecoder
            val name: String? = if (subtitleDecoder != null) subtitleDecoder.getName() else null
            if (name == null) {
                val name2: String = getClass().getName()
    ...
    public override fun dequeueInputBuffer(): SubtitleInputBuffer {
        Log.i(CustomDecoder.Companion.TAG, "dequeueInputBuffer")
        val subtitleDecoder: SubtitleDecoder? = realDecoder
        val dequeueInputBuffer: SubtitleInputBuffer? =
            if (subtitleDecoder != null) subtitleDecoder.dequeueInputBuffer() else null
        return if (dequeueInputBuffer == null) SubtitleInputBuffer() else dequeueInputBuffer
    }
    ...
    */
    private fun getStr(r8: ByteArray): Tuples<String, java.nio.charset.Charset> {
        /*
            r7 = this;
        ...
        L88:
            return r5
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.player.CustomDecoder.getStr(byte[]):kotlin.Pair")
    }

    private fun getStr(subtitleInputBuffer: SubtitleInputBuffer): String? {
        try {
            val byteBuffer: ByteBuffer? = subtitleInputBuffer.data
            if (byteBuffer == null) {
                return null
            }
            byteBuffer.position(0)
            val bArr: ByteArray = ByteArray(byteBuffer.remaining())
            byteBuffer.get(bArr)
            return CustomDecoder.Companion.Companion.trimStr(getStr(bArr).getFirst())
        } catch (e: Exception) {
            Log.e(CustomDecoder.Companion.TAG, "Failed to parse text returning plain data")
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */ public override fun queueInputBuffer(r10: SubtitleInputBuffer) {
        /*
            Method dump skipped, instructions count: 410
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.player.CustomDecoder.queueInputBuffer(com.google.android.exoplayer2.text.SubtitleInputBuffer):void")
    }

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // com.google.android.exoplayer2.decoder.Decoder
    public override fun dequeueOutputBuffer(): SubtitleOutputBuffer {
        val subtitleDecoder: SubtitleDecoder? = realDecoder
    ...
    public override fun setPositionUs(j: Long) {
        val subtitleDecoder: SubtitleDecoder? = realDecoder
        if (subtitleDecoder != null) {
    ...
    companion object {
        private val TAG: String = "CustomDecoder"
        private val UTF_8: String = "UTF-8"
        private val overrideEncoding: String? = null
        private val regexSubtitlesToRemoveBloat: Boolean = false
        private val regexSubtitlesToRemoveCaptions: Boolean = false
        val Companion: Companion = Companion(null)
        private val bloatRegex: List<Regex> = CollectionsKt.listOf<Object>(
            *arrayOf<Regex>(
                Regex(
        ...
        private val captionRegex: List<Regex> =
            CollectionsKt.listOf<Regex>(Regex("(-\\s?|)[\\[({][\\w\\d\\s]*?[])}]\\s*"))
    }
}