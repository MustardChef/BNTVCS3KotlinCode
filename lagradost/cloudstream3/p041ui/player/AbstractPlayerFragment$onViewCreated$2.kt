...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: AbstractPlayerFragment.kt */
@Metadata(
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.AbstractPlayerFragment$onViewCreated$2 */ /* loaded from: classes3.dex */
/* synthetic */   class `AbstractPlayerFragment$onViewCreated$2`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) : FunctionReferenceImpl(
    1,
    obj,
    AbstractPlayerFragment::class.java,
    "updateIsPlaying",
    "updateIsPlaying(Lkotlin/Pair;)V",
    0
), Function1<Tuples<out CSPlayerLoading, out CSPlayerLoading>, Unit> {
    @Override // kotlin.jvm.functions.Function1
    public /* bridge */ /* synthetic */  override fun invoke(tuples: Tuples<out CSPlayerLoading, out CSPlayerLoading>) {
        invoke2(tuples)
        return Unit.INSTANCE
    }

    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(p0: Tuples<out CSPlayerLoading, out CSPlayerLoading>) {
        Intrinsics.checkNotNullParameter(p0, "p0")
        (this.receiver as AbstractPlayerFragment).updateIsPlaying(p0)
    }
}