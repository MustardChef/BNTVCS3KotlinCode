...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.GeneratorPlayer$autoSelectSubtitles$1 */ /* loaded from: classes3.dex */
class `GeneratorPlayer$autoSelectSubtitles$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    @Override // kotlin.jvm.functions.Functions
        ...
        val autoSelectFromSettings: Boolean
        autoSelectFromSettings = `this$0`.autoSelectFromSettings()
        if (autoSelectFromSettings) {
            return
        }
        `this$0`.autoSelectFromDownloads()
    }
}