...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.player.GeneratorPlayer\$openOnlineSubPicker$5$1$2$1",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.player.GeneratorPlayer$openOnlineSubPicker$5$1$2$1 */ /* loaded from: classes3.dex */
class `GeneratorPlayer$openOnlineSubPicker$5$1$2$1` constructor(
    openSubtitlesApi: OpenSubtitlesApi,
    subtitleEntity: SubtitleEntity,
    generatorPlayer: GeneratorPlayer,
    continuation: Continuation<in `GeneratorPlayer$openOnlineSubPicker$5$1$2$1`?>?
) : SuspendLambda(1, continuation), Function1<Continuation<in Unit>?, Object> {
    /* synthetic */ val `$api`: OpenSubtitlesApi
    /* synthetic */ val `$currentSubtitle`: SubtitleEntity
    var label: Int = 0
    ...
    public override fun invoke(continuation: Continuation<in Unit>?): Object {
        return (create(continuation) as `GeneratorPlayer$openOnlineSubPicker$5$1$2$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    public override fun invokeSuspend(obj: Object): Object {
        var obj: Object = obj
        val `openOnlineSubPicker$getName`: String
        val coroutine_suspended: Object = IntrinsicsKt.getCOROUTINE_SUSPENDED()
        val i: Int = label
        if (i == 0) {
            ResultKt.throwOnFailure(obj)
            label = 1
            obj = `$api`.load(`$currentSubtitle`, this)
        ...
        `openOnlineSubPicker$getName` = GeneratorPlayer.Companion.`openOnlineSubPicker$getName`(
            `$currentSubtitle`
        )
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.player.GeneratorPlayer$openOnlineSubPicker$5$1$2$1$1 */ /* loaded from: classes3.dex */
    class C48711  /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ internal constructor(/* synthetic */
        val `this$0`: GeneratorPlayer, /* synthetic */
        ...
        @Override // kotlin.jvm.functions.Functions
            ...
            `this$0`.addAndSelectSubtitles(`$subtitle`)
        }
    }
}