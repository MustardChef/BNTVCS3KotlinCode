...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/ui/player/SubtitleOrigin;", "", "(Ljava/lang/String;I)V", "URL", "DOWNLOADED_FILE", "EMBEDDED_IN_VIDEO", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.player.SubtitleOrigin */ /* loaded from: classes3.dex */
enum class SubtitleOrigin {
    URL, DOWNLOADED_FILE, EMBEDDED_IN_VIDEO
}