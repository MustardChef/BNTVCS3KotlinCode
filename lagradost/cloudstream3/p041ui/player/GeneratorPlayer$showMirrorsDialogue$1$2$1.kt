...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.player.GeneratorPlayer$showMirrorsDialogue$1$2$1 */ /* loaded from: classes3.dex */
class `GeneratorPlayer$showMirrorsDialogue$1$2$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `$isPlaying`: Boolean, /* synthetic */
