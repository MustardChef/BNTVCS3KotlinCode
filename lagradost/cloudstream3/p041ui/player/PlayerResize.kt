...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/ui/player/PlayerResize;", "", "nameRes", "", "(Ljava/lang/String;II)V", "getNameRes", "()I", "Fit", "Fill", "Zoom", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.player.PlayerResize */ /* loaded from: classes3.dex */
enum class PlayerResize(val nameRes: Int) {
    Fit(R.string.resize_fit), Fill(R.string.resize_fill), Zoom(R.string.resize_zoom);
