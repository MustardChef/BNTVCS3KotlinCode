...
/* renamed from: com.lagradost.cloudstream3.ui.home.HomeFragment$onViewCreated$13 */ /* loaded from: classes3.dex */
internal class `HomeFragment$onViewCreated$13`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    @Metadata(
        ...
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.home.HomeFragment$onViewCreated$13$1 */ /* loaded from: classes3.dex */
    class C48601 internal constructor(/* synthetic */val `this$0`: HomeFragment,
        ...
        companion object {
            ...
            private fun `invoke$remove`(
                ...
                val card: SearchResponse = searchClickCallback.getCard()
                if (card is ResumeWatchingResult) {
                    DataStoreHelper.INSTANCE.removeLastWatched((card as ResumeWatchingResult).getParentId())
                    homeFragment.reloadStored()
                }
            }
            ...
            SingleSelectionHelper.INSTANCE.showOptionSelectStringRes(
                ...
                CollectionsKt.listOf<Object>(
                    *arrayOf<Integer>(
                        ...
                        ), Integer.valueOf(R.string.action_remove_watching)
                    ) as Array<Object>
                ),
                CollectionsKt.listOf<Object>(
                    *arrayOf<Integer>(
