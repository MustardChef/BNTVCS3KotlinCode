...
@Metadata(
    m108d1 = ["\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"],
    m107d2 = ["<anonymous>", "", "dx", "", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.home.HomeFragment$onViewCreated$4$2$1$1 */ /* loaded from: classes3.dex */
class `HomeFragment$onViewCreated$4$2$1$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    override fun invoke(i: Int) {
        ...
        if (recyclerView != null) {
            ...
            recyclerView.post(object : Runnable() {
                // from class: com.lagradost.cloudstream3.ui.home.-$$Lambda$HomeFragment$onViewCreated$4$2$1$1$XcfOiagyOxri80t7Jgt6ZcJCjnM
                @Override // java.lang.Runnable
                fun run() {
                    `m8655invoke$lambda0`(this@HomeFragment, i)
                }
            })
        }
    }
    ...
    companion object {
        ...
        fun `m8655invoke$lambda0`(`this$0`: HomeFragment, i: Int) {
