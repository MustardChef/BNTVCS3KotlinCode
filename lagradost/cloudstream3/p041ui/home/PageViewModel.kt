...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/ui/home/PageViewModel;", "Landroidx/lifecycle/ViewModel;", "()V", "_searchResponse", "Landroidx/lifecycle/MutableLiveData;", "Lcom/lagradost/cloudstream3/mvvm/Resource;", "Lcom/lagradost/cloudstream3/PageResponse;", "hasLoadMore", "", "getHasLoadMore", "()Z", "repos", "Lcom/lagradost/cloudstream3/ui/APIRepository;", "getRepos", "()Lcom/lagradost/cloudstream3/ui/APIRepository;", "setRepos", "(Lcom/lagradost/cloudstream3/ui/APIRepository;)V", "searchResponse", "Landroidx/lifecycle/LiveData;", "getSearchResponse", "()Landroidx/lifecycle/LiveData;", "getPage", "Lkotlinx/coroutines/Job;", "url", "", "name", "urlApi", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.home.PageViewModel */ /* loaded from: classes3.dex */
class PageViewModel : ViewModel() {
    val _searchResponse: MutableLiveData<Resource<PageResponse>> =
        MutableLiveData<Resource<PageResponse>>()
    val hasLoadMore = false
    var repos: APIRepository? = null
    val searchResponse: LiveData<Resource<PageResponse>>
        get() = _searchResponse

    fun getPage(str: String?, str2: String?, str3: String?): Job {
        val `launch$default`: Job
        `launch$default` = BuildersKt__Builders_commonKt.`launch$default`(
            ViewModelKt.getViewModelScope(this),
            null,
            null,
            `PageViewModel$getPage$1`(str, str2, str3, this, null),
            3,
            null
        )
