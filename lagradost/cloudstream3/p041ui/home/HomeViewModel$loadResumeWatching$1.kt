...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.home.HomeViewModel\$loadResumeWatching$1",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.home.HomeViewModel$loadResumeWatching$1 */ /* loaded from: classes3.dex */
class `HomeViewModel$loadResumeWatching$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: HomeViewModel,
    continuation: Continuation<in `HomeViewModel$loadResumeWatching$1`?>?
    ...
    public override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `HomeViewModel$loadResumeWatching$1`(`this$0`, continuation)
    }
    ...
    public override fun invoke(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `HomeViewModel$loadResumeWatching$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
    ...
    */ public override fun invokeSuspend(r7: Any?): Any {
        /*
            r6 = this;
        ...
        L63:
            ...
            return r7
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.p041ui.home.HomeViewModel\$loadResumeWatching$1.invokeSuspend(java.lang.Object):java.lang.Object")
    }
}