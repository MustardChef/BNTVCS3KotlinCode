...
@Metadata(
    m108d1 = ["\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003H\n¢\u0006\u0002\b\u0004¨\u0006\u0005"],
    m107d2 = ["<anonymous>", "Landroidx/lifecycle/viewmodel/CreationExtras;", "VM", "Landroidx/lifecycle/ViewModel;", "invoke", "androidx/fragment/app/FragmentViewModelLazyKt\$activityViewModels$5"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.search.SearchFragment$special$$inlined$activityViewModels$default$2 */ /* loaded from: classes4.dex */
class `SearchFragment$special$$inlined$activityViewModels$default$2`     /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `$extrasProducer`: Functions<*>?, /* synthetic */
    val `$this_activityViewModels`: Fragment
) : Lambda<Any?>(0), Functions<CreationExtras?> {
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // kotlin.jvm.functions.Functions
    public override fun invoke(): CreationExtras {
        var creationExtras: CreationExtras
        val functions: Functions<*>? = `$extrasProducer`
        if (functions == null || (functions.invoke() as CreationExtras?. also ({
                creationExtras = it
            })) == null) {
            val defaultViewModelCreationExtras: CreationExtras =
                `$this_activityViewModels`.requireActivity().getDefaultViewModelCreationExtras()
