...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.SelectSourceController$1$3$loadMirror$3 */ /* loaded from: classes.dex */
class `SelectSourceController$1$3$loadMirror$3` constructor(/* synthetic */val `$index`: Int, /* synthetic */
