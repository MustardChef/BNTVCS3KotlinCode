...
internal class `ChromecastSubtitlesFragment$onViewCreated$2`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) : FunctionReferenceImpl(
    1,
    obj,
    ChromecastSubtitlesFragment::class.java,
    "onDialogDismissed",
    "onDialogDismissed(I)V",
    0
), Function1<Integer, Unit> {
    ...
    override fun invoke(i: Int) {
        (this.receiver as ChromecastSubtitlesFragment).onDialogDismissed(i)
    }
}