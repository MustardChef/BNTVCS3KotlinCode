...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.subtitles.SubtitlesFragment$onViewCreated$3$3 */ /* loaded from: classes4.dex */
class `SubtitlesFragment$onViewCreated$3$3` constructor(/* synthetic */val `this$0`: SubtitlesFragment,
                                                                       list: List<Tuples<Integer, String>>,
                                                                       view: View
) : Lambda<Any?>(1), Function1<Integer, Unit> {
    /* synthetic */ val `$elevationTypes`: List<Tuples<Integer, String>>
    ...
    override fun invoke(i: Int) {
        ...
        val list: List<Tuples<Integer, String>> = `$elevationTypes`
        ...
        saveCaptionStyle.setElevation((arrayList.get(i) as Number).intValue())
        ...
        z = `this$0`.hide
        if (!z || (`this$0`.getActivity().also({ activity = it })) == null) {
            return
        }
