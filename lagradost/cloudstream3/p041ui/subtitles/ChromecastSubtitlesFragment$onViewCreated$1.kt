...
internal class `ChromecastSubtitlesFragment$onViewCreated$1`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(obj: Object?) : FunctionReferenceImpl(
    1,
    obj,
    ChromecastSubtitlesFragment::class.java,
    "onColorSelected",
    "onColorSelected(Lkotlin/Pair;)V",
    0
), Function1<Tuples<out Integer?, out Integer?>, Unit> {
    @Override // kotlin.jvm.functions.Function1
    public /* bridge */ /* synthetic */  override fun invoke(tuples: Tuples<out Integer?, out Integer?>) {
        invoke2(tuples as Tuples<Integer?, Integer?>)
        return Unit.INSTANCE
    }

    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(p0: Tuples<Integer?, Integer?>) {
        Intrinsics.checkNotNullParameter(p0, "p0")
        (this.receiver as ChromecastSubtitlesFragment).onColorSelected(p0)
    }
}