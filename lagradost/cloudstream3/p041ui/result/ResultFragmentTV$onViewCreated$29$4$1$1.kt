...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.result.ResultFragmentTV\$onViewCreated$29$4$1$1",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentTV$onViewCreated$29$4$1$1 */ /* loaded from: classes4.dex */
class `ResultFragmentTV$onViewCreated$29$4$1$1` constructor(
    context: Context,
    str: String?,
    continuation: Continuation<in `ResultFragmentTV$onViewCreated$29$4$1$1`?>?
    ...
    public override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `ResultFragmentTV$onViewCreated$29$4$1$1`(`$ctx`, `$posterImageLink`, continuation)
    }
    ...
    public override fun invoke(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `ResultFragmentTV$onViewCreated$29$4$1$1`).invokeSuspend(
            Unit.INSTANCE
        )
    }
        ...
        if (label == 0) {
            ...
            if (imageView != null) {
                ...
                imageView.setOnClickListener(object : OnClickListener() {
                    // from class: com.lagradost.cloudstream3.ui.result.-$$Lambda$ResultFragmentTV$onViewCreated$29$4$1$1$wzc4-mWT_QZaMDMeivyPZIV8uH4
                    @Override // android.view.View.OnClickListener
                    fun onClick(view: View?) {
                        `m8855invokeSuspend$lambda1$lambda0`(this@AlertDialog, view)
                    }
                })
                return imageView
            }
    ...
    companion object {
        ...
        fun `m8855invokeSuspend$lambda1$lambda0`(alertDialog: AlertDialog?, view: View?) {
