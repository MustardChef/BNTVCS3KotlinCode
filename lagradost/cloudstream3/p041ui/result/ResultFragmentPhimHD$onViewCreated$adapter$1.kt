...
@Metadata(
    m108d1 = ["\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"],
    m107d2 = ["<anonymous>", "", "episodeClick", "Lcom/lagradost/cloudstream3/ui/result/EpisodeClickEvent;", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$adapter$1 */ /* loaded from: classes4.dex */
internal class `ResultFragmentPhimHD$onViewCreated$adapter$1` constructor(/* synthetic */val `this$0`: ResultFragmentPhimHD, /* synthetic */
                                                                                         val `$apiName`: String,
                                                                                         mainAPI: MainAPI
) : Lambda<Any?>(1), Function1<EpisodeClickEvent?, Unit> {
    ...
    public /* bridge */ /* synthetic */  override fun invoke(episodeClickEvent: EpisodeClickEvent?) {
        invoke2(episodeClickEvent)
        return Unit.INSTANCE
    }

    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(episodeClick: EpisodeClickEvent?) {
