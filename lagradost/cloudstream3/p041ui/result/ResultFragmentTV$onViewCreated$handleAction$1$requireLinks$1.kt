...
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentTV$onViewCreated$handleAction$1$requireLinks$1 */ /* loaded from: classes4.dex */
class `ResultFragmentTV$onViewCreated$handleAction$1$requireLinks$1`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(continuation: Continuation<in `ResultFragmentTV$onViewCreated$handleAction$1$requireLinks$1`?>?) :
    ...
    public override fun invokeSuspend(obj: Object): Object {
        ...
        `invokeSuspend$requireLinks` =
            `ResultFragmentTV$onViewCreated$handleAction$1`.Companion.`invokeSuspend$requireLinks`(
                null,
                null,
                null,
                null,
