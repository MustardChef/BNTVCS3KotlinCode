...
@Metadata(
    m108d1 = ["\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u0004\u0018\u00010\u00012\u0006\u0010\u0002\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0003"],
    m107d2 = ["<anonymous>", "Lcom/lagradost/cloudstream3/syncproviders/SyncAPI\$SyncStatus;", "status", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.result.SyncViewModel$modifyMaxEpisode$1 */ /* loaded from: classes4.dex */
internal class `SyncViewModel$modifyMaxEpisode$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    val `$episodeNum`: Int
) : Lambda<Any?>(1), Function1<SyncStatus, SyncStatus?> {
    @Override // kotlin.jvm.functions.Function1
    public override fun invoke(status: SyncStatus): SyncStatus? {
        Intrinsics.checkNotNullParameter(status, "status")
        val i: Int = `$episodeNum`
        val watchedEpisodes: Integer? = status.getWatchedEpisodes()
        if (watchedEpisodes != null) {
            return SyncAPI.SyncStatus.`copy$default`(
                status,
                0,
                null,
                Integer.valueOf(Math.max(i, watchedEpisodes.intValue())),
                null,
                null,
                27,
                null
