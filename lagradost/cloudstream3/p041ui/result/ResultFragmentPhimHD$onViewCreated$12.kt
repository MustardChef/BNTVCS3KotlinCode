...
@Metadata(
    m108d1 = ["\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0005"],
    m107d2 = ["<anonymous>", "", SessionDescription.ATTR_RANGE, "", "kotlin.jvm.PlatformType", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$12 */ /* loaded from: classes4.dex */
internal class `ResultFragmentPhimHD$onViewCreated$12`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    ...
    fun invoke2(str: String?) {
        val materialButton: MaterialButton? =
            `this$0`.`_$_findCachedViewById`(C4761R.C4764id.result_episode_select) as MaterialButton?
