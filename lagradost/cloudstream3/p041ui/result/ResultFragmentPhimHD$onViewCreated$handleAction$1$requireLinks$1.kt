...
@DebugMetadata(
    ...
    m97i = [0, 0, 0, 0, 0],
    m96l = [988],
    m95m = "invokeSuspend\$requireLinks",
    m94n = ["this$0", "currentLinks", "currentSubs", "loadingDialog", "currentLoad"],
    m93s = ["L$0", "L$1", "L$2", "L$3", "I$0"]
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$onViewCreated$handleAction$1$requireLinks$1 */ /* loaded from: classes4.dex */
class `ResultFragmentPhimHD$onViewCreated$handleAction$1$requireLinks$1`  /* JADX INFO: Access modifiers changed from: package-private */
constructor(continuation: Continuation<in `ResultFragmentPhimHD$onViewCreated$handleAction$1$requireLinks$1`?>?) :
    ...
    public override fun invokeSuspend(obj: Object): Object {
        val `invokeSuspend$requireLinks`: Object
        result = obj
        label = label or Integer.MIN_VALUE
        `invokeSuspend$requireLinks` =
            `ResultFragmentPhimHD$onViewCreated$handleAction$1`.Companion.`invokeSuspend$requireLinks`(
                null,
                null,
                null,
                null,
