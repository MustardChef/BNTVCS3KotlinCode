...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/ui/result/CurrentSynced;", "", "name", "", "idPrefix", "isSynced", "", "hasAccount", "icon", "", "(Ljava/lang/String;Ljava/lang/String;ZZLjava/lang/Integer;)V", "getHasAccount", "()Z", "getIcon", "()Ljava/lang/Integer;", "Ljava/lang/Integer;", "getIdPrefix", "()Ljava/lang/String;", "getName", "component1", "component2", "component3", "component4", "component5", "copy", "(Ljava/lang/String;Ljava/lang/String;ZZLjava/lang/Integer;)Lcom/lagradost/cloudstream3/ui/result/CurrentSynced;", "equals", "other", "hashCode", "toString", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.result.CurrentSynced */ /* loaded from: classes4.dex */
class CurrentSynced constructor(
    name: String,
    idPrefix: String,
    z: Boolean,
    z2: Boolean,
    ...
    fun copy(name: String, idPrefix: String, z: Boolean, z2: Boolean, num: Integer): CurrentSynced {
        Intrinsics.checkNotNullParameter(name, "name")
        Intrinsics.checkNotNullParameter(idPrefix, "idPrefix")
        return CurrentSynced(name, idPrefix, z, z2, num)
    }
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is CurrentSynced) {
            val currentSynced: CurrentSynced = obj
            return Intrinsics.areEqual(name, currentSynced.name) && Intrinsics.areEqual(
                idPrefix, currentSynced.idPrefix
            ) && (isSynced == currentSynced.isSynced) && (hasAccount == currentSynced.hasAccount) && Intrinsics.areEqual(
                icon, currentSynced.icon
            )
        }
        return false
    }
    ...
    override fun hashCode(): Int {
        val hashCode: Int = ((name.hashCode() * 31) + idPrefix.hashCode()) * 31
        val z: Boolean = isSynced
        var i: Int = z.toInt()
        if (z.toInt() != 0) {
            i = 1
        }
        val i2: Int = (hashCode + i) * 31
        val z2: Boolean = hasAccount
        val i3: Int = (i2 + (if (z2) 1 else if (z2) 1 else 0)) * 31
        val num: Integer? = icon
        return i3 + (if (num == null) 0 else num.hashCode())
    }

    override fun toString(): String {
        return "CurrentSynced(name=" + name + ", idPrefix=" + idPrefix + ", isSynced=" + isSynced + ", hasAccount=" + hasAccount + ", icon=" + icon + ')'
    }
