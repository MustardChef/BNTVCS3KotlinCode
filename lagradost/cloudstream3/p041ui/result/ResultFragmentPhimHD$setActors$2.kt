...
@Metadata(
    m108d1 = ["\u0000\u000e\n\u0000\n\u0002\u0010\r\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"],
    m107d2 = ["<anonymous>", "", "it", "Lcom/lagradost/cloudstream3/ActorData;", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$setActors$2 */ /* loaded from: classes4.dex */
internal class `ResultFragmentPhimHD$setActors$2` constructor() : Lambda<Any?>(1),
    Function1<ActorData, CharSequence> {
    @Override // kotlin.jvm.functions.Function1
    public override fun invoke(it: ActorData): CharSequence {
        Intrinsics.checkNotNullParameter(it, "it")
        return it.actor.name
    }

    companion object {
        val INSTANCE: `ResultFragmentPhimHD$setActors$2` = `ResultFragmentPhimHD$setActors$2`()
    }
}