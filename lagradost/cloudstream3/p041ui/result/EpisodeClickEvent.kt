...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.result.EpisodeClickEvent */ /* loaded from: classes4.dex */
class EpisodeClickEvent constructor(i: Int, data: ResultEpisode?) {
    val action: Int
    val data: ResultEpisode?
    operator fun component1(): Int {
        return action
    }

    operator fun component2(): ResultEpisode? {
        return data
    }

    fun copy(i: Int, data: ResultEpisode?): EpisodeClickEvent {
        Intrinsics.checkNotNullParameter(data, "data")
        return EpisodeClickEvent(i, data)
    }
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is EpisodeClickEvent) {
            val episodeClickEvent: EpisodeClickEvent = obj
            return action == episodeClickEvent.action && Intrinsics.areEqual(
                data, episodeClickEvent.data
            )
        }
        return false
    }
    ...
    override fun toString(): String {
        return "EpisodeClickEvent(action=" + action + ", data=" + data + ')'
    }
    ...
    companion object {
        fun  /* synthetic */`copy$default`(
            ...
            var i: Int = i
            var resultEpisode: ResultEpisode? = resultEpisode
            if ((i2 and 1) != 0) {
