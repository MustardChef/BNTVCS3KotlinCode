...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.result.ResultFragmentPhimHD$setRecommendations$3$1$2 */ /* loaded from: classes4.dex */
class `ResultFragmentPhimHD$setRecommendations$3$1$2` constructor(/* synthetic */val `this$0`: ResultFragmentPhimHD,
