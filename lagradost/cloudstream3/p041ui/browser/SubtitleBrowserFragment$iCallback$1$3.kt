...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.browser.SubtitleBrowserFragment\$iCallback$1$3",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.browser.SubtitleBrowserFragment$iCallback$1$3 */ /* loaded from: classes.dex */
class `SubtitleBrowserFragment$iCallback$1$3`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: SubtitleBrowserFragment,
    continuation: Continuation<in `SubtitleBrowserFragment$iCallback$1$3`?>?
    ...
    public override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `SubtitleBrowserFragment$iCallback$1$3`(`this$0`, continuation)
    }
    ...
    public override fun invoke(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `SubtitleBrowserFragment$iCallback$1$3`).invokeSuspend(
            Unit.INSTANCE
        )
    }
