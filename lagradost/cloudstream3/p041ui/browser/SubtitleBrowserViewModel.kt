...
class SubtitleBrowserViewModel constructor() : ViewModel() {
    ...
    fun downloadSubtitle(url: String?, fileDir: String) {
        ...
        BuildersKt__Builders_commonKt.`launch$default`(
            ...
            null,
            null,
            `SubtitleBrowserViewModel$downloadSubtitle$1`(this, url, fileDir, null),
            3,
            null
        )
    }
