...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.download.DownloadClickEvent */ /* loaded from: classes3.dex */
class DownloadClickEvent constructor(i: Int, data: IMinimumData?) {
    val action: Int
    private val data: IMinimumData?
    operator fun component1(): Int {
        return action
    }

    operator fun component2(): IMinimumData? {
        return data
    }

    fun copy(i: Int, data: IMinimumData?): DownloadClickEvent {
        Intrinsics.checkNotNullParameter(data, "data")
        return DownloadClickEvent(i, data)
    }
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is DownloadClickEvent) {
            val downloadClickEvent: DownloadClickEvent = obj
            return action == downloadClickEvent.action && Intrinsics.areEqual(
                data, downloadClickEvent.data
            )
        }
        return false
    }
    ...
    override fun toString(): String {
        return "DownloadClickEvent(action=" + action + ", data=" + data + ')'
    }
    ...
    companion object {
        fun  /* synthetic */`copy$default`(
            ...
            var i: Int = i
            var iMinimumData: IMinimumData? = iMinimumData
            if ((i2 and 1) != 0) {
