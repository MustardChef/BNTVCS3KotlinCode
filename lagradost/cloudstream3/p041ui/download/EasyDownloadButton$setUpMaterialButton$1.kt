...
/* renamed from: com.lagradost.cloudstream3.ui.download.EasyDownloadButton$setUpMaterialButton$1 */ /* loaded from: classes3.dex */
internal class `EasyDownloadButton$setUpMaterialButton$1` constructor(materialButton: MaterialButton) :
    Lambda<Any?>(1), Function1<Tuples<out Integer?, out String?>, Unit> {
    /* synthetic */ val `$downloadButton`: MaterialButton
    ...
    fun invoke2(it: Tuples<Integer?, String?>) {
        ...
        `$downloadButton`.setIconResource(it.getFirst().intValue())
        `$downloadButton`.setText(it.getSecond())
    }
}