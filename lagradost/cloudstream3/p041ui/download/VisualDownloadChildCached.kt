...
@Metadata(
    ...
    m107d2 = ["Lcom/lagradost/cloudstream3/ui/download/VisualDownloadChildCached;", "", "currentBytes", "", "totalBytes", "data", "Lcom/lagradost/cloudstream3/utils/VideoDownloadHelper\$DownloadEpisodeCached;", "(JJLcom/lagradost/cloudstream3/utils/VideoDownloadHelper\$DownloadEpisodeCached;)V", "getCurrentBytes", "()J", "getData", "()Lcom/lagradost/cloudstream3/utils/VideoDownloadHelper\$DownloadEpisodeCached;", "getTotalBytes", "component1", "component2", "component3", "copy", "equals", "", "other", "hashCode", "", "toString", "", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.download.VisualDownloadChildCached */ /* loaded from: classes3.dex */
class VisualDownloadChildCached constructor(j: Long, j2: Long, data: DownloadEpisodeCached) {
    val currentBytes: Long
    private val data: DownloadEpisodeCached
    val totalBytes: Long
    ...
    operator fun component3(): DownloadEpisodeCached {
        return data
    }

    fun copy(j: Long, j2: Long, data: DownloadEpisodeCached): VisualDownloadChildCached {
        Intrinsics.checkNotNullParameter(data, "data")
        return VisualDownloadChildCached(j, j2, data)
    }
    ...
    override fun equals(obj: Object): Boolean {
        ...
        if (obj is VisualDownloadChildCached) {
            val visualDownloadChildCached: VisualDownloadChildCached = obj
            return (currentBytes == visualDownloadChildCached.currentBytes) && (totalBytes == visualDownloadChildCached.totalBytes) && Intrinsics.areEqual(
                data, visualDownloadChildCached.data
            )
        }
        return false
    }
    ...
    override fun hashCode(): Int {
        return (((`C$r8$backportedMethods$utility$Long$1$hashCode`.hashCode(currentBytes) * 31) + `C$r8$backportedMethods$utility$Long$1$hashCode`.hashCode(
            totalBytes
        )) * 31) + data.hashCode()
    }

    override fun toString(): String {
        return "VisualDownloadChildCached(currentBytes=" + currentBytes + ", totalBytes=" + totalBytes + ", data=" + data + ')'
    }
    ...
    fun getData(): DownloadEpisodeCached {
        return data
    }

    companion object {
        fun  /* synthetic */`copy$default`(
            visualDownloadChildCached: VisualDownloadChildCached,
            j: Long,
            j2: Long,
            ...
            var j: Long = j
            var j2: Long = j2
            var downloadEpisodeCached: DownloadEpisodeCached = downloadEpisodeCached
            if ((i and 1) != 0) {
