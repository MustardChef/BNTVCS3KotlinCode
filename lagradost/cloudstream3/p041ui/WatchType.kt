...
@Metadata(
    m108d1 = ["\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\b\n\u0002\b\u000f\b\u0086\u0001\u0018\u0000 \u00112\b\u0012\u0004\u0012\u00020\u00000\u0001:\u0001\u0011B#\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0001\u0010\u0004\u001a\u00020\u0003\u0012\b\b\u0001\u0010\u0005\u001a\u00020\u0003¢\u0006\u0002\u0010\u0006R\u0011\u0010\u0005\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\bR\u0011\u0010\u0004\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\bj\u0002\b\u000bj\u0002\b\u000cj\u0002\b\rj\u0002\b\u000ej\u0002\b\u000fj\u0002\b\u0010¨\u0006\u0012"],
    m107d2 = ["Lcom/lagradost/cloudstream3/ui/WatchType;", "", "internalId", "", "stringRes", "iconRes", "(Ljava/lang/String;IIII)V", "getIconRes", "()I", "getInternalId", "getStringRes", "WATCHING", "COMPLETED", "ONHOLD", "DROPPED", "PLANTOWATCH", "NONE", "Companion", "app_release"],
    m106k = 1,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.WatchType */ /* loaded from: classes.dex */
enum class WatchType(val internalId: Int, val stringRes: Int, val iconRes: Int) {
    WATCHING(0, R.string.type_watching, R.drawable.ic_baseline_remove_red_eye_24), COMPLETED(
        1,
        R.string.type_completed,
        R.drawable.ic_baseline_check_24
    ),
    ONHOLD(2, R.string.type_on_hold, R.drawable.ic_baseline_pause_24), DROPPED(
        3,
        R.string.type_dropped,
        R.drawable.ic_baseline_close_24
    ),
    PLANTOWATCH(4, R.string.type_plan_to_watch, R.drawable.ic_baseline_close_24), NONE(
        5,
        R.string.type_none,
    ...
    @Metadata(
        ...
        m107d2 = ["Lcom/lagradost/cloudstream3/ui/WatchType\$Companion;", "", "()V", "fromInternalId", "Lcom/lagradost/cloudstream3/ui/WatchType;", "id", "", "(Ljava/lang/Integer;)Lcom/lagradost/cloudstream3/ui/WatchType;", "app_release"],
        m106k = 1,
        m105mv = [1, 6, 0],
        m103xi = 48
    ) /* renamed from: com.lagradost.cloudstream3.ui.WatchType$Companion */ /* loaded from: classes.dex */
    class Companion private constructor() {
        /* synthetic */   constructor(defaultConstructorMarker: DefaultConstructorMarker?) : this() {}

        fun fromInternalId(num: Integer?): WatchType {
            var watchType: WatchType?
            val values: Array<WatchType> = values()
            ...
            while (true) {
                ...
                watchType = values.get(i)
                if (num != null && watchType.internalId == num.intValue()) {
                    break
                }
                i++
            }
            return if (watchType == null) NONE else watchType
        }
    }
