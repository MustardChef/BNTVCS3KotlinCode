...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.ui.APIRepository",
    ...
    m94n = [],
    m93s = []
) /* renamed from: com.lagradost.cloudstream3.ui.APIRepository$loadLinks$1 */ /* loaded from: classes.dex */
class `APIRepository$loadLinks$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(/* synthetic */
    val `this$0`: APIRepository, continuation: Continuation<in `APIRepository$loadLinks$1`?>?
