...
/* compiled from: lambda */ /* renamed from: com.lagradost.cloudstream3.ui.settings.-$$Lambda$SettingsGeneral$FYlCQVujJ8iEr7ZEFy64GbqALbY  reason: invalid class name */ /* loaded from: classes4.dex */
/* synthetic */  class `$$Lambda$SettingsGeneral$FYlCQVujJ8iEr7ZEFy64GbqALbY` private /* synthetic */   constructor() :
    OnPreferenceClickListener {
    @Override // androidx.preference.Preference.OnPreferenceClickListener
    public override fun onPreferenceClick(preference: Preference): Boolean {
        val `m8912onCreatePreferences$lambda9`: Boolean
        `m8912onCreatePreferences$lambda9` =
            SettingsGeneral.Companion.`m8912onCreatePreferences$lambda9`(preference)
        return `m8912onCreatePreferences$lambda9`
    }

    companion object {
        /* synthetic */ val INSTANCE: `$$Lambda$SettingsGeneral$FYlCQVujJ8iEr7ZEFy64GbqALbY` =
            `$$Lambda$SettingsGeneral$FYlCQVujJ8iEr7ZEFy64GbqALbY`()
    }
}