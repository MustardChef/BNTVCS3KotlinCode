...
@Metadata(
    m108d1 = ["\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"],
    m107d2 = ["<anonymous>", "", "it", "Lcom/lagradost/cloudstream3/ui/settings/AccountClickCallback;", "invoke"],
    m106k = 3,
    m105mv = [1, 6, 0],
    m103xi = 48
)
/* renamed from: com.lagradost.cloudstream3.ui.settings.SettingsAccount$showAccountSwitch$adapter$1 */ /* loaded from: classes4.dex */
internal class `SettingsAccount$showAccountSwitch$adapter$1` constructor(
    alertDialog: AlertDialog,
    settingsAccount: SettingsAccount,
    accountManager: AccountManager
) : Lambda<Any?>(1), Function1<AccountClickCallback, Unit> {
    /* synthetic */ val `$api`: AccountManager
    /* synthetic */ val `$dialog`: AlertDialog
    ...
    public /* bridge */ /* synthetic */  override fun invoke(accountClickCallback: AccountClickCallback) {
        invoke2(accountClickCallback)
        return Unit.INSTANCE
    }

    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(it: AccountClickCallback) {
        Intrinsics.checkNotNullParameter(it, "it")
        val alertDialog: AlertDialog? = `$dialog`
        if (alertDialog != null) {
            UIHelper.INSTANCE.dismissSafe(alertDialog, `this$0`.getActivity())
        }
        `$api`.changeAccount(it.getCard().accountIndex)
    }
}