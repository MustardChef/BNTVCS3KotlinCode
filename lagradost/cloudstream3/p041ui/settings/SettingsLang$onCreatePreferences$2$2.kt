...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.settings.SettingsLang$onCreatePreferences$2$2 */ /* loaded from: classes4.dex */
class `SettingsLang$onCreatePreferences$2$2` constructor(
    ...
    override fun invoke(i: Int) {
        `$settingsManager`.edit()
            .putInt(`this$0`.getString(R.string.prefer_media_type_key), `$prefValues`.get(i))
            .apply()
