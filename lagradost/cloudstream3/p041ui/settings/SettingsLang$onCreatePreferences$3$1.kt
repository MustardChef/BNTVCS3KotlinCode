...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.settings.SettingsLang$onCreatePreferences$3$1 */ /* loaded from: classes4.dex */
class `SettingsLang$onCreatePreferences$3$1` internal constructor() : Lambda<Any?>(0),
    Functions<Unit> {
    ...
    companion object {
        val INSTANCE: `SettingsLang$onCreatePreferences$3$1` =
