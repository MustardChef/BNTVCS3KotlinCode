...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.settings.SettingsUI$onCreatePreferences$4$2 */ /* loaded from: classes4.dex */
class `SettingsUI$onCreatePreferences$4$2` constructor(
    ...
    override fun invoke(i: Int) {
        try {
            `$settingsManager`.edit()
                .putString(`this$0`.getString(R.string.primary_color_key), `$prefValues`.get(i))
                .apply()
