...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.settings.SettingsUI$onCreatePreferences$2$2 */ /* loaded from: classes4.dex */
class `SettingsUI$onCreatePreferences$2$2` constructor(
    ...
    override fun invoke(i: Int) {
        try {
            `$settingsManager`.edit()
                .putInt(`this$0`.getString(R.string.app_layout_key), `$prefValues`.get(i)).apply()
