...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: SettingsUpdates.kt */
@Metadata(
    m108d1 = ["\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"],
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.settings.SettingsUpdates$onCreatePreferences$4$1 */ /* loaded from: classes4.dex */
class `SettingsUpdates$onCreatePreferences$4$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */ constructor(  /* synthetic */
    val `this$0`: SettingsUpdates
    ...
    @Override // kotlin.jvm.functions.Functions
        ...
        val companion: InAppUpdater.Companion = InAppUpdater.Companion
        val requireActivity: FragmentActivity = `this$0`.requireActivity()
        Intrinsics.checkNotNullExpressionValue(requireActivity, "requireActivity()")
        if (companion.runAutoUpdate(requireActivity, false) || (`this$0`.getActivity()
                .also({ activity = it })) == null
        ) {
            return
        }
        val settingsUpdates: SettingsUpdates = `this$0`
        activity.runOnUiThread(object : Runnable() {
            // from class: com.lagradost.cloudstream3.ui.settings.-$$Lambda$SettingsUpdates$onCreatePreferences$4$1$VMDyYChqw--Hhp_IOfZyxO4gdeg
            @Override // java.lang.Runnable
            fun run() {
                `m8952invoke$lambda0`(this@SettingsUpdates)
            }
        })
    }
    ...
    companion object {
        ...
        fun `m8952invoke$lambda0`(`this$0`: SettingsUpdates) {
