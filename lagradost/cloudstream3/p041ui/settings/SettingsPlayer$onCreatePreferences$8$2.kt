...
@Metadata(
    ...
    m105mv = [1, 6, 0],
    m103xi = 48
) /* renamed from: com.lagradost.cloudstream3.ui.settings.SettingsPlayer$onCreatePreferences$8$2 */ /* loaded from: classes4.dex */
class `SettingsPlayer$onCreatePreferences$8$2` constructor(
    ...
    override fun invoke(i: Int) {
        `$settingsManager`.edit()
            .putInt(`this$0`.getString(R.string.video_buffer_size_key), `$prefValues`.get(i))
            .apply()
    }
}