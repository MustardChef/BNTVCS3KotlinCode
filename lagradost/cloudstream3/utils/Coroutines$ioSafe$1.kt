...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.utils.Coroutines\$ioSafe$1",
    m98f = "Coroutines.kt",
    m97i = [],
    m96l = [21],
    m95m = "invokeSuspend",
...
class `Coroutines$ioSafe$1`(
    function1: Function1<in Continuation<in Unit>?, out Object?>,
    continuation: Continuation<in `Coroutines$ioSafe$1`?>?
    ...
    override fun create(obj: Object, continuation: Continuation<*>?): Continuation<Unit> {
        return `Coroutines$ioSafe$1`(`$work`, continuation)
    }
    ...
    override fun invoke(
        ...
        return (create(
            coroutineScope,
            continuation
        ) as `Coroutines$ioSafe$1`).invokeSuspend(Unit.INSTANCE)
    }
