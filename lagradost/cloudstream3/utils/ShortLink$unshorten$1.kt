...
@DebugMetadata(
    ...
    m96l = [59],
    m95m = "unshorten",
    m94n = ["type", "currentUrl", "oldurl"],
    m93s = ["L$0", "L$1", "L$2"]
) /* loaded from: classes4.dex */
class `ShortLink$unshorten$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: UnshortenUrl, continuation: Continuation<in `ShortLink$unshorten$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.unshorten(null, null, this)
    }
}