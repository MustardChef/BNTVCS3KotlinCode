...
internal class `Vector2$lengthSquared$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(  /* synthetic */
    val `this$0`: Vector2
) : Lambda<Any?>(0), Functions<Float?> {
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // kotlin.jvm.functions.Functions
    override fun invoke(): Float {
        return Float.valueOf(`this$0`.x * `this$0`.x + `this$0`.y * `this$0`.y)
    }
}