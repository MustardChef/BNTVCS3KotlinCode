...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.utils.ExtractorApi",
...
class `ExtractorApi$getUrl$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: ExtractorApi, continuation: Continuation<in `ExtractorApi$getUrl$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return ExtractorApi.Companion.`getUrl$suspendImpl`(`this$0`, null, null, null, null, this)
    }
}