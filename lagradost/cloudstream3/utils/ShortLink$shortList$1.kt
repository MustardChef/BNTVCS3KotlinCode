...
internal class `ShortLink$shortList$1`  /* JADX INFO: Access modifiers changed from: package-private */
    (obj: Object?) : FunctionReferenceImpl(
    2,
    obj,
    UnshortenUrl::class.java,
    "unshortenAdfly",
    "unshortenAdfly(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;",
    0
    ...
    override fun invoke(str: String?, continuation: Continuation<in String?>?): Object? {
        return (this.receiver as UnshortenUrl).unshortenAdfly(str, continuation)
    }
}