...
internal class `ShortLink$shortList$2`  /* JADX INFO: Access modifiers changed from: package-private */
    (obj: Object?) : FunctionReferenceImpl(
    2,
    obj,
    UnshortenUrl::class.java,
    "unshortenLinkup",
    "unshortenLinkup(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;",
    0
    ...
    override fun invoke(str: String?, continuation: Continuation<in String?>?): Object? {
        return (this.receiver as UnshortenUrl).unshortenLinkup(str, continuation)
    }
}