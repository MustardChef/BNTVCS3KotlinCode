...
internal class `ShortLink$shortList$4`  /* JADX INFO: Access modifiers changed from: package-private */
    (obj: Object?) : FunctionReferenceImpl(
    2,
    obj,
    UnshortenUrl::class.java,
    "unshortenNuovoIndirizzo",
    "unshortenNuovoIndirizzo(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;",
    0
    ...
    override fun invoke(str: String?, continuation: Continuation<in String?>?): Object? {
        return (this.receiver as UnshortenUrl).unshortenNuovoIndirizzo(str, continuation)
    }
}