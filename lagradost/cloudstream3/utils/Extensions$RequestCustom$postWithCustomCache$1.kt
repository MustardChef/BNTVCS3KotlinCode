...
@DebugMetadata(
    ...
    m97i = [0],
    m96l = [81],
    m95m = "postWithCustomCache",
    m94n = ["url"],
    m93s = ["L$0"]
) /* loaded from: classes4.dex */
class `Extensions$RequestCustom$postWithCustomCache$1`(
    requestCustom: RequestCustom,
    continuation: Continuation<in `Extensions$RequestCustom$postWithCustomCache$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.postWithCustomCache(
            null,
            null,
            null,
            null,
