...
internal class `ShortLink$shortList$7`  /* JADX INFO: Access modifiers changed from: package-private */
    (obj: Object?) : AdaptedFunctionReference(
    2,
    obj,
    UnshortenUrl::class.java,
    "unshortenDavisonbarker",
    "unshortenDavisonbarker(Ljava/lang/String;)Ljava/lang/String;",
    4
    ...
    override fun invoke(str: String?, continuation: Continuation<in String?>?): Object? {
        val unshortenDavisonbarker: Object?
        unshortenDavisonbarker = (this.receiver as UnshortenUrl).unshortenDavisonbarker(str)
