...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.helper.AsianEmbedHelper\$Companion",
    m98f = "AsianEmbedHelper.kt",
    m97i = [0, 0, 0],
    m96l = [18],
    m95m = "getUrls",
    m94n = ["url", "subtitleCallback", "callback"],
    m93s = ["L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `AsianEmbedHelper$Companion$getUrls$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AsianEmbedHelper.Companion,
    continuation: Continuation<in `AsianEmbedHelper$Companion$getUrls$1`?>?
