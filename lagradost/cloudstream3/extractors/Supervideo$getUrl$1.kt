...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: Supervideo.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.Supervideo",
    m98f = "Supervideo.kt",
    m97i = [0, 0, 0],
    m96l = [20],
...
class `Supervideo$getUrl$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: Supervideo, continuation: Continuation<in `Supervideo$getUrl$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return Supervideo.Companion.`getUrl$suspendImpl`(
            `this$0`,
            null as String?,
            null as String?,
