...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: Hxfile.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.Hxfile",
    m98f = "Hxfile.kt",
    m97i = [0, 0, 0],
    m96l = [44],
...
class `Hxfile$getUrl$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: Hxfile, continuation: Continuation<in `Hxfile$getUrl$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return Hxfile.Companion.`getUrl$suspendImpl`(
            `this$0`,
            null as String?,
            null as String?,
