...
class AsianLoad : ExtractorApi() {
    ...
    // com.lagradost.cloudstream3.utils.ExtractorApi
    @get:Override
    var mainUrl = "https://asianembed.io"
        set(str) {
            Intrinsics.checkNotNullParameter(str, "<set-?>")
            field = str
        }
    ...
    private val sourceRegex: Regex = Regex("sources:[\\W\\w]*?file:\\s*?[\"'](.*?)[\"']")

    /* JADX WARN: Multi-variable type inference failed */ /* JADX WARN: Removed duplicated region for block: B:10:0x0028  */ /* JADX WARN: Removed duplicated region for block: B:14:0x0046  */ /* JADX WARN: Removed duplicated region for block: B:21:0x00a8  */ /* JADX WARN: Type inference failed for: r3v7, types: [java.util.List] */
    ...
    */   override fun getUrl(
        r30: String?,
        r31: String?,
        r32: Continuation<in MutableList<out ExtractorLink?>?>?
    ): Any {
        /*
            Method dump skipped, instructions count: 352
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.extractors.AsianLoad.getUrl(java.lang.String, java.lang.String, kotlin.coroutines.Continuation):java.lang.Object")
    }
}