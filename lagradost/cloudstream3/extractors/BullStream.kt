...
class BullStream : ExtractorApi() {
    ...
    // com.lagradost.cloudstream3.utils.ExtractorApi
    @get:Override
    val mainUrl = "https://bullstream.xyz"
    val regex: Regex = Regex("(?<=sniff\\()(.*)(?=\\)\\);)")

    /* JADX WARN: Removed duplicated region for block: B:10:0x0028  */ /* JADX WARN: Removed duplicated region for block: B:14:0x0043  */
    ...
    */   override fun getUrl(
        ...
        */
        throw UnsupportedOperationException("Method not decompiled: com.lagradost.cloudstream3.extractors.BullStream.getUrl(java.lang.String, java.lang.String, kotlin.coroutines.Continuation):java.lang.Object")
    }
}