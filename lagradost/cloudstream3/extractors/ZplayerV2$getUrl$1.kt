...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.ZplayerV2",
    m98f = "Zplayer.kt",
    m97i = [0, 0],
    m96l = [31],
...
class `ZplayerV2$getUrl$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: ZplayerV2, continuation: Continuation<in `ZplayerV2$getUrl$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return ZplayerV2.Companion.`getUrl$suspendImpl`(
            `this$0`,
            null as String?,
            null as String?,
