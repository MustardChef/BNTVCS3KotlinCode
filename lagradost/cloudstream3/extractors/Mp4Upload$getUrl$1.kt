...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: Mp4Upload.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.Mp4Upload",
    m98f = "Mp4Upload.kt",
    m97i = [0, 0],
    m96l = [16],
    m95m = "getUrl",
...
class `Mp4Upload$getUrl$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: Mp4Upload, continuation: Continuation<in `Mp4Upload$getUrl$1`?>?
