...
/* JADX INFO: Access modifiers changed from: package-private */ /* compiled from: StreamSB.kt */
@Metadata(m106k = 3, m105mv = [1, 6, 0], m103xi = 48)
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.StreamSB",
    m98f = "StreamSB.kt",
    m97i = [0, 0, 0, 1, 1, 1, 1, 1],
    m96l = [106, 111],
    m95m = "getUrl\$suspendImpl",
    m94n = ["this", "url", "headers", "this", "url", "headers", "urltext", "mapped"],
    m93s = ["L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3", "L$4"]
) /* loaded from: classes3.dex */
class `StreamSB$getUrl$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: StreamSB, continuation: Continuation<in `StreamSB$getUrl$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return StreamSB.Companion.`getUrl$suspendImpl`(
            `this$0`,
            null as String?,
            null as String?,
