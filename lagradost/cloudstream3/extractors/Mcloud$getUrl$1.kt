...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.extractors.Mcloud",
    m98f = "Mcloud.kt",
    m97i = [0, 0, 0, 1, 1],
    m96l = [38, 42],
    m95m = "getUrl\$suspendImpl",
    m94n = ["this", "url", "id", "this", "url"],
    m93s = ["L$0", "L$1", "L$2", "L$0", "L$1"]
) /* loaded from: classes3.dex */
class `Mcloud$getUrl$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: Mcloud, continuation: Continuation<in `Mcloud$getUrl$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return Mcloud.Companion.`getUrl$suspendImpl`(
            `this$0`,
            null as String?,
            null as String?,
