...
class `MainAPIKt$newMovieSearchResponse$1` internal constructor() : Lambda<Any?>(1),
    Function1<MovieSearchResponse?, Unit> {
    /* renamed from: invoke  reason: avoid collision after fix types in other method */
    fun invoke2(movieSearchResponse: MovieSearchResponse?) {
    ...
    companion object {
        val INSTANCE = `MainAPIKt$newMovieSearchResponse$1`()
    }
}