...
@DebugMetadata(
    ...
    m97i = [],
    m96l = [684],
    m95m = "getFullAnilistList",
    m94n = [],
    m93s = []
) /* loaded from: classes3.dex */
class `AniListApi$getFullAnilistList$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AniListApi, continuation: Continuation<in `AniListApi$getFullAnilistList$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val fullAnilistList: Object
        result = obj
        label = label or Integer.MIN_VALUE
        fullAnilistList = `this$0`.getFullAnilistList(this)
