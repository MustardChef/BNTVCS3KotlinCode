...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.syncproviders.providers.AniListApi\$Companion",
    m98f = "AniListApi.kt",
    m97i = [0, 0, 0],
    m96l = [291],
    m95m = "getShowId",
    m94n = ["malId", "name", "year"],
    m93s = ["L$0", "L$1", "L$2"]
) /* loaded from: classes3.dex */
class `AniListApi$Companion$getShowId$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AniListApi.Companion,
    continuation: Continuation<in `AniListApi$Companion$getShowId$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.getShowId(null, null, null, this)
    }
}