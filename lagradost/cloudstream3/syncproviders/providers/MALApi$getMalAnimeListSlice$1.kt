...
@DebugMetadata(
    ...
    m97i = [],
    m96l = [455],
    m95m = "getMalAnimeListSlice",
    m94n = [],
    m93s = []
) /* loaded from: classes3.dex */
class `MALApi$getMalAnimeListSlice$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MALApi, continuation: Continuation<in `MALApi$getMalAnimeListSlice$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        val malAnimeListSlice: Object
        result = obj
        label = label or Integer.MIN_VALUE
        malAnimeListSlice = `this$0`.getMalAnimeListSlice(0, this)
