...
@DebugMetadata(
    ...
    m97i = [],
    m96l = [420],
    m95m = "getMalAnimeListSmart",
    m94n = [],
    m93s = []
) /* loaded from: classes3.dex */
class `MALApi$getMalAnimeListSmart$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MALApi, continuation: Continuation<in `MALApi$getMalAnimeListSmart$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.getMalAnimeListSmart(this)
    }
}