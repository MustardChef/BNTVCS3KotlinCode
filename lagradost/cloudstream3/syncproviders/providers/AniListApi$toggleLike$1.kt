...
@DebugMetadata(
    ...
    m98f = "AniListApi.kt",
    m97i = [],
    m96l = [TypedValues.TransitionType.TYPE_FROM],
    m95m = "toggleLike",
    m94n = [],
    m93s = []
) /* loaded from: classes3.dex */
class `AniListApi$toggleLike$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: AniListApi, continuation: Continuation<in `AniListApi$toggleLike$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.toggleLike(0, this)
    }
}