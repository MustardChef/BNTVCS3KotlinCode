...
@DebugMetadata(
    ...
    m96l = [481, 483],
    m95m = "setAllMalData",
    m94n = ["this", "user", "isDone", FirebaseAnalytics.Param.INDEX, "this", "user", FirebaseAnalytics.Param.INDEX],
    m93s = ["L$0", "L$1", "I$0", "I$1", "L$0", "L$1", "I$0"]
) /* loaded from: classes3.dex */
class `MALApi$setAllMalData$1`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: MALApi, continuation: Continuation<in `MALApi$setAllMalData$1`?>?
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        return `this$0`.setAllMalData(this)
    }
}