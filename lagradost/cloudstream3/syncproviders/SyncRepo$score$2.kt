...
@DebugMetadata(
    m99c = "com.lagradost.cloudstream3.syncproviders.SyncRepo\$score$2",
    m98f = "SyncRepo.kt",
    m97i = [],
    m96l = [15],
    m95m = "invokeSuspend",
...
class `SyncRepo$score$2`     /* JADX INFO: Access modifiers changed from: package-private */ /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */(/* synthetic */
    val `this$0`: SyncRepo, /* synthetic */
    val `$id`: String?, /* synthetic */
    val `$status`: SyncStatus, continuation: Continuation<in `SyncRepo$score$2`?>?
    ...
    override fun create(continuation: Continuation<*>?): Continuation<Unit> {
        return `SyncRepo$score$2`(`this$0`, `$id`, `$status`, continuation)
    }

    @Override // kotlin.jvm.functions.Function1
    override fun invoke(continuation: Continuation<in Boolean?>?): Object {
        return (create(continuation) as `SyncRepo$score$2`).invokeSuspend(Unit.INSTANCE)
    }
    ...
    override fun invokeSuspend(obj: Object): Object {
        ...
        if (i == 0) {
            ...
            syncAPI = `this$0`.repo
            label = 1
            obj = syncAPI.score(`$id`, `$status`, this)
